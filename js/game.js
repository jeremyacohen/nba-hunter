...
const PLAYERS = [
  { id:'jokic',     name:'Nikola Jokic',            teamName:'Denver Nuggets',          espnId:3112335, espnRank:1,  color:'#0E2240',
    stats:{ pts:28.2, reb:12.6, ast:10.6, stl:1.5, blk:0.8, threePM:1.8, fgPct:57.3, ftPct:83.7, tov:3.8 },
  ...
  { id:'sga',       name:'Shai Gilgeous-Alexander',  teamName:'Oklahoma City Thunder',    espnId:4278073, espnRank:2,  color:'#007AC1',
    stats:{ pts:31.7, reb:4.5, ast:6.6, stl:1.4, blk:0.8, threePM:1.8, fgPct:54.9, ftPct:89.3, tov:2.1 },
    ranks:{ pts:2, reb:37, ast:12, stl:9, blk:16, threePM:23, fgPct:7, ftPct:7, tov:32 } },
  ...
  { id:'wemby',     name:'Victor Wembanyama',        teamName:'San Antonio Spurs',        espnId:5104157, espnRank:5,  color:'#C4CED4',
    stats:{ pts:24.2, reb:11.1, ast:2.9, stl:1.0, blk:3.0, threePM:2.0, fgPct:50.6, ftPct:81.1, tov:2.5 },
    ranks:{ pts:18, reb:5, ast:38, stl:28, blk:1, threePM:16, fgPct:13, ftPct:29, tov:23 } },
  { id:'edwards',   name:'Anthony Edwards',          teamName:'Minnesota Timberwolves',   espnId:4594268, espnRank:6,  color:'#0C2340',
    ...
    ranks:{ pts:3, reb:33, ast:34, stl:10, blk:17, threePM:3, fgPct:22, ftPct:31, tov:17 } },
  ...
  { id:'durant',    name:'Kevin Durant',             teamName:'Houston Rockets',          espnId:3202,    espnRank:9,  color:'#CE1141',
    ...
    ranks:{ pts:14, reb:31, ast:28, stl:40, blk:12, threePM:13, fgPct:12, ftPct:9, tov:11 } },
  ...
  { id:'jwilliams', name:'Jalen Williams',           teamName:'Oklahoma City Thunder',    espnId:4593803, espnRank:11, color:'#007AC1',
    ...
    ranks:{ pts:40, reb:36, ast:20, stl:14, blk:38, threePM:41, fgPct:30, ftPct:22, tov:36 } },
  { id:'cade',      name:'Cade Cunningham',          teamName:'Detroit Pistons',          espnId:4432166, espnRank:12, color:'#C8102E',
    ...
    ranks:{ pts:17, reb:29, ast:2, stl:7, blk:13, threePM:17, fgPct:41, ftPct:27, tov:3 } },
  { id:'mobley',    name:'Evan Mobley',              teamName:'Cleveland Cavaliers',      espnId:4432158, espnRank:13, color:'#860038',
    stats:{ pts:18.1, reb:8.9, ast:3.6, stl:0.8, blk:1.9, threePM:1.1, fgPct:52.8, ftPct:61.3, tov:1.9 },
    ranks:{ pts:37, reb:12, ast:36, stl:42, blk:2, threePM:38, fgPct:9, ftPct:49, tov:37 } },
  { id:'adavis',    name:'Anthony Davis',            teamName:'Dallas Mavericks',         espnId:6583,    espnRank:14, color:'#003DA5',
    ...
    ranks:{ pts:27, reb:6, ast:41, stl:21, blk:4, threePM:43, fgPct:15, ftPct:42, tov:34 } },
  { id:'mitchell',  name:'Donovan Mitchell',         teamName:'Cleveland Cavaliers',      espnId:3908809, espnRank:15, color:'#860038',
    stats:{ pts:28.0, reb:4.5, ast:5.9, stl:1.6, blk:0.3, threePM:3.3, fgPct:47.9, ftPct:85.4, tov:2.9 },
    ranks:{ pts:8, reb:38, ast:16, stl:4, blk:39, threePM:4, fgPct:31, ftPct:15, tov:14 } },
  { id:'booker',    name:'Devin Booker',             teamName:'Phoenix Suns',             espnId:3136193, espnRank:16, color:'#1D1160',
    stats:{ pts:25.8, reb:4.0, ast:5.9, stl:0.8, blk:0.3, threePM:1.9, fgPct:45.5, ftPct:86.9, tov:3.3 },
    ranks:{ pts:15, reb:44, ast:17, stl:43, blk:40, threePM:20, fgPct:45, ftPct:12, tov:7 } },
  { id:'banchero',  name:'Paolo Banchero',           teamName:'Orlando Magic',            espnId:4432573, espnRank:17, color:'#0077C0',
    stats:{ pts:22.4, reb:8.6, ast:5.0, stl:0.6, blk:0.6, threePM:1.2, fgPct:46.4, ftPct:77.3, tov:2.9 },
    ranks:{ pts:22, reb:14, ast:25, stl:45, blk:26, threePM:37, fgPct:40, ftPct:38, tov:15 } },
  { id:'butler',    name:'Jimmy Butler',             teamName:'Golden State Warriors',    espnId:6430,    espnRank:18, color:'#1D428A',
    ...
    ranks:{ pts:29, reb:30, ast:26, stl:11, blk:44, threePM:42, fgPct:11, ftPct:13, tov:43 } },
  { id:'jbrown',    name:'Jaylen Brown',             teamName:'Boston Celtics',           espnId:3917376, espnRank:19, color:'#007A33',
    ...
    ranks:{ pts:5, reb:20, ast:23, stl:29, blk:32, threePM:18, fgPct:32, ftPct:32, tov:4 } },
  { id:'kawhi',     name:'Kawhi Leonard',            teamName:'LA Clippers',              espnId:6450,    espnRank:20, color:'#C8102E',
    ...
    ranks:{ pts:6, reb:24, ast:35, stl:1, blk:33, threePM:11, fgPct:17, ftPct:4, tov:33 } },
  ...
  { id:'siakam',    name:'Pascal Siakam',            teamName:'Indiana Pacers',           espnId:3149673, espnRank:22, color:'#002D62',
    ...
    ranks:{ pts:19, reb:23, ast:31, stl:23, blk:34, threePM:28, fgPct:28, ftPct:47, tov:29 } },
  ...
  { id:'sengun',    name:'Alperen Sengun',           teamName:'Houston Rockets',          espnId:4871144, espnRank:25, color:'#CE1141',
    ...
    ranks:{ pts:28, reb:13, ast:15, stl:16, blk:10, threePM:44, fgPct:16, ftPct:46, tov:8 } },
  { id:'dwhite',    name:'Derrick White',            teamName:'Boston Celtics',           espnId:3078576, espnRank:26, color:'#007A33',
    ...
    ranks:{ pts:41, reb:39, ast:18, stl:17, blk:8, threePM:8, fgPct:50, ftPct:3, tov:40 } },
  { id:'kat',       name:'Karl-Anthony Towns',       teamName:'New York Knicks',          espnId:3136195, espnRank:27, color:'#006BB6',
    stats:{ pts:20.0, reb:11.8, ast:2.9, stl:0.9, blk:0.6, threePM:1.6, fgPct:49.2, ftPct:85.2, tov:2.5 },
    ranks:{ pts:31, reb:2, ast:40, stl:35, blk:27, threePM:30, fgPct:23, ftPct:17, tov:24 } },
  { id:'maxey',     name:'Tyrese Maxey',             teamName:'Philadelphia 76ers',       espnId:4431678, espnRank:28, color:'#006BB6',
    ...
    ranks:{ pts:4, reb:41, ast:11, stl:2, blk:18, threePM:5, fgPct:42, ftPct:8, tov:26 } },
  { id:'trae',      name:'Trae Young',               teamName:'Atlanta Hawks',            espnId:4277905, espnRank:29, color:'#C8102E',
    ...
    ranks:{ pts:38, reb:50, ast:7, stl:36, blk:49, threePM:24, fgPct:43, ftPct:24, tov:21 } },
  ...
  { id:'jjj',       name:'Jaren Jackson Jr.',        teamName:'Memphis Grizzlies',        espnId:4277961, espnRank:31, color:'#5D76A9',
    ...
    ranks:{ pts:32, reb:28, ast:47, stl:25, blk:9, threePM:25, fgPct:36, ftPct:30, tov:30 } },
  ...
  { id:'sabonis',   name:'Domantas Sabonis',         teamName:'Sacramento Kings',         espnId:3155942, espnRank:34, color:'#5A2D81',
    ...
    ranks:{ pts:46, reb:3, ast:30, stl:37, blk:45, threePM:47, fgPct:8, ftPct:43, tov:19 } },
  { id:'fox',       name:"De'Aaron Fox",             teamName:'San Antonio Spurs',        espnId:4066259, espnRank:35, color:'#C4CED4',
    stats:{ pts:19.0, reb:3.8, ast:6.3, stl:1.2, blk:0.3, threePM:1.9, fgPct:49.0, ftPct:75.9, tov:2.2 },
    ranks:{ pts:34, reb:45, ast:14, stl:18, blk:43, threePM:21, fgPct:24, ftPct:40, tov:31 } },
  ...
  { id:'garland',   name:'Darius Garland',           teamName:'Cleveland Cavaliers',      espnId:4396907, espnRank:38, color:'#860038',
    ...
    ranks:{ pts:36, reb:49, ast:10, stl:38, blk:50, threePM:12, fgPct:46, ftPct:16, tov:16 } },
  { id:'dbane',     name:'Desmond Bane',             teamName:'Orlando Magic',            espnId:4066320, espnRank:39, color:'#0077C0',
    stats:{ pts:20.5, reb:4.1, ast:4.2, stl:1.0, blk:0.4, threePM:2.1, fgPct:48.9, ftPct:92.3, tov:2.0 },
    ranks:{ pts:26, reb:42, ast:29, stl:31, blk:36, threePM:15, fgPct:25, ftPct:2, tov:35 } },
  { id:'agordon',   name:'Aaron Gordon',             teamName:'Denver Nuggets',           espnId:3064290, espnRank:40, color:'#0E2240',
    stats:{ pts:16.8, reb:6.0, ast:2.5, stl:0.6, blk:0.2, threePM:1.8, fgPct:49.5, ftPct:78.5, tov:1.1 },
    ranks:{ pts:45, reb:25, ast:43, stl:47, blk:46, threePM:26, fgPct:19, ftPct:34, tov:48 } },
  { id:'og',        name:'OG Anunoby',               teamName:'New York Knicks',          espnId:3934719, espnRank:41, color:'#006BB6',
    stats:{ pts:16.9, reb:5.3, ast:2.2, stl:1.7, blk:0.7, threePM:2.2, fgPct:48.8, ftPct:81.3, tov:1.9 },
    ranks:{ pts:44, reb:32, ast:45, stl:3, blk:23, threePM:14, fgPct:26, ftPct:28, tov:38 } },
  { id:'randle',    name:'Julius Randle',            teamName:'Minnesota Timberwolves',   espnId:3064514, espnRank:42, color:'#0C2340',
    stats:{ pts:21.2, reb:6.9, ast:5.1, stl:1.1, blk:0.2, threePM:1.4, fgPct:48.4, ftPct:81.7, tov:2.7 },
    ranks:{ pts:25, reb:21, ast:24, stl:27, blk:47, threePM:34, fgPct:29, ftPct:26, tov:20 } },
  ...
  { id:'jjohnson',  name:'Jalen Johnson',            teamName:'Atlanta Hawks',            espnId:4701230, espnRank:44, color:'#C8102E',
    ...
    ranks:{ pts:21, reb:8, ast:5, stl:15, blk:30, threePM:31, fgPct:20, ftPct:35, tov:9 } },
  ...
  { id:'jmurray',   name:'Jamal Murray',             teamName:'Denver Nuggets',           espnId:3936299, espnRank:46, color:'#0E2240',
    stats:{ pts:25.2, reb:4.4, ast:7.1, stl:0.9, blk:0.4, threePM:3.1, fgPct:47.9, ftPct:87.7, tov:2.3 },
    ranks:{ pts:16, reb:40, ast:8, stl:39, blk:37, threePM:6, fgPct:34, ftPct:11, tov:28 } },
  ...
  { id:'mbridges',  name:'Mikal Bridges',            teamName:'New York Knicks',          espnId:3147657, espnRank:48, color:'#006BB6',
    stats:{ pts:14.8, reb:4.1, ast:3.9, stl:1.4, blk:0.8, threePM:2.0, fgPct:48.6, ftPct:82.1, tov:1.0 },
    ranks:{ pts:48, reb:43, ast:33, stl:13, blk:20, threePM:19, fgPct:27, ftPct:25, tov:50 } },
  { id:'gobert',    name:'Rudy Gobert',              teamName:'Minnesota Timberwolves',   espnId:3032976, espnRank:49, color:'#0C2340',
    stats:{ pts:10.8, reb:11.4, ast:1.8, stl:0.8, blk:1.6, threePM:0.0, fgPct:70.4, ftPct:51.5, tov:1.4 },
    ranks:{ pts:50, reb:4, ast:49, stl:44, blk:6, threePM:50, fgPct:1, ftPct:50, tov:47 } },
  { id:'porzingis', name:'Kristaps Porzingis',       teamName:'Atlanta Hawks',            espnId:3102531, espnRank:50, color:'#C8102E',
    ...
    ranks:{ pts:43, reb:35, ast:42, stl:49, blk:7, threePM:29, fgPct:44, ftPct:19, tov:49 } },
];
