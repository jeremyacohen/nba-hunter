...
const PLAYERS = [
  { id:'jokic',     name:'Nikola Jokic',            teamName:'Denver Nuggets',          espnId:3112335, espnRank:1,  color:'#0E2240',
    stats:{ pts:28.7, reb:12.6, ast:10.3, stl:1.3, blk:0.8, threePM:1.9, fgPct:57.0, ftPct:82.7, tov:3.7 },
    ranks:{ pts:6, reb:1, ast:1, stl:13, blk:15, threePM:18, fgPct:5, ftPct:24, tov:3 } },
  ...
  { id:'luka',      name:'Luka Doncic',              teamName:'Los Angeles Lakers',       espnId:3945274, espnRank:3,  color:'#552583',
    stats:{ pts:32.4, reb:7.7, ast:8.6, stl:1.4, blk:0.5, threePM:3.7, fgPct:47.3, ftPct:77.3, tov:4.0 },
    ranks:{ pts:1, reb:17, ast:4, stl:9, blk:28, threePM:2, fgPct:36, ftPct:37, tov:1 } },
  { id:'giannis',   name:'Giannis Antetokounmpo',    teamName:'Milwaukee Bucks',          espnId:3032977, espnRank:4,  color:'#00471B',
    ...
    ranks:{ pts:9, reb:9, ast:20, stl:36, blk:22, threePM:43, fgPct:2, ftPct:48, tov:8 } },
  { id:'wemby',     name:'Victor Wembanyama',        teamName:'San Antonio Spurs',        espnId:5104157, espnRank:5,  color:'#C4CED4',
    stats:{ pts:23.4, reb:11.1, ast:2.9, stl:1.0, blk:2.9, threePM:1.7, fgPct:50.1, ftPct:81.4, tov:2.6 },
    ranks:{ pts:20, reb:5, ast:38, stl:27, blk:1, threePM:27, fgPct:16, ftPct:27, tov:21 } },
  { id:'edwards',   name:'Anthony Edwards',          teamName:'Minnesota Timberwolves',   espnId:4594268, espnRank:6,  color:'#0C2340',
    stats:{ pts:29.7, reb:5.2, ast:3.7, stl:1.4, blk:0.8, threePM:3.5, fgPct:49.4, ftPct:78.7, tov:2.8 },
    ranks:{ pts:3, reb:32, ast:35, stl:10, blk:17, threePM:3, fgPct:22, ftPct:32, tov:17 } },
  ...
  { id:'lebron',    name:'LeBron James',             teamName:'Los Angeles Lakers',       espnId:1966,    espnRank:8,  color:'#552583',
    stats:{ pts:21.6, reb:5.7, ast:7.0, stl:1.0, blk:0.6, threePM:1.5, fgPct:50.2, ftPct:74.2, tov:3.1 },
    ranks:{ pts:23, reb:28, ast:9, stl:28, blk:25, threePM:31, fgPct:15, ftPct:41, tov:12 } },
  { id:'durant',    name:'Kevin Durant',             teamName:'Houston Rockets',          espnId:3202,    espnRank:9,  color:'#CE1141',
    stats:{ pts:26.3, reb:5.4, ast:4.5, stl:0.8, blk:0.9, threePM:2.4, fgPct:51.0, ftPct:89.1, tov:3.2 },
    ranks:{ pts:14, reb:31, ast:28, stl:41, blk:12, threePM:12, fgPct:12, ftPct:10, tov:10 } },
  { id:'brunson',   name:'Jalen Brunson',            teamName:'New York Knicks',          espnId:3934672, espnRank:10, color:'#006BB6',
    ...
    ranks:{ pts:13, reb:47, ast:13, stl:44, blk:48, threePM:9, fgPct:39, ftPct:19, tov:28 } },
  { id:'jwilliams', name:'Jalen Williams',           teamName:'Oklahoma City Thunder',    espnId:4593803, espnRank:11, color:'#007AC1',
    ...
    ranks:{ pts:39, reb:36, ast:21, stl:14, blk:38, threePM:41, fgPct:32, ftPct:21, tov:37 } },
  { id:'cade',      name:'Cade Cunningham',          teamName:'Detroit Pistons',          espnId:4432166, espnRank:12, color:'#C8102E',
    stats:{ pts:25.2, reb:5.8, ast:9.9, stl:1.5, blk:0.9, threePM:1.9, fgPct:45.7, ftPct:81.1, tov:3.8 },
    ranks:{ pts:16, reb:26, ast:2, stl:5, blk:13, threePM:19, fgPct:43, ftPct:28, tov:2 } },
  { id:'mobley',    name:'Evan Mobley',              teamName:'Cleveland Cavaliers',      espnId:4432158, espnRank:13, color:'#860038',
    ...
    ranks:{ pts:38, reb:13, ast:34, stl:37, blk:3, threePM:37, fgPct:10, ftPct:49, tov:34 } },
  { id:'adavis',    name:'Anthony Davis',            teamName:'Dallas Mavericks',         espnId:6583,    espnRank:14, color:'#003DA5',
    ...
    ranks:{ pts:27, reb:6, ast:40, stl:21, blk:4, threePM:44, fgPct:14, ftPct:42, tov:35 } },
  { id:'mitchell',  name:'Donovan Mitchell',         teamName:'Cleveland Cavaliers',      espnId:3908809, espnRank:15, color:'#860038',
    ...
    ranks:{ pts:7, reb:37, ast:17, stl:4, blk:39, threePM:4, fgPct:28, ftPct:18, tov:13 } },
  { id:'booker',    name:'Devin Booker',             teamName:'Phoenix Suns',             espnId:3136193, espnRank:16, color:'#1D1160',
    stats:{ pts:24.6, reb:3.9, ast:6.1, stl:0.9, blk:0.3, threePM:1.7, fgPct:45.1, ftPct:86.2, tov:3.3 },
    ranks:{ pts:17, reb:44, ast:16, stl:38, blk:40, threePM:28, fgPct:45, ftPct:15, tov:9 } },
  { id:'banchero',  name:'Paolo Banchero',           teamName:'Orlando Magic',            espnId:4432573, espnRank:17, color:'#0077C0',
    stats:{ pts:22.1, reb:8.4, ast:5.0, stl:0.7, blk:0.7, threePM:1.2, fgPct:45.9, ftPct:77.4, tov:2.9 },
    ranks:{ pts:22, reb:15, ast:24, stl:45, blk:23, threePM:38, fgPct:42, ftPct:36, tov:15 } },
  { id:'butler',    name:'Jimmy Butler',             teamName:'Golden State Warriors',    espnId:6430,    espnRank:18, color:'#1D428A',
    ...
    ranks:{ pts:29, reb:30, ast:26, stl:11, blk:44, threePM:42, fgPct:9, ftPct:12, tov:43 } },
  { id:'jbrown',    name:'Jaylen Brown',             teamName:'Boston Celtics',           espnId:3917376, espnRank:19, color:'#007A33',
    ...
    ranks:{ pts:4, reb:20, ast:25, stl:29, blk:34, threePM:14, fgPct:31, ftPct:34, tov:5 } },
  ...
  { id:'adebayo',   name:'Bam Adebayo',              teamName:'Miami Heat',               espnId:4066261, espnRank:21, color:'#98002E',
    stats:{ pts:18.7, reb:9.9, ast:2.9, stl:1.1, blk:0.7, threePM:1.7, fgPct:44.9, ftPct:76.5, tov:1.7 },
    ranks:{ pts:35, reb:10, ast:39, stl:22, blk:24, threePM:29, fgPct:46, ftPct:40, tov:41 } },
  { id:'siakam',    name:'Pascal Siakam',            teamName:'Indiana Pacers',           espnId:3149673, espnRank:22, color:'#002D62',
    ...
    ranks:{ pts:19, reb:23, ast:31, stl:23, blk:35, threePM:21, fgPct:25, ftPct:47, tov:30 } },
  ...
  { id:'sengun',    name:'Alperen Sengun',           teamName:'Houston Rockets',          espnId:4871144, espnRank:25, color:'#CE1141',
    stats:{ pts:20.5, reb:9.2, ast:6.3, stl:1.3, blk:1.1, threePM:0.5, fgPct:50.1, ftPct:69.3, tov:3.2 },
    ranks:{ pts:26, reb:11, ast:14, stl:15, blk:10, threePM:45, fgPct:17, ftPct:46, tov:11 } },
  ...
  { id:'kat',       name:'Karl-Anthony Towns',       teamName:'New York Knicks',          espnId:3136195, espnRank:27, color:'#006BB6',
    ...
    ranks:{ pts:30, reb:2, ast:41, stl:39, blk:26, threePM:30, fgPct:26, ftPct:17, tov:25 } },
  ...
  { id:'trae',      name:'Trae Young',               teamName:'Atlanta Hawks',            espnId:4277905, espnRank:29, color:'#C8102E',
    ...
    ranks:{ pts:33, reb:50, ast:3, stl:30, blk:49, threePM:22, fgPct:48, ftPct:14, tov:22 } },
  { id:'barnes',    name:'Scottie Barnes',           teamName:'Toronto Raptors',          espnId:4433134, espnRank:30, color:'#CE1141',
    stats:{ pts:19.0, reb:8.1, ast:5.5, stl:1.4, blk:1.6, threePM:0.9, fgPct:50.1, ftPct:82.9, tov:2.7 },
    ranks:{ pts:34, reb:16, ast:19, stl:12, blk:5, threePM:40, fgPct:18, ftPct:22, tov:19 } },
  { id:'jjj',       name:'Jaren Jackson Jr.',        teamName:'Memphis Grizzlies',        espnId:4277961, espnRank:31, color:'#5D76A9',
    ...
    ranks:{ pts:31, reb:29, ast:47, stl:24, blk:8, threePM:23, fgPct:35, ftPct:29, tov:31 } },
  { id:'fwagner',   name:'Franz Wagner',             teamName:'Orlando Magic',            espnId:4566434, espnRank:32, color:'#0077C0',
    ...
    ranks:{ pts:25, reb:27, ast:37, stl:25, blk:41, threePM:32, fgPct:33, ftPct:23, tov:42 } },
  ...
  { id:'sabonis',   name:'Domantas Sabonis',         teamName:'Sacramento Kings',         espnId:3155942, espnRank:34, color:'#5A2D81',
    ...
    ranks:{ pts:46, reb:4, ast:29, stl:40, blk:45, threePM:46, fgPct:8, ftPct:43, tov:20 } },
  { id:'fox',       name:"De'Aaron Fox",             teamName:'San Antonio Spurs',        espnId:4066259, espnRank:35, color:'#C4CED4',
    stats:{ pts:18.6, reb:3.8, ast:6.2, stl:1.2, blk:0.2, threePM:1.9, fgPct:48.1, ftPct:76.8, tov:2.3 },
    ranks:{ pts:36, reb:45, ast:15, stl:19, blk:46, threePM:20, fgPct:30, ftPct:39, tov:29 } },
  ...
  { id:'garland',   name:'Darius Garland',           teamName:'Cleveland Cavaliers',      espnId:4396907, espnRank:38, color:'#860038',
    ...
    ranks:{ pts:40, reb:49, ast:10, stl:42, blk:50, threePM:13, fgPct:44, ftPct:13, tov:16 } },
  { id:'dbane',     name:'Desmond Bane',             teamName:'Orlando Magic',            espnId:4066320, espnRank:39, color:'#0077C0',
    stats:{ pts:20.4, reb:4.1, ast:4.1, stl:1.0, blk:0.5, threePM:2.1, fgPct:48.6, ftPct:91.5, tov:2.0 },
    ranks:{ pts:28, reb:42, ast:30, stl:32, blk:30, threePM:15, fgPct:24, ftPct:2, tov:36 } },
  ...
  { id:'randle',    name:'Julius Randle',            teamName:'Minnesota Timberwolves',   espnId:3064514, espnRank:42, color:'#0C2340',
    stats:{ pts:21.5, reb:6.9, ast:5.3, stl:1.1, blk:0.3, threePM:1.5, fgPct:48.3, ftPct:81.7, tov:2.6 },
    ranks:{ pts:24, reb:21, ast:22, stl:26, blk:43, threePM:33, fgPct:29, ftPct:26, tov:24 } },
  ...
  { id:'jjohnson',  name:'Jalen Johnson',            teamName:'Atlanta Hawks',            espnId:4701230, espnRank:44, color:'#C8102E',
    ...
    ranks:{ pts:21, reb:8, ast:7, stl:16, blk:32, threePM:34, fgPct:23, ftPct:35, tov:7 } },
  { id:'jallen',    name:'Jarrett Allen',            teamName:'Cleveland Cavaliers',      espnId:4066328, espnRank:45, color:'#860038',
    ...
    ranks:{ pts:48, reb:14, ast:48, stl:34, blk:14, threePM:49, fgPct:3, ftPct:44, tov:46 } },
  ...
  { id:'embiid',    name:'Joel Embiid',              teamName:'Philadelphia 76ers',       espnId:3059318, espnRank:47, color:'#006BB6',
    ...
    ranks:{ pts:12, reb:19, ast:32, stl:47, blk:11, threePM:36, fgPct:21, ftPct:16, tov:14 } },
  ...
  { id:'porzingis', name:'Kristaps Porzingis',       teamName:'Atlanta Hawks',            espnId:3102531, espnRank:50, color:'#C8102E',
    ...
    ranks:{ pts:44, reb:35, ast:42, stl:49, blk:9, threePM:25, fgPct:40, ftPct:20, tov:50 } },
];
