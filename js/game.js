...
const PLAYERS = [
  { id:'jokic',     name:'Nikola Jokic',            teamName:'Denver Nuggets',          espnId:3112335, espnRank:1,  color:'#0E2240',
    stats:{ pts:28.6, reb:12.3, ast:10.5, stl:1.4, blk:0.7, threePM:1.9, fgPct:58.6, ftPct:83.3, tov:3.7 },
    ranks:{ pts:7, reb:1, ast:1, stl:8, blk:21, threePM:19, fgPct:5, ftPct:21, tov:2 } },
  { id:'sga',       name:'Shai Gilgeous-Alexander',  teamName:'Oklahoma City Thunder',    espnId:4278073, espnRank:2,  color:'#007AC1',
    ...
    ranks:{ pts:2, reb:38, ast:12, stl:12, blk:15, threePM:21, fgPct:7, ftPct:7, tov:33 } },
  { id:'luka',      name:'Luka Doncic',              teamName:'Los Angeles Lakers',       espnId:3945274, espnRank:3,  color:'#552583',
    stats:{ pts:33.0, reb:7.8, ast:8.6, stl:1.5, blk:0.5, threePM:3.7, fgPct:47.3, ftPct:77.9, tov:4.2 },
    ranks:{ pts:1, reb:17, ast:4, stl:4, blk:28, threePM:2, fgPct:35, ftPct:37, tov:1 } },
  { id:'giannis',   name:'Giannis Antetokounmpo',    teamName:'Milwaukee Bucks',          espnId:3032977, espnRank:4,  color:'#00471B',
    ...
    ranks:{ pts:8, reb:9, ast:18, stl:35, blk:22, threePM:44, fgPct:2, ftPct:48, tov:8 } },
  { id:'wemby',     name:'Victor Wembanyama',        teamName:'San Antonio Spurs',        espnId:5104157, espnRank:5,  color:'#C4CED4',
    stats:{ pts:24.2, reb:11.1, ast:2.8, stl:1.0, blk:2.7, threePM:1.8, fgPct:51.0, ftPct:81.2, tov:2.6 },
    ranks:{ pts:19, reb:5, ast:39, stl:27, blk:1, threePM:22, fgPct:11, ftPct:27, tov:21 } },
  { id:'edwards',   name:'Anthony Edwards',          teamName:'Minnesota Timberwolves',   espnId:4594268, espnRank:6,  color:'#0C2340',
    stats:{ pts:29.5, reb:5.2, ast:3.7, stl:1.3, blk:0.8, threePM:3.4, fgPct:49.4, ftPct:79.4, tov:2.7 },
    ranks:{ pts:3, reb:33, ast:35, stl:13, blk:16, threePM:4, fgPct:20, ftPct:32, tov:18 } },
  { id:'curry',     name:'Stephen Curry',            teamName:'Golden State Warriors',    espnId:3975,    espnRank:7,  color:'#1D428A',
    ...
    ranks:{ pts:10, reb:46, ast:25, stl:20, blk:34, threePM:1, fgPct:38, ftPct:1, tov:15 } },
  { id:'lebron',    name:'LeBron James',             teamName:'Los Angeles Lakers',       espnId:1966,    espnRank:8,  color:'#552583',
    stats:{ pts:21.7, reb:5.7, ast:7.2, stl:1.1, blk:0.6, threePM:1.4, fgPct:49.9, ftPct:74.9, tov:3.1 },
    ranks:{ pts:23, reb:27, ast:9, stl:21, blk:24, threePM:34, fgPct:18, ftPct:41, tov:11 } },
  { id:'durant',    name:'Kevin Durant',             teamName:'Houston Rockets',          espnId:3202,    espnRank:9,  color:'#CE1141',
    stats:{ pts:26.0, reb:5.4, ast:4.4, stl:0.8, blk:0.9, threePM:2.3, fgPct:51.0, ftPct:88.2, tov:3.2 },
    ranks:{ pts:14, reb:31, ast:28, stl:41, blk:12, threePM:12, fgPct:12, ftPct:11, tov:10 } },
  { id:'brunson',   name:'Jalen Brunson',            teamName:'New York Knicks',          espnId:3934672, espnRank:10, color:'#006BB6',
    stats:{ pts:27.1, reb:3.4, ast:6.1, stl:0.7, blk:0.1, threePM:2.9, fgPct:47.2, ftPct:85.0, tov:2.3 },
  ...
  { id:'jwilliams', name:'Jalen Williams',           teamName:'Oklahoma City Thunder',    espnId:4593803, espnRank:11, color:'#007AC1',
    ...
    ranks:{ pts:40, reb:36, ast:21, stl:14, blk:38, threePM:41, fgPct:30, ftPct:22, tov:38 } },
  { id:'cade',      name:'Cade Cunningham',          teamName:'Detroit Pistons',          espnId:4432166, espnRank:12, color:'#C8102E',
    stats:{ pts:25.7, reb:5.7, ast:9.7, stl:1.5, blk:0.9, threePM:2.0, fgPct:46.3, ftPct:81.0, tov:3.7 },
    ranks:{ pts:15, reb:28, ast:2, stl:5, blk:13, threePM:15, fgPct:41, ftPct:28, tov:3 } },
  { id:'mobley',    name:'Evan Mobley',              teamName:'Cleveland Cavaliers',      espnId:4432158, espnRank:13, color:'#860038',
    stats:{ pts:17.7, reb:8.8, ast:4.0, stl:0.9, blk:1.9, threePM:1.1, fgPct:51.3, ftPct:63.5, tov:2.1 },
    ranks:{ pts:38, reb:12, ast:31, stl:36, blk:2, threePM:38, fgPct:10, ftPct:49, tov:34 } },
  { id:'adavis',    name:'Anthony Davis',            teamName:'Dallas Mavericks',         espnId:6583,    espnRank:14, color:'#003DA5',
    ...
    ranks:{ pts:27, reb:6, ast:40, stl:22, blk:4, threePM:45, fgPct:14, ftPct:43, tov:36 } },
  { id:'mitchell',  name:'Donovan Mitchell',         teamName:'Cleveland Cavaliers',      espnId:3908809, espnRank:15, color:'#860038',
    stats:{ pts:28.8, reb:4.4, ast:5.9, stl:1.5, blk:0.3, threePM:3.6, fgPct:48.6, ftPct:85.6, tov:3.1 },
    ranks:{ pts:6, reb:39, ast:17, stl:6, blk:39, threePM:3, fgPct:25, ftPct:18, tov:12 } },
  { id:'booker',    name:'Devin Booker',             teamName:'Phoenix Suns',             espnId:3136193, espnRank:16, color:'#1D1160',
    ...
    ranks:{ pts:17, reb:44, ast:16, stl:37, blk:40, threePM:28, fgPct:43, ftPct:14, tov:9 } },
  { id:'banchero',  name:'Paolo Banchero',           teamName:'Orlando Magic',            espnId:4432573, espnRank:17, color:'#0077C0',
    stats:{ pts:21.5, reb:8.3, ast:4.8, stl:0.7, blk:0.6, threePM:1.2, fgPct:45.4, ftPct:76.5, tov:2.8 },
    ranks:{ pts:24, reb:16, ast:26, stl:44, blk:25, threePM:37, fgPct:44, ftPct:40, tov:16 } },
  { id:'butler',    name:'Jimmy Butler',             teamName:'Golden State Warriors',    espnId:6430,    espnRank:18, color:'#1D428A',
    ...
    ranks:{ pts:28, reb:30, ast:24, stl:9, blk:44, threePM:42, fgPct:9, ftPct:12, tov:43 } },
  { id:'jbrown',    name:'Jaylen Brown',             teamName:'Boston Celtics',           espnId:3917376, espnRank:19, color:'#007A33',
    stats:{ pts:29.2, reb:7.0, ast:4.8, stl:1.0, blk:0.4, threePM:2.0, fgPct:48.4, ftPct:77.7, tov:3.6 },
    ranks:{ pts:4, reb:20, ast:27, stl:28, blk:35, threePM:16, fgPct:26, ftPct:38, tov:4 } },
  { id:'kawhi',     name:'Kawhi Leonard',            teamName:'LA Clippers',              espnId:6450,    espnRank:20, color:'#C8102E',
    stats:{ pts:27.8, reb:6.3, ast:3.7, stl:2.0, blk:0.5, threePM:2.7, fgPct:49.2, ftPct:90.9, tov:2.2 },
    ranks:{ pts:9, reb:24, ast:36, stl:1, blk:29, threePM:11, fgPct:23, ftPct:3, tov:30 } },
  { id:'adebayo',   name:'Bam Adebayo',              teamName:'Miami Heat',               espnId:4066261, espnRank:21, color:'#98002E',
    stats:{ pts:18.4, reb:9.9, ast:2.8, stl:1.0, blk:0.7, threePM:1.6, fgPct:44.5, ftPct:77.5, tov:1.8 },
    ranks:{ pts:36, reb:10, ast:41, stl:29, blk:23, threePM:29, fgPct:46, ftPct:39, tov:40 } },
  { id:'siakam',    name:'Pascal Siakam',            teamName:'Indiana Pacers',           espnId:3149673, espnRank:22, color:'#002D62',
    ...
    ranks:{ pts:20, reb:23, ast:33, stl:23, blk:30, threePM:23, fgPct:29, ftPct:47, tov:31 } },
  { id:'harden',    name:'James Harden',             teamName:'LA Clippers',              espnId:3992,    espnRank:23, color:'#C8102E',
    stats:{ pts:24.7, reb:4.8, ast:8.2, stl:1.3, blk:0.4, threePM:3.0, fgPct:42.4, ftPct:90.1, tov:3.6 },
    ranks:{ pts:18, reb:35, ast:5, stl:15, blk:36, threePM:7, fgPct:47, ftPct:4, tov:5 } },
  { id:'holmgren',  name:'Chet Holmgren',            teamName:'Oklahoma City Thunder',    espnId:4433255, espnRank:24, color:'#007AC1',
    stats:{ pts:17.4, reb:8.6, ast:1.6, stl:0.5, blk:1.9, threePM:1.3, fgPct:55.9, ftPct:79.3, tov:1.6 },
    ranks:{ pts:42, reb:13, ast:50, stl:48, blk:3, threePM:35, fgPct:6, ftPct:33, tov:44 } },
  { id:'sengun',    name:'Alperen Sengun',           teamName:'Houston Rockets',          espnId:4871144, espnRank:25, color:'#CE1141',
    stats:{ pts:20.5, reb:9.2, ast:6.3, stl:1.4, blk:1.0, threePM:0.6, fgPct:49.5, ftPct:69.0, tov:3.1 },
    ranks:{ pts:26, reb:11, ast:13, stl:10, blk:11, threePM:43, fgPct:19, ftPct:46, tov:13 } },
  { id:'dwhite',    name:'Derrick White',            teamName:'Boston Celtics',           espnId:3078576, espnRank:26, color:'#007A33',
    stats:{ pts:17.1, reb:4.4, ast:5.6, stl:1.2, blk:1.5, threePM:2.8, fgPct:38.8, ftPct:89.6, tov:1.8 },
    ranks:{ pts:43, reb:40, ast:19, stl:18, blk:7, threePM:9, fgPct:50, ftPct:6, tov:41 } },
  { id:'kat',       name:'Karl-Anthony Towns',       teamName:'New York Knicks',          espnId:3136195, espnRank:27, color:'#006BB6',
    stats:{ pts:19.8, reb:11.9, ast:2.9, stl:0.9, blk:0.6, threePM:1.6, fgPct:46.7, ftPct:85.7, tov:2.5 },
    ranks:{ pts:29, reb:2, ast:38, stl:38, blk:26, threePM:30, fgPct:39, ftPct:17, tov:24 } },
  { id:'maxey',     name:'Tyrese Maxey',             teamName:'Philadelphia 76ers',       espnId:4431678, espnRank:28, color:'#006BB6',
    stats:{ pts:28.9, reb:4.1, ast:6.7, stl:1.9, blk:0.8, threePM:3.4, fgPct:46.7, ftPct:89.2, tov:2.4 },
    ranks:{ pts:5, reb:43, ast:11, stl:2, blk:17, threePM:5, fgPct:40, ftPct:8, tov:26 } },
  { id:'trae',      name:'Trae Young',               teamName:'Atlanta Hawks',            espnId:4277905, espnRank:29, color:'#C8102E',
    ...
    ranks:{ pts:33, reb:50, ast:3, stl:30, blk:49, threePM:24, fgPct:48, ftPct:13, tov:22 } },
  { id:'barnes',    name:'Scottie Barnes',           teamName:'Toronto Raptors',          espnId:4433134, espnRank:30, color:'#CE1141',
    stats:{ pts:19.2, reb:8.4, ast:5.6, stl:1.3, blk:1.6, threePM:0.9, fgPct:50.1, ftPct:82.3, tov:2.7 },
    ranks:{ pts:35, reb:14, ast:20, stl:16, blk:5, threePM:40, fgPct:17, ftPct:26, tov:19 } },
  { id:'jjj',       name:'Jaren Jackson Jr.',        teamName:'Memphis Grizzlies',        espnId:4277961, espnRank:31, color:'#5D76A9',
    ...
    ranks:{ pts:31, reb:29, ast:47, stl:24, blk:8, threePM:25, fgPct:33, ftPct:29, tov:32 } },
  { id:'fwagner',   name:'Franz Wagner',             teamName:'Orlando Magic',            espnId:4566434, espnRank:32, color:'#0077C0',
    ...
    ranks:{ pts:25, reb:26, ast:37, stl:25, blk:41, threePM:32, fgPct:31, ftPct:24, tov:42 } },
  { id:'morant',    name:'Ja Morant',                teamName:'Memphis Grizzlies',        espnId:4279888, espnRank:33, color:'#5D76A9',
    ...
    ranks:{ pts:32, reb:48, ast:7, stl:31, blk:42, threePM:39, fgPct:49, ftPct:5, tov:6 } },
  { id:'sabonis',   name:'Domantas Sabonis',         teamName:'Sacramento Kings',         espnId:3155942, espnRank:34, color:'#5A2D81',
    ...
    ranks:{ pts:46, reb:3, ast:29, stl:39, blk:45, threePM:46, fgPct:8, ftPct:44, tov:20 } },
  { id:'fox',       name:"De'Aaron Fox",             teamName:'San Antonio Spurs',        espnId:4066259, espnRank:35, color:'#C4CED4',
    stats:{ pts:19.3, reb:3.8, ast:6.3, stl:1.2, blk:0.3, threePM:2.0, fgPct:48.3, ftPct:79.7, tov:2.4 },
    ranks:{ pts:34, reb:45, ast:14, stl:19, blk:43, threePM:17, fgPct:27, ftPct:30, tov:27 } },
  { id:'zubac',     name:'Ivica Zubac',              teamName:'LA Clippers',              espnId:4017837, espnRank:36, color:'#C8102E',
    ...
    ranks:{ pts:49, reb:7, ast:45, stl:50, blk:18, threePM:48, fgPct:4, ftPct:45, tov:39 } },
  { id:'amen',      name:'Amen Thompson',            teamName:'Houston Rockets',          espnId:4684740, espnRank:37, color:'#CE1141',
    stats:{ pts:17.5, reb:7.6, ast:5.3, stl:1.5, blk:0.6, threePM:0.3, fgPct:50.4, ftPct:78.7, tov:2.5 },
    ranks:{ pts:41, reb:18, ast:23, stl:7, blk:27, threePM:47, fgPct:15, ftPct:35, tov:25 } },
  { id:'garland',   name:'Darius Garland',           teamName:'Cleveland Cavaliers',      espnId:4396907, espnRank:38, color:'#860038',
    ...
    ranks:{ pts:37, reb:49, ast:10, stl:42, blk:50, threePM:13, fgPct:45, ftPct:15, tov:17 } },
  { id:'dbane',     name:'Desmond Bane',             teamName:'Orlando Magic',            espnId:4066320, espnRank:39, color:'#0077C0',
    stats:{ pts:19.6, reb:4.2, ast:4.1, stl:0.9, blk:0.5, threePM:1.9, fgPct:47.4, ftPct:92.6, tov:2.1 },
    ranks:{ pts:30, reb:41, ast:30, stl:40, blk:31, threePM:20, fgPct:34, ftPct:2, tov:35 } },
  { id:'agordon',   name:'Aaron Gordon',             teamName:'Denver Nuggets',           espnId:3064290, espnRank:40, color:'#0E2240',
    ...
    ranks:{ pts:39, reb:25, ast:43, stl:45, blk:46, threePM:26, fgPct:13, ftPct:34, tov:49 } },
  { id:'og',        name:'OG Anunoby',               teamName:'New York Knicks',          espnId:3934719, espnRank:41, color:'#006BB6',
    stats:{ pts:16.4, reb:5.4, ast:2.3, stl:1.7, blk:0.8, threePM:2.0, fgPct:47.3, ftPct:79.6, tov:2.0 },
    ranks:{ pts:45, reb:32, ast:44, stl:3, blk:19, threePM:18, fgPct:36, ftPct:31, tov:37 } },
  { id:'randle',    name:'Julius Randle',            teamName:'Minnesota Timberwolves',   espnId:3064514, espnRank:42, color:'#0C2340',
    stats:{ pts:22.2, reb:6.9, ast:5.4, stl:1.1, blk:0.2, threePM:1.5, fgPct:48.8, ftPct:82.5, tov:2.6 },
    ranks:{ pts:22, reb:22, ast:22, stl:26, blk:47, threePM:33, fgPct:24, ftPct:25, tov:23 } },
  { id:'lauri',     name:'Lauri Markkanen',          teamName:'Utah Jazz',                espnId:4066336, espnRank:43, color:'#002B5C',
    ...
    ranks:{ pts:12, reb:21, ast:46, stl:32, blk:32, threePM:10, fgPct:32, ftPct:9, tov:45 } },
  { id:'jjohnson',  name:'Jalen Johnson',            teamName:'Atlanta Hawks',            espnId:4701230, espnRank:44, color:'#C8102E',
    stats:{ pts:23.3, reb:10.7, ast:8.2, stl:1.3, blk:0.5, threePM:1.6, fgPct:49.4, ftPct:78.5, tov:3.4 },
    ranks:{ pts:21, reb:8, ast:6, stl:17, blk:33, threePM:31, fgPct:21, ftPct:36, tov:7 } },
  { id:'jallen',    name:'Jarrett Allen',            teamName:'Cleveland Cavaliers',      espnId:4066328, espnRank:45, color:'#860038',
    stats:{ pts:14.9, reb:8.4, ast:2.0, stl:1.0, blk:0.9, threePM:0.0, fgPct:62.7, ftPct:73.7, tov:1.3 },
    ranks:{ pts:48, reb:15, ast:48, stl:33, blk:14, threePM:49, fgPct:3, ftPct:42, tov:46 } },
  { id:'jmurray',   name:'Jamal Murray',             teamName:'Denver Nuggets',           espnId:3936299, espnRank:46, color:'#0E2240',
    stats:{ pts:25.6, reb:4.5, ast:7.6, stl:1.0, blk:0.4, threePM:3.2, fgPct:48.2, ftPct:88.7, tov:2.3 },
    ranks:{ pts:16, reb:37, ast:8, stl:34, blk:37, threePM:6, fgPct:28, ftPct:10, tov:29 } },
  { id:'embiid',    name:'Joel Embiid',              teamName:'Philadelphia 76ers',       espnId:3059318, espnRank:47, color:'#006BB6',
    ...
    ranks:{ pts:13, reb:19, ast:34, stl:47, blk:10, threePM:36, fgPct:22, ftPct:16, tov:14 } },
  { id:'mbridges',  name:'Mikal Bridges',            teamName:'New York Knicks',          espnId:3147657, espnRank:48, color:'#006BB6',
    stats:{ pts:15.8, reb:4.2, ast:4.0, stl:1.4, blk:0.8, threePM:2.1, fgPct:50.4, ftPct:82.9, tov:1.1 },
    ranks:{ pts:47, reb:42, ast:32, stl:11, blk:20, threePM:14, fgPct:16, ftPct:23, tov:48 } },
  { id:'gobert',    name:'Rudy Gobert',              teamName:'Minnesota Timberwolves',   espnId:3032976, espnRank:49, color:'#0C2340',
    stats:{ pts:11.2, reb:11.3, ast:1.7, stl:0.7, blk:1.6, threePM:0.0, fgPct:70.6, ftPct:50.2, tov:1.3 },
    ranks:{ pts:50, reb:4, ast:49, stl:46, blk:6, threePM:50, fgPct:1, ftPct:50, tov:47 } },
  { id:'porzingis', name:'Kristaps Porzingis',       teamName:'Atlanta Hawks',            espnId:3102531, espnRank:50, color:'#C8102E',
    ...
    ranks:{ pts:44, reb:34, ast:42, stl:49, blk:9, threePM:27, fgPct:42, ftPct:20, tov:50 } },
];
