...
const PLAYERS = [
  { id:'jokic',     name:'Nikola Jokic',            teamName:'Denver Nuggets',          espnId:3112335, espnRank:1,  color:'#0E2240',
    ...
    ranks:{ pts:5, reb:1, ast:1, stl:8, blk:15, threePM:19, fgPct:5, ftPct:22, tov:2 } },
  { id:'sga',       name:'Shai Gilgeous-Alexander',  teamName:'Oklahoma City Thunder',    espnId:4278073, espnRank:2,  color:'#007AC1',
    stats:{ pts:31.7, reb:4.4, ast:6.5, stl:1.4, blk:0.8, threePM:1.7, fgPct:55.1, ftPct:89.3, tov:2.1 },
    ranks:{ pts:2, reb:38, ast:12, stl:9, blk:16, threePM:27, fgPct:7, ftPct:7, tov:32 } },
  { id:'luka',      name:'Luka Doncic',              teamName:'Los Angeles Lakers',       espnId:3945274, espnRank:3,  color:'#552583',
    ...
    ranks:{ pts:1, reb:17, ast:4, stl:6, blk:28, threePM:2, fgPct:37, ftPct:36, tov:1 } },
  { id:'giannis',   name:'Giannis Antetokounmpo',    teamName:'Milwaukee Bucks',          espnId:3032977, espnRank:4,  color:'#00471B',
    stats:{ pts:27.6, reb:9.9, ast:5.4, stl:0.9, blk:0.7, threePM:0.5, fgPct:63.7, ftPct:65.5, tov:3.3 },
    ranks:{ pts:9, reb:9, ast:19, stl:35, blk:22, threePM:43, fgPct:2, ftPct:48, tov:8 } },
  { id:'wemby',     name:'Victor Wembanyama',        teamName:'San Antonio Spurs',        espnId:5104157, espnRank:5,  color:'#C4CED4',
    ...
    ranks:{ pts:20, reb:5, ast:38, stl:29, blk:1, threePM:21, fgPct:16, ftPct:27, tov:21 } },
  { id:'edwards',   name:'Anthony Edwards',          teamName:'Minnesota Timberwolves',   espnId:4594268, espnRank:6,  color:'#0C2340',
    stats:{ pts:29.5, reb:5.2, ast:3.7, stl:1.4, blk:0.8, threePM:3.5, fgPct:49.5, ftPct:78.6, tov:2.8 },
    ranks:{ pts:3, reb:32, ast:35, stl:10, blk:17, threePM:3, fgPct:21, ftPct:31, tov:17 } },
  ...
  { id:'lebron',    name:'LeBron James',             teamName:'Los Angeles Lakers',       espnId:1966,    espnRank:8,  color:'#552583',
    ...
    ranks:{ pts:24, reb:29, ast:9, stl:21, blk:24, threePM:33, fgPct:14, ftPct:41, tov:13 } },
  { id:'durant',    name:'Kevin Durant',             teamName:'Houston Rockets',          espnId:3202,    espnRank:9,  color:'#CE1141',
    ...
    ranks:{ pts:14, reb:31, ast:28, stl:41, blk:12, threePM:12, fgPct:12, ftPct:10, tov:9 } },
  { id:'brunson',   name:'Jalen Brunson',            teamName:'New York Knicks',          espnId:3934672, espnRank:10, color:'#006BB6',
    ...
    ranks:{ pts:13, reb:47, ast:13, stl:44, blk:48, threePM:9, fgPct:39, ftPct:18, tov:29 } },
  { id:'jwilliams', name:'Jalen Williams',           teamName:'Oklahoma City Thunder',    espnId:4593803, espnRank:11, color:'#007AC1',
    ...
    ranks:{ pts:39, reb:36, ast:20, stl:14, blk:38, threePM:41, fgPct:32, ftPct:21, tov:37 } },
  { id:'cade',      name:'Cade Cunningham',          teamName:'Detroit Pistons',          espnId:4432166, espnRank:12, color:'#C8102E',
    ...
    ranks:{ pts:16, reb:26, ast:2, stl:7, blk:13, threePM:17, fgPct:43, ftPct:28, tov:3 } },
  { id:'mobley',    name:'Evan Mobley',              teamName:'Cleveland Cavaliers',      espnId:4432158, espnRank:13, color:'#860038',
    ...
    ranks:{ pts:37, reb:13, ast:34, stl:36, blk:3, threePM:37, fgPct:11, ftPct:49, tov:34 } },
  ...
  { id:'booker',    name:'Devin Booker',             teamName:'Phoenix Suns',             espnId:3136193, espnRank:16, color:'#1D1160',
    ...
    ranks:{ pts:17, reb:43, ast:16, stl:37, blk:40, threePM:22, fgPct:45, ftPct:12, tov:10 } },
  { id:'banchero',  name:'Paolo Banchero',           teamName:'Orlando Magic',            espnId:4432573, espnRank:17, color:'#0077C0',
    stats:{ pts:22.0, reb:8.5, ast:5.0, stl:0.7, blk:0.6, threePM:1.2, fgPct:45.8, ftPct:77.2, tov:2.9 },
    ranks:{ pts:22, reb:14, ast:25, stl:45, blk:25, threePM:38, fgPct:42, ftPct:37, tov:15 } },
  { id:'butler',    name:'Jimmy Butler',             teamName:'Golden State Warriors',    espnId:6430,    espnRank:18, color:'#1D428A',
    ...
    ranks:{ pts:29, reb:30, ast:26, stl:11, blk:45, threePM:42, fgPct:9, ftPct:13, tov:43 } },
  { id:'jbrown',    name:'Jaylen Brown',             teamName:'Boston Celtics',           espnId:3917376, espnRank:19, color:'#007A33',
    ...
    ranks:{ pts:6, reb:20, ast:24, stl:30, blk:34, threePM:15, fgPct:31, ftPct:35, tov:5 } },
  { id:'kawhi',     name:'Kawhi Leonard',            teamName:'LA Clippers',              espnId:6450,    espnRank:20, color:'#C8102E',
    stats:{ pts:27.9, reb:6.4, ast:3.7, stl:2.0, blk:0.5, threePM:2.6, fgPct:49.7, ftPct:90.6, tov:2.1 },
    ranks:{ pts:8, reb:24, ast:36, stl:1, blk:29, threePM:11, fgPct:20, ftPct:3, tov:33 } },
  ...
  { id:'siakam',    name:'Pascal Siakam',            teamName:'Indiana Pacers',           espnId:3149673, espnRank:22, color:'#002D62',
    ...
    ranks:{ pts:19, reb:23, ast:31, stl:24, blk:35, threePM:23, fgPct:24, ftPct:47, tov:30 } },
  ...
  { id:'sengun',    name:'Alperen Sengun',           teamName:'Houston Rockets',          espnId:4871144, espnRank:25, color:'#CE1141',
    ...
    ranks:{ pts:26, reb:11, ast:14, stl:15, blk:10, threePM:45, fgPct:15, ftPct:46, tov:11 } },
  ...
  { id:'kat',       name:'Karl-Anthony Towns',       teamName:'New York Knicks',          espnId:3136195, espnRank:27, color:'#006BB6',
    ...
    ranks:{ pts:30, reb:2, ast:41, stl:38, blk:26, threePM:30, fgPct:25, ftPct:16, tov:24 } },
  { id:'maxey',     name:'Tyrese Maxey',             teamName:'Philadelphia 76ers',       espnId:4431678, espnRank:28, color:'#006BB6',
    stats:{ pts:28.9, reb:4.2, ast:6.7, stl:2.0, blk:0.8, threePM:3.3, fgPct:46.0, ftPct:89.2, tov:2.4 },
    ranks:{ pts:4, reb:41, ast:11, stl:2, blk:18, threePM:5, fgPct:41, ftPct:9, tov:26 } },
  { id:'trae',      name:'Trae Young',               teamName:'Atlanta Hawks',            espnId:4277905, espnRank:29, color:'#C8102E',
    ...
    ranks:{ pts:36, reb:50, ast:3, stl:25, blk:49, threePM:28, fgPct:48, ftPct:20, tov:22 } },
  { id:'barnes',    name:'Scottie Barnes',           teamName:'Toronto Raptors',          espnId:4433134, espnRank:30, color:'#CE1141',
    ...
    ranks:{ pts:33, reb:16, ast:21, stl:12, blk:5, threePM:40, fgPct:17, ftPct:23, tov:19 } },
  { id:'jjj',       name:'Jaren Jackson Jr.',        teamName:'Memphis Grizzlies',        espnId:4277961, espnRank:31, color:'#5D76A9',
    ...
    ranks:{ pts:31, reb:28, ast:47, stl:26, blk:8, threePM:24, fgPct:36, ftPct:29, tov:31 } },
  { id:'fwagner',   name:'Franz Wagner',             teamName:'Orlando Magic',            espnId:4566434, espnRank:32, color:'#0077C0',
    ...
    ranks:{ pts:25, reb:27, ast:37, stl:27, blk:41, threePM:31, fgPct:33, ftPct:24, tov:42 } },
  ...
  { id:'sabonis',   name:'Domantas Sabonis',         teamName:'Sacramento Kings',         espnId:3155942, espnRank:34, color:'#5A2D81',
    ...
    ranks:{ pts:46, reb:4, ast:29, stl:39, blk:46, threePM:46, fgPct:8, ftPct:43, tov:20 } },
  ...
  { id:'amen',      name:'Amen Thompson',            teamName:'Houston Rockets',          espnId:4684740, espnRank:37, color:'#CE1141',
    ...
    ranks:{ pts:38, reb:18, ast:22, stl:5, blk:27, threePM:47, fgPct:10, ftPct:39, tov:25 } },
  { id:'garland',   name:'Darius Garland',           teamName:'Cleveland Cavaliers',      espnId:4396907, espnRank:38, color:'#860038',
    stats:{ pts:17.5, reb:2.5, ast:6.8, stl:0.8, blk:0.1, threePM:2.2, fgPct:45.2, ftPct:86.4, tov:2.9 },
    ranks:{ pts:40, reb:49, ast:10, stl:42, blk:50, threePM:13, fgPct:44, ftPct:14, tov:16 } },
  { id:'dbane',     name:'Desmond Bane',             teamName:'Orlando Magic',            espnId:4066320, espnRank:39, color:'#0077C0',
    stats:{ pts:20.2, reb:4.2, ast:4.1, stl:1.0, blk:0.5, threePM:2.1, fgPct:48.5, ftPct:91.6, tov:2.0 },
    ranks:{ pts:28, reb:42, ast:30, stl:32, blk:30, threePM:16, fgPct:26, ftPct:2, tov:36 } },
  { id:'agordon',   name:'Aaron Gordon',             teamName:'Denver Nuggets',           espnId:3064290, espnRank:40, color:'#0E2240',
    ...
    ranks:{ pts:43, reb:25, ast:43, stl:46, blk:47, threePM:25, fgPct:18, ftPct:33, tov:48 } },
  { id:'og',        name:'OG Anunoby',               teamName:'New York Knicks',          espnId:3934719, espnRank:41, color:'#006BB6',
    ...
    ranks:{ pts:45, reb:33, ast:45, stl:3, blk:20, threePM:14, fgPct:34, ftPct:30, tov:39 } },
  { id:'randle',    name:'Julius Randle',            teamName:'Minnesota Timberwolves',   espnId:3064514, espnRank:42, color:'#0C2340',
    stats:{ pts:21.5, reb:6.9, ast:5.3, stl:1.1, blk:0.3, threePM:1.4, fgPct:48.3, ftPct:81.8, tov:2.6 },
    ranks:{ pts:23, reb:21, ast:23, stl:28, blk:44, threePM:34, fgPct:30, ftPct:26, tov:23 } },
  { id:'lauri',     name:'Lauri Markkanen',          teamName:'Utah Jazz',                espnId:4066336, espnRank:43, color:'#002B5C',
    ...
    ranks:{ pts:11, reb:22, ast:46, stl:33, blk:31, threePM:10, fgPct:35, ftPct:6, tov:45 } },
  ...
  { id:'jallen',    name:'Jarrett Allen',            teamName:'Cleveland Cavaliers',      espnId:4066328, espnRank:45, color:'#860038',
    ...
    ranks:{ pts:48, reb:15, ast:48, stl:34, blk:14, threePM:49, fgPct:3, ftPct:44, tov:46 } },
  ...
  { id:'embiid',    name:'Joel Embiid',              teamName:'Philadelphia 76ers',       espnId:3059318, espnRank:47, color:'#006BB6',
    ...
    ranks:{ pts:12, reb:19, ast:32, stl:47, blk:11, threePM:36, fgPct:22, ftPct:15, tov:14 } },
  { id:'mbridges',  name:'Mikal Bridges',            teamName:'New York Knicks',          espnId:3147657, espnRank:48, color:'#006BB6',
    ...
    ranks:{ pts:47, reb:44, ast:33, stl:13, blk:21, threePM:18, fgPct:19, ftPct:25, tov:49 } },
  { id:'gobert',    name:'Rudy Gobert',              teamName:'Minnesota Timberwolves',   espnId:3032976, espnRank:49, color:'#0C2340',
    stats:{ pts:10.8, reb:11.5, ast:1.7, stl:0.8, blk:1.6, threePM:0.0, fgPct:70.0, ftPct:50.2, tov:1.4 },
    ranks:{ pts:50, reb:3, ast:50, stl:43, blk:6, threePM:50, fgPct:1, ftPct:50, tov:47 } },
  { id:'porzingis', name:'Kristaps Porzingis',       teamName:'Atlanta Hawks',            espnId:3102531, espnRank:50, color:'#C8102E',
    ...
    ranks:{ pts:44, reb:35, ast:42, stl:49, blk:9, threePM:26, fgPct:40, ftPct:19, tov:50 } },
];
