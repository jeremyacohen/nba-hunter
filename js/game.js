...
const PLAYERS = [
  ...
  { id:'sga',       name:'Shai Gilgeous-Alexander',  teamName:'Oklahoma City Thunder',    espnId:4278073, espnRank:2,  color:'#007AC1',
    ...
    ranks:{ pts:2, reb:39, ast:12, stl:12, blk:16, threePM:21, fgPct:6, ftPct:7, tov:33 } },
  { id:'luka',      name:'Luka Doncic',              teamName:'Los Angeles Lakers',       espnId:3945274, espnRank:3,  color:'#552583',
    stats:{ pts:32.5, reb:7.8, ast:8.6, stl:1.4, blk:0.5, threePM:3.6, fgPct:46.8, ftPct:77.0, tov:4.1 },
    ranks:{ pts:1, reb:17, ast:4, stl:8, blk:28, threePM:2, fgPct:36, ftPct:40, tov:1 } },
  ...
  { id:'wemby',     name:'Victor Wembanyama',        teamName:'San Antonio Spurs',        espnId:5104157, espnRank:5,  color:'#C4CED4',
    ...
    ranks:{ pts:19, reb:5, ast:38, stl:27, blk:1, threePM:22, fgPct:13, ftPct:27, tov:21 } },
  { id:'edwards',   name:'Anthony Edwards',          teamName:'Minnesota Timberwolves',   espnId:4594268, espnRank:6,  color:'#0C2340',
    stats:{ pts:29.6, reb:5.3, ast:3.7, stl:1.4, blk:0.8, threePM:3.4, fgPct:49.3, ftPct:78.9, tov:2.8 },
    ranks:{ pts:3, reb:32, ast:35, stl:9, blk:17, threePM:4, fgPct:23, ftPct:31, tov:15 } },
  { id:'curry',     name:'Stephen Curry',            teamName:'Golden State Warriors',    espnId:3975,    espnRank:7,  color:'#1D428A',
    ...
    ranks:{ pts:10, reb:46, ast:27, stl:20, blk:33, threePM:1, fgPct:37, ftPct:1, tov:16 } },
  { id:'lebron',    name:'LeBron James',             teamName:'Los Angeles Lakers',       espnId:1966,    espnRank:8,  color:'#552583',
    stats:{ pts:21.7, reb:5.7, ast:7.0, stl:1.1, blk:0.6, threePM:1.4, fgPct:49.9, ftPct:75.0, tov:3.1 },
    ranks:{ pts:24, reb:28, ast:9, stl:21, blk:25, threePM:34, fgPct:16, ftPct:41, tov:12 } },
  ...
  { id:'brunson',   name:'Jalen Brunson',            teamName:'New York Knicks',          espnId:3934672, espnRank:10, color:'#006BB6',
    stats:{ pts:26.7, reb:3.4, ast:6.1, stl:0.7, blk:0.1, threePM:2.8, fgPct:46.8, ftPct:84.4, tov:2.3 },
  ...
  { id:'jwilliams', name:'Jalen Williams',           teamName:'Oklahoma City Thunder',    espnId:4593803, espnRank:11, color:'#007AC1',
    ...
    ranks:{ pts:39, reb:36, ast:21, stl:13, blk:38, threePM:41, fgPct:31, ftPct:22, tov:38 } },
  ...
  { id:'mobley',    name:'Evan Mobley',              teamName:'Cleveland Cavaliers',      espnId:4432158, espnRank:13, color:'#860038',
    stats:{ pts:17.5, reb:8.6, ast:3.9, stl:0.9, blk:1.8, threePM:1.1, fgPct:51.4, ftPct:63.5, tov:2.0 },
    ranks:{ pts:40, reb:13, ast:32, stl:37, blk:3, threePM:38, fgPct:10, ftPct:49, tov:35 } },
  ...
  { id:'mitchell',  name:'Donovan Mitchell',         teamName:'Cleveland Cavaliers',      espnId:3908809, espnRank:15, color:'#860038',
    ...
    ranks:{ pts:7, reb:37, ast:17, stl:4, blk:39, threePM:3, fgPct:25, ftPct:18, tov:13 } },
  ...
  { id:'banchero',  name:'Paolo Banchero',           teamName:'Orlando Magic',            espnId:4432573, espnRank:17, color:'#0077C0',
    stats:{ pts:21.8, reb:8.5, ast:5.0, stl:0.7, blk:0.7, threePM:1.2, fgPct:45.3, ftPct:77.3, tov:2.8 },
    ranks:{ pts:23, reb:15, ast:24, stl:45, blk:23, threePM:35, fgPct:44, ftPct:39, tov:17 } },
  { id:'butler',    name:'Jimmy Butler',             teamName:'Golden State Warriors',    espnId:6430,    espnRank:18, color:'#1D428A',
    ...
    ranks:{ pts:29, reb:30, ast:25, stl:10, blk:45, threePM:42, fgPct:9, ftPct:12, tov:43 } },
  { id:'jbrown',    name:'Jaylen Brown',             teamName:'Boston Celtics',           espnId:3917376, espnRank:19, color:'#007A33',
    ...
    ranks:{ pts:4, reb:20, ast:26, stl:28, blk:34, threePM:14, fgPct:29, ftPct:37, tov:4 } },
  { id:'kawhi',     name:'Kawhi Leonard',            teamName:'LA Clippers',              espnId:6450,    espnRank:20, color:'#C8102E',
    ...
    ranks:{ pts:9, reb:24, ast:36, stl:1, blk:29, threePM:10, fgPct:21, ftPct:3, tov:30 } },
  { id:'adebayo',   name:'Bam Adebayo',              teamName:'Miami Heat',               espnId:4066261, espnRank:21, color:'#98002E',
    ...
    ranks:{ pts:36, reb:10, ast:39, stl:29, blk:24, threePM:29, fgPct:46, ftPct:38, tov:40 } },
  ...
  { id:'harden',    name:'James Harden',             teamName:'LA Clippers',              espnId:3992,    espnRank:23, color:'#C8102E',
    ...
    ranks:{ pts:18, reb:35, ast:5, stl:17, blk:36, threePM:7, fgPct:47, ftPct:4, tov:5 } },
  { id:'holmgren',  name:'Chet Holmgren',            teamName:'Oklahoma City Thunder',    espnId:4433255, espnRank:24, color:'#007AC1',
    stats:{ pts:17.2, reb:8.8, ast:1.7, stl:0.5, blk:1.9, threePM:1.2, fgPct:55.2, ftPct:78.9, tov:1.6 },
    ranks:{ pts:42, reb:12, ast:49, stl:48, blk:2, threePM:36, fgPct:7, ftPct:32, tov:44 } },
  { id:'sengun',    name:'Alperen Sengun',           teamName:'Houston Rockets',          espnId:4871144, espnRank:25, color:'#CE1141',
    ...
    ranks:{ pts:27, reb:11, ast:13, stl:14, blk:10, threePM:43, fgPct:20, ftPct:46, tov:11 } },
  { id:'dwhite',    name:'Derrick White',            teamName:'Boston Celtics',           espnId:3078576, espnRank:26, color:'#007A33',
    stats:{ pts:17.1, reb:4.5, ast:5.7, stl:1.2, blk:1.5, threePM:2.8, fgPct:39.0, ftPct:89.0, tov:1.8 },
    ranks:{ pts:43, reb:38, ast:18, stl:18, blk:7, threePM:9, fgPct:50, ftPct:8, tov:41 } },
  { id:'kat',       name:'Karl-Anthony Towns',       teamName:'New York Knicks',          espnId:3136195, espnRank:27, color:'#006BB6',
    stats:{ pts:20.0, reb:11.7, ast:2.9, stl:0.9, blk:0.6, threePM:1.6, fgPct:47.7, ftPct:85.5, tov:2.6 },
    ranks:{ pts:30, reb:2, ast:40, stl:39, blk:26, threePM:30, fgPct:33, ftPct:17, tov:22 } },
  { id:'maxey',     name:'Tyrese Maxey',             teamName:'Philadelphia 76ers',       espnId:4431678, espnRank:28, color:'#006BB6',
    stats:{ pts:29.1, reb:4.1, ast:6.7, stl:2.0, blk:0.8, threePM:3.3, fgPct:46.7, ftPct:89.0, tov:2.5 },
    ranks:{ pts:5, reb:42, ast:11, stl:2, blk:18, threePM:5, fgPct:39, ftPct:9, tov:26 } },
  { id:'trae',      name:'Trae Young',               teamName:'Atlanta Hawks',            espnId:4277905, espnRank:29, color:'#C8102E',
    ...
    ranks:{ pts:33, reb:50, ast:3, stl:30, blk:49, threePM:24, fgPct:48, ftPct:13, tov:23 } },
  { id:'barnes',    name:'Scottie Barnes',           teamName:'Toronto Raptors',          espnId:4433134, espnRank:30, color:'#CE1141',
    stats:{ pts:19.1, reb:8.3, ast:5.6, stl:1.3, blk:1.6, threePM:0.9, fgPct:49.9, ftPct:82.4, tov:2.7 },
    ranks:{ pts:34, reb:16, ast:20, stl:15, blk:5, threePM:40, fgPct:17, ftPct:25, tov:19 } },
  { id:'jjj',       name:'Jaren Jackson Jr.',        teamName:'Memphis Grizzlies',        espnId:4277961, espnRank:31, color:'#5D76A9',
    ...
    ranks:{ pts:31, reb:29, ast:47, stl:24, blk:8, threePM:25, fgPct:35, ftPct:29, tov:32 } },
  ...
  { id:'fox',       name:"De'Aaron Fox",             teamName:'San Antonio Spurs',        espnId:4066259, espnRank:35, color:'#C4CED4',
    ...
    ranks:{ pts:35, reb:45, ast:14, stl:19, blk:43, threePM:20, fgPct:30, ftPct:33, tov:27 } },
  ...
  { id:'amen',      name:'Amen Thompson',            teamName:'Houston Rockets',          espnId:4684740, espnRank:37, color:'#CE1141',
    ...
    ranks:{ pts:41, reb:18, ast:22, stl:6, blk:27, threePM:47, fgPct:11, ftPct:35, tov:24 } },
  ...
  { id:'dbane',     name:'Desmond Bane',             teamName:'Orlando Magic',            espnId:4066320, espnRank:39, color:'#0077C0',
    stats:{ pts:20.2, reb:4.1, ast:4.1, stl:1.0, blk:0.5, threePM:2.0, fgPct:48.3, ftPct:91.4, tov:2.1 },
    ranks:{ pts:28, reb:43, ast:30, stl:32, blk:30, threePM:18, fgPct:27, ftPct:2, tov:34 } },
  { id:'agordon',   name:'Aaron Gordon',             teamName:'Denver Nuggets',           espnId:3064290, espnRank:40, color:'#0E2240',
    ...
    ranks:{ pts:38, reb:25, ast:43, stl:46, blk:47, threePM:26, fgPct:12, ftPct:34, tov:49 } },
  { id:'og',        name:'OG Anunoby',               teamName:'New York Knicks',          espnId:3934719, espnRank:41, color:'#006BB6',
    stats:{ pts:16.0, reb:5.3, ast:2.3, stl:1.7, blk:0.8, threePM:2.0, fgPct:46.7, ftPct:79.5, tov:2.0 },
    ranks:{ pts:45, reb:33, ast:44, stl:3, blk:20, threePM:19, fgPct:40, ftPct:30, tov:37 } },
  { id:'randle',    name:'Julius Randle',            teamName:'Minnesota Timberwolves',   espnId:3064514, espnRank:42, color:'#0C2340',
    stats:{ pts:21.9, reb:6.9, ast:5.3, stl:1.1, blk:0.3, threePM:1.5, fgPct:48.9, ftPct:82.1, tov:2.6 },
    ranks:{ pts:22, reb:21, ast:23, stl:26, blk:44, threePM:33, fgPct:24, ftPct:26, tov:25 } },
  { id:'lauri',     name:'Lauri Markkanen',          teamName:'Utah Jazz',                espnId:4066336, espnRank:43, color:'#002B5C',
    ...
    ranks:{ pts:12, reb:22, ast:46, stl:33, blk:31, threePM:11, fgPct:34, ftPct:6, tov:45 } },
  { id:'jjohnson',  name:'Jalen Johnson',            teamName:'Atlanta Hawks',            espnId:4701230, espnRank:44, color:'#C8102E',
    ...
    ranks:{ pts:21, reb:8, ast:7, stl:16, blk:32, threePM:31, fgPct:22, ftPct:36, tov:7 } },
  ...
  { id:'embiid',    name:'Joel Embiid',              teamName:'Philadelphia 76ers',       espnId:3059318, espnRank:47, color:'#006BB6',
    stats:{ pts:26.6, reb:7.4, ast:3.9, stl:0.6, blk:1.1, threePM:1.2, fgPct:49.8, ftPct:85.7, tov:3.0 },
    ranks:{ pts:13, reb:19, ast:34, stl:47, blk:11, threePM:37, fgPct:18, ftPct:16, tov:14 } },
  { id:'mbridges',  name:'Mikal Bridges',            teamName:'New York Knicks',          espnId:3147657, espnRank:48, color:'#006BB6',
    stats:{ pts:15.7, reb:4.2, ast:4.0, stl:1.4, blk:0.8, threePM:2.1, fgPct:49.8, ftPct:82.9, tov:1.1 },
    ranks:{ pts:47, reb:41, ast:31, stl:11, blk:21, threePM:15, fgPct:19, ftPct:23, tov:48 } },
  { id:'gobert',    name:'Rudy Gobert',              teamName:'Minnesota Timberwolves',   espnId:3032976, espnRank:49, color:'#0C2340',
    stats:{ pts:11.2, reb:11.4, ast:1.7, stl:0.8, blk:1.6, threePM:0.0, fgPct:70.8, ftPct:50.6, tov:1.4 },
