...
const PLAYERS = [
  { id:'jokic',     name:'Nikola Jokic',            teamName:'Denver Nuggets',          espnId:3112335, espnRank:1,  color:'#0E2240',
    stats:{ pts:27.9, reb:12.9, ast:10.8, stl:1.4, blk:0.8, threePM:1.8, fgPct:57.3, ftPct:82.8, tov:3.8 },
    ranks:{ pts:7, reb:1, ast:1, stl:8, blk:14, threePM:22, fgPct:5, ftPct:20, tov:2 } },
  { id:'sga',       name:'Shai Gilgeous-Alexander',  teamName:'Oklahoma City Thunder',    espnId:4278073, espnRank:2,  color:'#007AC1',
    stats:{ pts:31.6, reb:4.4, ast:6.5, stl:1.4, blk:0.8, threePM:1.7, fgPct:55.3, ftPct:88.0, tov:2.2 },
    ranks:{ pts:2, reb:38, ast:13, stl:9, blk:15, threePM:26, fgPct:6, ftPct:10, tov:30 } },
  { id:'luka',      name:'Luka Doncic',              teamName:'Los Angeles Lakers',       espnId:3945274, espnRank:3,  color:'#552583',
    stats:{ pts:33.8, reb:7.8, ast:8.3, stl:1.7, blk:0.5, threePM:4.0, fgPct:47.7, ftPct:77.9, tov:4.0 },
    ranks:{ pts:1, reb:16, ast:3, stl:3, blk:27, threePM:2, fgPct:32, ftPct:37, tov:1 } },
  ...
  { id:'curry',     name:'Stephen Curry',            teamName:'Golden State Warriors',    espnId:3975,    espnRank:7,  color:'#1D428A',
    ...
    ranks:{ pts:10, reb:46, ast:27, stl:20, blk:32, threePM:1, fgPct:39, ftPct:1, tov:17 } },
  { id:'lebron',    name:'LeBron James',             teamName:'Los Angeles Lakers',       espnId:1966,    espnRank:8,  color:'#552583',
    stats:{ pts:20.9, reb:6.0, ast:7.0, stl:1.1, blk:0.6, threePM:1.3, fgPct:51.2, ftPct:74.2, tov:3.0 },
    ranks:{ pts:25, reb:25, ast:9, stl:21, blk:24, threePM:35, fgPct:14, ftPct:41, tov:12 } },
  ...
  { id:'brunson',   name:'Jalen Brunson',            teamName:'New York Knicks',          espnId:3934672, espnRank:10, color:'#006BB6',
    ...
    ranks:{ pts:13, reb:47, ast:12, stl:40, blk:48, threePM:9, fgPct:40, ftPct:18, tov:25 } },
  { id:'jwilliams', name:'Jalen Williams',           teamName:'Oklahoma City Thunder',    espnId:4593803, espnRank:11, color:'#007AC1',
    stats:{ pts:17.3, reb:4.5, ast:5.3, stl:1.2, blk:0.3, threePM:0.7, fgPct:48.2, ftPct:82.4, tov:1.9 },
    ranks:{ pts:40, reb:36, ast:21, stl:16, blk:38, threePM:42, fgPct:30, ftPct:23, tov:36 } },
  ...
  { id:'mobley',    name:'Evan Mobley',              teamName:'Cleveland Cavaliers',      espnId:4432158, espnRank:13, color:'#860038',
    stats:{ pts:18.2, reb:8.9, ast:3.6, stl:0.8, blk:1.8, threePM:1.0, fgPct:54.4, ftPct:61.0, tov:1.9 },
    ranks:{ pts:37, reb:11, ast:35, stl:41, blk:2, threePM:38, fgPct:8, ftPct:49, tov:37 } },
  { id:'adavis',    name:'Anthony Davis',            teamName:'Dallas Mavericks',         espnId:6583,    espnRank:14, color:'#003DA5',
    ...
    ranks:{ pts:27, reb:6, ast:41, stl:22, blk:5, threePM:44, fgPct:16, ftPct:42, tov:34 } },
  { id:'mitchell',  name:'Donovan Mitchell',         teamName:'Cleveland Cavaliers',      espnId:3908809, espnRank:15, color:'#860038',
    stats:{ pts:27.7, reb:4.4, ast:5.7, stl:1.5, blk:0.3, threePM:3.2, fgPct:47.9, ftPct:86.2, tov:2.8 },
    ranks:{ pts:8, reb:39, ast:18, stl:6, blk:39, threePM:4, fgPct:31, ftPct:15, tov:18 } },
  { id:'booker',    name:'Devin Booker',             teamName:'Phoenix Suns',             espnId:3136193, espnRank:16, color:'#1D1160',
    stats:{ pts:25.8, reb:3.9, ast:6.0, stl:0.8, blk:0.3, threePM:1.9, fgPct:45.7, ftPct:86.8, tov:3.2 },
    ranks:{ pts:15, reb:43, ast:16, stl:42, blk:40, threePM:20, fgPct:44, ftPct:12, tov:10 } },
  { id:'banchero',  name:'Paolo Banchero',           teamName:'Orlando Magic',            espnId:4432573, espnRank:17, color:'#0077C0',
    ...
    ranks:{ pts:22, reb:15, ast:24, stl:45, blk:25, threePM:36, fgPct:45, ftPct:35, tov:13 } },
  ...
  { id:'jbrown',    name:'Jaylen Brown',             teamName:'Boston Celtics',           espnId:3917376, espnRank:19, color:'#007A33',
    ...
    ranks:{ pts:4, reb:20, ast:22, stl:28, blk:33, threePM:16, fgPct:35, ftPct:33, tov:4 } },
  { id:'kawhi',     name:'Kawhi Leonard',            teamName:'LA Clippers',              espnId:6450,    espnRank:20, color:'#C8102E',
    stats:{ pts:28.1, reb:6.3, ast:3.6, stl:1.9, blk:0.5, threePM:2.6, fgPct:50.3, ftPct:89.9, tov:2.1 },
    ranks:{ pts:6, reb:24, ast:36, stl:2, blk:28, threePM:12, fgPct:17, ftPct:4, tov:33 } },
  ...
  { id:'harden',    name:'James Harden',             teamName:'LA Clippers',              espnId:3992,    espnRank:23, color:'#C8102E',
    stats:{ pts:23.7, reb:4.9, ast:8.1, stl:1.1, blk:0.4, threePM:3.0, fgPct:43.4, ftPct:88.1, tov:3.5 },
    ranks:{ pts:20, reb:34, ast:4, stl:24, blk:35, threePM:7, fgPct:48, ftPct:9, tov:5 } },
  { id:'holmgren',  name:'Chet Holmgren',            teamName:'Oklahoma City Thunder',    espnId:4433255, espnRank:24, color:'#007AC1',
    stats:{ pts:17.0, reb:8.9, ast:1.7, stl:0.6, blk:1.8, threePM:1.2, fgPct:55.1, ftPct:79.9, tov:1.6 },
    ranks:{ pts:42, reb:12, ast:49, stl:46, blk:3, threePM:37, fgPct:7, ftPct:31, tov:44 } },
  { id:'sengun',    name:'Alperen Sengun',           teamName:'Houston Rockets',          espnId:4871144, espnRank:25, color:'#CE1141',
    ...
    ranks:{ pts:26, reb:13, ast:14, stl:13, blk:10, threePM:43, fgPct:11, ftPct:47, tov:11 } },
  { id:'dwhite',    name:'Derrick White',            teamName:'Boston Celtics',           espnId:3078576, espnRank:26, color:'#007A33',
    ...
    ranks:{ pts:43, reb:37, ast:19, stl:18, blk:7, threePM:10, fgPct:50, ftPct:3, tov:39 } },
  { id:'kat',       name:'Karl-Anthony Towns',       teamName:'New York Knicks',          espnId:3136195, espnRank:27, color:'#006BB6',
    ...
    ranks:{ pts:30, reb:2, ast:40, stl:43, blk:29, threePM:31, fgPct:19, ftPct:16, tov:24 } },
  { id:'maxey',     name:'Tyrese Maxey',             teamName:'Philadelphia 76ers',       espnId:4431678, espnRank:28, color:'#006BB6',
    ...
    ranks:{ pts:5, reb:41, ast:11, stl:1, blk:17, threePM:5, fgPct:41, ftPct:7, tov:26 } },
  { id:'trae',      name:'Trae Young',               teamName:'Atlanta Hawks',            espnId:4277905, espnRank:29, color:'#C8102E',
    ...
    ranks:{ pts:38, reb:50, ast:7, stl:35, blk:49, threePM:23, fgPct:43, ftPct:21, tov:22 } },
  ...
  { id:'jjj',       name:'Jaren Jackson Jr.',        teamName:'Memphis Grizzlies',        espnId:4277961, espnRank:31, color:'#5D76A9',
    ...
    ranks:{ pts:32, reb:27, ast:47, stl:25, blk:8, threePM:24, fgPct:36, ftPct:30, tov:32 } },
  { id:'fwagner',   name:'Franz Wagner',             teamName:'Orlando Magic',            espnId:4566434, espnRank:32, color:'#0077C0',
    ...
    ranks:{ pts:23, reb:30, ast:37, stl:29, blk:41, threePM:32, fgPct:37, ftPct:22, tov:42 } },
  ...
  { id:'sabonis',   name:'Domantas Sabonis',         teamName:'Sacramento Kings',         espnId:3155942, espnRank:34, color:'#5A2D81',
    ...
    ranks:{ pts:46, reb:5, ast:30, stl:36, blk:46, threePM:46, fgPct:9, ftPct:43, tov:20 } },
  { id:'fox',       name:"De'Aaron Fox",             teamName:'San Antonio Spurs',        espnId:4066259, espnRank:35, color:'#C4CED4',
    stats:{ pts:18.5, reb:3.7, ast:6.2, stl:1.2, blk:0.3, threePM:1.8, fgPct:48.7, ftPct:76.2, tov:2.3 },
    ranks:{ pts:35, reb:45, ast:15, stl:19, blk:43, threePM:25, fgPct:25, ftPct:40, tov:28 } },
  { id:'zubac',     name:'Ivica Zubac',              teamName:'LA Clippers',              espnId:4017837, espnRank:36, color:'#C8102E',
    ...
    ranks:{ pts:49, reb:7, ast:44, stl:50, blk:18, threePM:48, fgPct:4, ftPct:45, tov:40 } },
  { id:'amen',      name:'Amen Thompson',            teamName:'Houston Rockets',          espnId:4684740, espnRank:37, color:'#CE1141',
    ...
    ranks:{ pts:39, reb:17, ast:23, stl:7, blk:26, threePM:47, fgPct:10, ftPct:36, tov:27 } },
  { id:'garland',   name:'Darius Garland',           teamName:'Cleveland Cavaliers',      espnId:4396907, espnRank:38, color:'#860038',
    stats:{ pts:19.1, reb:2.4, ast:6.9, stl:0.9, blk:0.1, threePM:2.9, fgPct:46.9, ftPct:86.5, tov:3.0 },
    ranks:{ pts:34, reb:49, ast:10, stl:37, blk:50, threePM:8, fgPct:38, ftPct:13, tov:14 } },
  ...
  { id:'og',        name:'OG Anunoby',               teamName:'New York Knicks',          espnId:3934719, espnRank:41, color:'#006BB6',
    ...
    ranks:{ pts:44, reb:32, ast:45, stl:4, blk:23, threePM:14, fgPct:27, ftPct:26, tov:38 } },
  { id:'randle',    name:'Julius Randle',            teamName:'Minnesota Timberwolves',   espnId:3064514, espnRank:42, color:'#0C2340',
    stats:{ pts:21.0, reb:6.8, ast:5.1, stl:1.1, blk:0.2, threePM:1.4, fgPct:47.7, ftPct:80.9, tov:2.7 },
    ranks:{ pts:24, reb:22, ast:25, stl:26, blk:47, threePM:33, fgPct:33, ftPct:29, tov:21 } },
  ...
  { id:'jjohnson',  name:'Jalen Johnson',            teamName:'Atlanta Hawks',            espnId:4701230, espnRank:44, color:'#C8102E',
    ...
    ranks:{ pts:21, reb:8, ast:6, stl:14, blk:31, threePM:30, fgPct:23, ftPct:34, tov:7 } },
  { id:'jallen',    name:'Jarrett Allen',            teamName:'Cleveland Cavaliers',      espnId:4066328, espnRank:45, color:'#860038',
    stats:{ pts:15.4, reb:8.4, ast:1.9, stl:1.0, blk:0.8, threePM:0.0, fgPct:64.3, ftPct:72.1, tov:1.3 },
    ranks:{ pts:47, reb:14, ast:48, stl:33, blk:19, threePM:49, fgPct:2, ftPct:44, tov:47 } },
  ...
  { id:'embiid',    name:'Joel Embiid',              teamName:'Philadelphia 76ers',       espnId:3059318, espnRank:47, color:'#006BB6',
    ...
    ranks:{ pts:11, reb:19, ast:31, stl:48, blk:11, threePM:34, fgPct:21, ftPct:17, tov:15 } },
  { id:'mbridges',  name:'Mikal Bridges',            teamName:'New York Knicks',          espnId:3147657, espnRank:48, color:'#006BB6',
    ...
    ranks:{ pts:48, reb:44, ast:33, stl:15, blk:20, threePM:18, fgPct:24, ftPct:24, tov:50 } },
  { id:'gobert',    name:'Rudy Gobert',              teamName:'Minnesota Timberwolves',   espnId:3032976, espnRank:49, color:'#0C2340',
    stats:{ pts:11.1, reb:11.5, ast:1.7, stl:0.8, blk:1.7, threePM:0.0, fgPct:69.3, ftPct:52.7, tov:1.4 },
    ranks:{ pts:50, reb:4, ast:50, stl:44, blk:4, threePM:50, fgPct:1, ftPct:50, tov:46 } },
  { id:'porzingis', name:'Kristaps Porzingis',       teamName:'Atlanta Hawks',            espnId:3102531, espnRank:50, color:'#C8102E',
    stats:{ pts:17.3, reb:4.9, ast:2.6, stl:0.6, blk:1.3, threePM:1.9, fgPct:45.4, ftPct:83.1, tov:1.2 },
    ranks:{ pts:41, reb:35, ast:42, stl:49, blk:9, threePM:21, fgPct:46, ftPct:19, tov:48 } },
];
