...
const PLAYERS = [
  ...
  { id:'sga',       name:'Shai Gilgeous-Alexander',  teamName:'Oklahoma City Thunder',    espnId:4278073, espnRank:2,  color:'#007AC1',
    ...
    ranks:{ pts:2, reb:38, ast:13, stl:9, blk:15, threePM:26, fgPct:6, ftPct:10, tov:31 } },
  { id:'luka',      name:'Luka Doncic',              teamName:'Los Angeles Lakers',       espnId:3945274, espnRank:3,  color:'#552583',
    ...
    ranks:{ pts:1, reb:16, ast:3, stl:3, blk:27, threePM:2, fgPct:33, ftPct:37, tov:1 } },
  ...
  { id:'wemby',     name:'Victor Wembanyama',        teamName:'San Antonio Spurs',        espnId:5104157, espnRank:5,  color:'#C4CED4',
    stats:{ pts:24.5, reb:11.4, ast:3.0, stl:1.1, blk:3.1, threePM:1.9, fgPct:50.4, ftPct:82.2, tov:2.5 },
    ranks:{ pts:17, reb:4, ast:38, stl:19, blk:1, threePM:18, fgPct:17, ftPct:24, tov:23 } },
  { id:'edwards',   name:'Anthony Edwards',          teamName:'Minnesota Timberwolves',   espnId:4594268, espnRank:6,  color:'#0C2340',
    ...
    ranks:{ pts:3, reb:32, ast:34, stl:10, blk:16, threePM:3, fgPct:22, ftPct:32, tov:16 } },
  { id:'curry',     name:'Stephen Curry',            teamName:'Golden State Warriors',    espnId:3975,    espnRank:7,  color:'#1D428A',
    ...
    ranks:{ pts:10, reb:46, ast:27, stl:20, blk:31, threePM:1, fgPct:39, ftPct:1, tov:17 } },
  ...
  { id:'durant',    name:'Kevin Durant',             teamName:'Houston Rockets',          espnId:3202,    espnRank:9,  color:'#CE1141',
    stats:{ pts:25.9, reb:5.4, ast:4.6, stl:0.8, blk:0.9, threePM:2.4, fgPct:51.8, ftPct:87.8, tov:3.2 },
  ...
  { id:'brunson',   name:'Jalen Brunson',            teamName:'New York Knicks',          espnId:3934672, espnRank:10, color:'#006BB6',
    stats:{ pts:26.3, reb:3.4, ast:6.7, stl:0.8, blk:0.1, threePM:2.7, fgPct:46.6, ftPct:84.3, tov:2.4 },
    ranks:{ pts:13, reb:47, ast:11, stl:41, blk:48, threePM:9, fgPct:40, ftPct:18, tov:25 } },
  { id:'jwilliams', name:'Jalen Williams',           teamName:'Oklahoma City Thunder',    espnId:4593803, espnRank:11, color:'#007AC1',
    ...
    ranks:{ pts:40, reb:36, ast:21, stl:15, blk:38, threePM:42, fgPct:29, ftPct:23, tov:36 } },
  { id:'cade',      name:'Cade Cunningham',          teamName:'Detroit Pistons',          espnId:4432166, espnRank:12, color:'#C8102E',
    ...
    ranks:{ pts:18, reb:29, ast:2, stl:5, blk:13, threePM:15, fgPct:41, ftPct:28, tov:3 } },
  { id:'mobley',    name:'Evan Mobley',              teamName:'Cleveland Cavaliers',      espnId:4432158, espnRank:13, color:'#860038',
    stats:{ pts:18.4, reb:9.0, ast:3.6, stl:0.8, blk:1.8, threePM:1.0, fgPct:54.5, ftPct:60.7, tov:1.9 },
    ranks:{ pts:37, reb:11, ast:35, stl:42, blk:2, threePM:38, fgPct:8, ftPct:49, tov:37 } },
  { id:'adavis',    name:'Anthony Davis',            teamName:'Dallas Mavericks',         espnId:6583,    espnRank:14, color:'#003DA5',
    ...
    ranks:{ pts:27, reb:6, ast:40, stl:22, blk:5, threePM:44, fgPct:15, ftPct:42, tov:34 } },
  { id:'mitchell',  name:'Donovan Mitchell',         teamName:'Cleveland Cavaliers',      espnId:3908809, espnRank:15, color:'#860038',
    ...
    ranks:{ pts:8, reb:39, ast:18, stl:6, blk:39, threePM:5, fgPct:31, ftPct:15, tov:18 } },
  ...
  { id:'banchero',  name:'Paolo Banchero',           teamName:'Orlando Magic',            espnId:4432573, espnRank:17, color:'#0077C0',
    stats:{ pts:22.6, reb:8.3, ast:5.1, stl:0.6, blk:0.6, threePM:1.2, fgPct:45.8, ftPct:78.0, tov:3.0 },
    ranks:{ pts:22, reb:15, ast:24, stl:45, blk:25, threePM:36, fgPct:43, ftPct:36, tov:13 } },
  { id:'butler',    name:'Jimmy Butler',             teamName:'Golden State Warriors',    espnId:6430,    espnRank:18, color:'#1D428A',
    ...
    ranks:{ pts:31, reb:30, ast:26, stl:11, blk:45, threePM:41, fgPct:11, ftPct:14, tov:43 } },
  { id:'jbrown',    name:'Jaylen Brown',             teamName:'Boston Celtics',           espnId:3917376, espnRank:19, color:'#007A33',
    stats:{ pts:28.6, reb:7.1, ast:5.2, stl:1.0, blk:0.4, threePM:1.9, fgPct:47.4, ftPct:79.6, tov:3.6 },
    ranks:{ pts:5, reb:20, ast:23, stl:29, blk:32, threePM:20, fgPct:37, ftPct:33, tov:4 } },
  { id:'kawhi',     name:'Kawhi Leonard',            teamName:'LA Clippers',              espnId:6450,    espnRank:20, color:'#C8102E',
    ...
    ranks:{ pts:6, reb:24, ast:36, stl:2, blk:28, threePM:12, fgPct:18, ftPct:4, tov:33 } },
  { id:'adebayo',   name:'Bam Adebayo',              teamName:'Miami Heat',               espnId:4066261, espnRank:21, color:'#98002E',
    stats:{ pts:20.1, reb:10.0, ast:3.0, stl:1.1, blk:0.7, threePM:1.7, fgPct:43.8, ftPct:78.2, tov:1.7 },
    ranks:{ pts:29, reb:9, ast:39, stl:23, blk:22, threePM:27, fgPct:47, ftPct:35, tov:41 } },
  { id:'siakam',    name:'Pascal Siakam',            teamName:'Indiana Pacers',           espnId:3149673, espnRank:22, color:'#002D62',
    stats:{ pts:23.8, reb:6.7, ast:3.8, stl:1.1, blk:0.4, threePM:1.7, fgPct:48.0, ftPct:69.2, tov:2.3 },
    ranks:{ pts:19, reb:23, ast:32, stl:24, blk:33, threePM:28, fgPct:30, ftPct:46, tov:28 } },
  { id:'harden',    name:'James Harden',             teamName:'LA Clippers',              espnId:3992,    espnRank:23, color:'#C8102E',
    ...
    ranks:{ pts:20, reb:34, ast:4, stl:25, blk:34, threePM:7, fgPct:48, ftPct:9, tov:5 } },
  ...
  { id:'sengun',    name:'Alperen Sengun',           teamName:'Houston Rockets',          espnId:4871144, espnRank:25, color:'#CE1141',
    stats:{ pts:20.5, reb:8.9, ast:6.2, stl:1.2, blk:1.1, threePM:0.6, fgPct:51.8, ftPct:68.6, tov:3.2 },
    ranks:{ pts:26, reb:13, ast:14, stl:16, blk:10, threePM:43, fgPct:13, ftPct:47, tov:11 } },
  { id:'dwhite',    name:'Derrick White',            teamName:'Boston Celtics',           espnId:3078576, espnRank:26, color:'#007A33',
    stats:{ pts:17.0, reb:4.5, ast:5.5, stl:1.2, blk:1.4, threePM:2.7, fgPct:39.1, ftPct:90.0, tov:1.8 },
    ranks:{ pts:43, reb:37, ast:19, stl:17, blk:7, threePM:10, fgPct:50, ftPct:3, tov:39 } },
  { id:'kat',       name:'Karl-Anthony Towns',       teamName:'New York Knicks',          espnId:3136195, espnRank:27, color:'#006BB6',
    stats:{ pts:20.1, reb:11.9, ast:2.8, stl:0.9, blk:0.5, threePM:1.5, fgPct:49.4, ftPct:85.6, tov:2.5 },
    ranks:{ pts:30, reb:2, ast:41, stl:35, blk:29, threePM:31, fgPct:21, ftPct:16, tov:24 } },
  { id:'maxey',     name:'Tyrese Maxey',             teamName:'Philadelphia 76ers',       espnId:4431678, espnRank:28, color:'#006BB6',
    stats:{ pts:28.8, reb:4.2, ast:6.7, stl:2.0, blk:0.8, threePM:3.3, fgPct:46.1, ftPct:89.3, tov:2.4 },
    ranks:{ pts:4, reb:41, ast:12, stl:1, blk:17, threePM:4, fgPct:42, ftPct:7, tov:26 } },
  { id:'trae',      name:'Trae Young',               teamName:'Atlanta Hawks',            espnId:4277905, espnRank:29, color:'#C8102E',
    ...
    ranks:{ pts:38, reb:50, ast:7, stl:36, blk:49, threePM:23, fgPct:44, ftPct:22, tov:22 } },
  { id:'barnes',    name:'Scottie Barnes',           teamName:'Toronto Raptors',          espnId:4433134, espnRank:30, color:'#CE1141',
    stats:{ pts:18.4, reb:7.6, ast:5.8, stl:1.4, blk:1.5, threePM:0.9, fgPct:50.5, ftPct:82.1, tov:2.7 },
    ranks:{ pts:36, reb:18, ast:17, stl:12, blk:6, threePM:40, fgPct:16, ftPct:25, tov:19 } },
  { id:'jjj',       name:'Jaren Jackson Jr.',        teamName:'Memphis Grizzlies',        espnId:4277961, espnRank:31, color:'#5D76A9',
    ...
    ranks:{ pts:32, reb:28, ast:47, stl:26, blk:8, threePM:24, fgPct:36, ftPct:30, tov:32 } },
  { id:'fwagner',   name:'Franz Wagner',             teamName:'Orlando Magic',            espnId:4566434, espnRank:32, color:'#0077C0',
    ...
    ranks:{ pts:23, reb:27, ast:37, stl:27, blk:41, threePM:32, fgPct:32, ftPct:21, tov:42 } },
  ...
  { id:'fox',       name:"De'Aaron Fox",             teamName:'San Antonio Spurs',        espnId:4066259, espnRank:35, color:'#C4CED4',
    stats:{ pts:18.6, reb:3.7, ast:6.2, stl:1.2, blk:0.3, threePM:1.8, fgPct:48.7, ftPct:76.0, tov:2.3 },
    ranks:{ pts:35, reb:45, ast:15, stl:18, blk:43, threePM:25, fgPct:24, ftPct:40, tov:29 } },
  ...
  { id:'amen',      name:'Amen Thompson',            teamName:'Houston Rockets',          espnId:4684740, espnRank:37, color:'#CE1141',
    stats:{ pts:17.9, reb:7.8, ast:5.3, stl:1.5, blk:0.6, threePM:0.3, fgPct:52.4, ftPct:77.6, tov:2.4 },
    ranks:{ pts:39, reb:17, ast:22, stl:7, blk:26, threePM:47, fgPct:10, ftPct:38, tov:27 } },
  { id:'garland',   name:'Darius Garland',           teamName:'Cleveland Cavaliers',      espnId:4396907, espnRank:38, color:'#860038',
    ...
    ranks:{ pts:34, reb:49, ast:10, stl:38, blk:50, threePM:8, fgPct:38, ftPct:13, tov:14 } },
  { id:'dbane',     name:'Desmond Bane',             teamName:'Orlando Magic',            espnId:4066320, espnRank:39, color:'#0077C0',
    stats:{ pts:20.3, reb:4.2, ast:4.2, stl:1.0, blk:0.4, threePM:2.0, fgPct:48.5, ftPct:92.3, tov:2.0 },
    ranks:{ pts:28, reb:42, ast:29, stl:31, blk:35, threePM:16, fgPct:26, ftPct:2, tov:35 } },
  { id:'agordon',   name:'Aaron Gordon',             teamName:'Denver Nuggets',           espnId:3064290, espnRank:40, color:'#0E2240',
    stats:{ pts:16.6, reb:5.9, ast:2.5, stl:0.6, blk:0.3, threePM:1.7, fgPct:50.1, ftPct:76.5, tov:1.1 },
    ranks:{ pts:44, reb:26, ast:43, stl:47, blk:44, threePM:29, fgPct:19, ftPct:39, tov:49 } },
  { id:'og',        name:'OG Anunoby',               teamName:'New York Knicks',          espnId:3934719, espnRank:41, color:'#006BB6',
    stats:{ pts:16.5, reb:5.1, ast:2.2, stl:1.6, blk:0.7, threePM:2.2, fgPct:48.4, ftPct:81.8, tov:1.9 },
    ranks:{ pts:45, reb:33, ast:45, stl:4, blk:23, threePM:14, fgPct:27, ftPct:26, tov:38 } },
  { id:'randle',    name:'Julius Randle',            teamName:'Minnesota Timberwolves',   espnId:3064514, espnRank:42, color:'#0C2340',
    ...
    ranks:{ pts:24, reb:22, ast:25, stl:28, blk:47, threePM:33, fgPct:34, ftPct:29, tov:21 } },
  { id:'lauri',     name:'Lauri Markkanen',          teamName:'Utah Jazz',                espnId:4066336, espnRank:43, color:'#002B5C',
    ...
    ranks:{ pts:12, reb:21, ast:46, stl:32, blk:30, threePM:11, fgPct:35, ftPct:6, tov:45 } },
  { id:'jjohnson',  name:'Jalen Johnson',            teamName:'Atlanta Hawks',            espnId:4701230, espnRank:44, color:'#C8102E',
    stats:{ pts:22.9, reb:10.2, ast:8.1, stl:1.3, blk:0.4, threePM:1.7, fgPct:49.3, ftPct:78.7, tov:3.4 },
    ranks:{ pts:21, reb:8, ast:6, stl:13, blk:36, threePM:30, fgPct:23, ftPct:34, tov:7 } },
  ...
  { id:'jmurray',   name:'Jamal Murray',             teamName:'Denver Nuggets',           espnId:3936299, espnRank:46, color:'#0E2240',
    stats:{ pts:25.5, reb:4.4, ast:7.2, stl:0.9, blk:0.4, threePM:3.2, fgPct:48.4, ftPct:88.4, tov:2.3 },
    ranks:{ pts:16, reb:40, ast:8, stl:39, blk:37, threePM:6, fgPct:28, ftPct:8, tov:30 } },
  { id:'embiid',    name:'Joel Embiid',              teamName:'Philadelphia 76ers',       espnId:3059318, espnRank:47, color:'#006BB6',
    ...
    ranks:{ pts:11, reb:19, ast:31, stl:48, blk:11, threePM:34, fgPct:20, ftPct:17, tov:15 } },
  { id:'mbridges',  name:'Mikal Bridges',            teamName:'New York Knicks',          espnId:3147657, espnRank:48, color:'#006BB6',
    stats:{ pts:14.6, reb:3.9, ast:3.8, stl:1.3, blk:0.8, threePM:2.0, fgPct:48.7, ftPct:81.8, tov:1.0 },
    ranks:{ pts:48, reb:44, ast:33, stl:14, blk:20, threePM:17, fgPct:25, ftPct:27, tov:50 } },
  { id:'gobert',    name:'Rudy Gobert',              teamName:'Minnesota Timberwolves',   espnId:3032976, espnRank:49, color:'#0C2340',
    stats:{ pts:11.0, reb:11.5, ast:1.7, stl:0.8, blk:1.7, threePM:0.0, fgPct:69.3, ftPct:52.4, tov:1.4 },
    ranks:{ pts:50, reb:3, ast:50, stl:44, blk:4, threePM:50, fgPct:1, ftPct:50, tov:46 } },
