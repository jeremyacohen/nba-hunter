...
const PLAYERS = [
  { id:'jokic',     name:'Nikola Jokic',            teamName:'Denver Nuggets',          espnId:3112335, espnRank:1,  color:'#0E2240',
    ...
    ranks:{ pts:5, reb:1, ast:1, stl:13, blk:15, threePM:19, fgPct:5, ftPct:21, tov:2 } },
  { id:'sga',       name:'Shai Gilgeous-Alexander',  teamName:'Oklahoma City Thunder',    espnId:4278073, espnRank:2,  color:'#007AC1',
    ...
    ranks:{ pts:2, reb:37, ast:12, stl:7, blk:16, threePM:27, fgPct:7, ftPct:7, tov:32 } },
  { id:'luka',      name:'Luka Doncic',              teamName:'Los Angeles Lakers',       espnId:3945274, espnRank:3,  color:'#552583',
    stats:{ pts:32.5, reb:7.9, ast:8.5, stl:1.5, blk:0.5, threePM:3.8, fgPct:47.3, ftPct:77.4, tov:4.0 },
    ranks:{ pts:1, reb:16, ast:4, stl:5, blk:28, threePM:2, fgPct:37, ftPct:37, tov:1 } },
  { id:'giannis',   name:'Giannis Antetokounmpo',    teamName:'Milwaukee Bucks',          espnId:3032977, espnRank:4,  color:'#00471B',
    stats:{ pts:27.4, reb:9.8, ast:5.4, stl:1.0, blk:0.7, threePM:0.4, fgPct:63.4, ftPct:64.9, tov:3.3 },
    ranks:{ pts:9, reb:9, ast:19, stl:28, blk:21, threePM:45, fgPct:3, ftPct:48, tov:9 } },
  { id:'wemby',     name:'Victor Wembanyama',        teamName:'San Antonio Spurs',        espnId:5104157, espnRank:5,  color:'#C4CED4',
    ...
    ranks:{ pts:18, reb:5, ast:38, stl:29, blk:1, threePM:20, fgPct:13, ftPct:27, tov:22 } },
  { id:'edwards',   name:'Anthony Edwards',          teamName:'Minnesota Timberwolves',   espnId:4594268, espnRank:6,  color:'#0C2340',
    stats:{ pts:29.3, reb:5.1, ast:3.7, stl:1.4, blk:0.8, threePM:3.5, fgPct:49.0, ftPct:79.4, tov:2.8 },
    ranks:{ pts:3, reb:33, ast:34, stl:8, blk:17, threePM:3, fgPct:25, ftPct:31, tov:16 } },
  ...
  { id:'lebron',    name:'LeBron James',             teamName:'Los Angeles Lakers',       espnId:1966,    espnRank:8,  color:'#552583',
    ...
    ranks:{ pts:23, reb:28, ast:9, stl:20, blk:24, threePM:33, fgPct:15, ftPct:41, tov:12 } },
  { id:'durant',    name:'Kevin Durant',             teamName:'Houston Rockets',          espnId:3202,    espnRank:9,  color:'#CE1141',
    stats:{ pts:26.1, reb:5.5, ast:4.5, stl:0.9, blk:0.9, threePM:2.3, fgPct:51.3, ftPct:88.7, tov:3.2 },
    ranks:{ pts:14, reb:31, ast:28, stl:36, blk:12, threePM:13, fgPct:12, ftPct:10, tov:10 } },
  ...
  { id:'jwilliams', name:'Jalen Williams',           teamName:'Oklahoma City Thunder',    espnId:4593803, espnRank:11, color:'#007AC1',
    ...
    ranks:{ pts:40, reb:36, ast:20, stl:14, blk:38, threePM:41, fgPct:32, ftPct:20, tov:37 } },
  { id:'cade',      name:'Cade Cunningham',          teamName:'Detroit Pistons',          espnId:4432166, espnRank:12, color:'#C8102E',
    stats:{ pts:25.1, reb:5.6, ast:9.9, stl:1.4, blk:0.9, threePM:2.1, fgPct:45.9, ftPct:80.9, tov:3.8 },
    ranks:{ pts:16, reb:29, ast:2, stl:9, blk:13, threePM:15, fgPct:42, ftPct:28, tov:3 } },
  { id:'mobley',    name:'Evan Mobley',              teamName:'Cleveland Cavaliers',      espnId:4432158, espnRank:13, color:'#860038',
    ...
    ranks:{ pts:38, reb:13, ast:35, stl:41, blk:2, threePM:37, fgPct:11, ftPct:49, tov:34 } },
  { id:'adavis',    name:'Anthony Davis',            teamName:'Dallas Mavericks',         espnId:6583,    espnRank:14, color:'#003DA5',
    ...
    ranks:{ pts:26, reb:6, ast:41, stl:21, blk:4, threePM:43, fgPct:14, ftPct:42, tov:35 } },
  { id:'mitchell',  name:'Donovan Mitchell',         teamName:'Cleveland Cavaliers',      espnId:3908809, espnRank:15, color:'#860038',
    ...
    ranks:{ pts:6, reb:38, ast:17, stl:4, blk:39, threePM:4, fgPct:28, ftPct:15, tov:13 } },
  { id:'booker',    name:'Devin Booker',             teamName:'Phoenix Suns',             espnId:3136193, espnRank:16, color:'#1D1160',
    stats:{ pts:24.9, reb:4.0, ast:6.1, stl:0.9, blk:0.3, threePM:1.8, fgPct:45.0, ftPct:86.9, tov:3.2 },
    ranks:{ pts:17, reb:44, ast:15, stl:37, blk:40, threePM:22, fgPct:43, ftPct:12, tov:11 } },
  ...
  { id:'butler',    name:'Jimmy Butler',             teamName:'Golden State Warriors',    espnId:6430,    espnRank:18, color:'#1D428A',
    ...
    ranks:{ pts:29, reb:30, ast:26, stl:10, blk:43, threePM:42, fgPct:9, ftPct:13, tov:43 } },
  { id:'jbrown',    name:'Jaylen Brown',             teamName:'Boston Celtics',           espnId:3917376, espnRank:19, color:'#007A33',
    stats:{ pts:28.3, reb:7.1, ast:5.1, stl:1.0, blk:0.4, threePM:2.0, fgPct:48.0, ftPct:78.0, tov:3.6 },
    ranks:{ pts:7, reb:20, ast:24, stl:30, blk:34, threePM:16, fgPct:31, ftPct:36, tov:4 } },
  { id:'kawhi',     name:'Kawhi Leonard',            teamName:'LA Clippers',              espnId:6450,    espnRank:20, color:'#C8102E',
    ...
    ranks:{ pts:8, reb:24, ast:36, stl:1, blk:29, threePM:11, fgPct:18, ftPct:3, tov:33 } },
  { id:'adebayo',   name:'Bam Adebayo',              teamName:'Miami Heat',               espnId:4066261, espnRank:21, color:'#98002E',
    stats:{ pts:20.0, reb:9.8, ast:2.9, stl:1.1, blk:0.7, threePM:1.7, fgPct:44.8, ftPct:78.2, tov:1.7 },
    ranks:{ pts:30, reb:10, ast:39, stl:22, blk:22, threePM:28, fgPct:46, ftPct:34, tov:40 } },
  { id:'siakam',    name:'Pascal Siakam',            teamName:'Indiana Pacers',           espnId:3149673, espnRank:22, color:'#002D62',
    ...
    ranks:{ pts:20, reb:23, ast:32, stl:23, blk:35, threePM:29, fgPct:27, ftPct:47, tov:30 } },
  { id:'harden',    name:'James Harden',             teamName:'LA Clippers',              espnId:3992,    espnRank:23, color:'#C8102E',
    ...
    ranks:{ pts:19, reb:34, ast:5, stl:24, blk:36, threePM:7, fgPct:48, ftPct:9, tov:5 } },
  { id:'holmgren',  name:'Chet Holmgren',            teamName:'Oklahoma City Thunder',    espnId:4433255, espnRank:24, color:'#007AC1',
    ...
    ranks:{ pts:42, reb:12, ast:49, stl:48, blk:3, threePM:35, fgPct:6, ftPct:33, tov:44 } },
  { id:'sengun',    name:'Alperen Sengun',           teamName:'Houston Rockets',          espnId:4871144, espnRank:25, color:'#CE1141',
    stats:{ pts:20.3, reb:9.1, ast:6.1, stl:1.3, blk:1.0, threePM:0.5, fgPct:50.2, ftPct:69.4, tov:3.4 },
    ranks:{ pts:28, reb:11, ast:16, stl:15, blk:11, threePM:44, fgPct:16, ftPct:46, tov:7 } },
  ...
  { id:'kat',       name:'Karl-Anthony Towns',       teamName:'New York Knicks',          espnId:3136195, espnRank:27, color:'#006BB6',
    ...
    ranks:{ pts:31, reb:2, ast:40, stl:38, blk:26, threePM:30, fgPct:23, ftPct:16, tov:24 } },
  ...
  { id:'barnes',    name:'Scottie Barnes',           teamName:'Toronto Raptors',          espnId:4433134, espnRank:30, color:'#CE1141',
    stats:{ pts:19.0, reb:7.9, ast:5.4, stl:1.4, blk:1.5, threePM:0.9, fgPct:50.2, ftPct:83.5, tov:2.7 },
    ranks:{ pts:34, reb:17, ast:21, stl:11, blk:6, threePM:40, fgPct:17, ftPct:19, tov:20 } },
  { id:'jjj',       name:'Jaren Jackson Jr.',        teamName:'Memphis Grizzlies',        espnId:4277961, espnRank:31, color:'#5D76A9',
    ...
    ranks:{ pts:32, reb:27, ast:47, stl:25, blk:8, threePM:24, fgPct:36, ftPct:29, tov:31 } },
  { id:'fwagner',   name:'Franz Wagner',             teamName:'Orlando Magic',            espnId:4566434, espnRank:32, color:'#0077C0',
    ...
    ranks:{ pts:24, reb:26, ast:37, stl:26, blk:41, threePM:32, fgPct:33, ftPct:23, tov:42 } },
  { id:'morant',    name:'Ja Morant',                teamName:'Memphis Grizzlies',        espnId:4279888, espnRank:33, color:'#5D76A9',
    ...
    ranks:{ pts:33, reb:48, ast:6, stl:32, blk:42, threePM:39, fgPct:49, ftPct:5, tov:6 } },
  { id:'sabonis',   name:'Domantas Sabonis',         teamName:'Sacramento Kings',         espnId:3155942, espnRank:34, color:'#5A2D81',
    ...
    ranks:{ pts:46, reb:4, ast:30, stl:39, blk:44, threePM:46, fgPct:8, ftPct:43, tov:21 } },
  { id:'fox',       name:"De'Aaron Fox",             teamName:'San Antonio Spurs',        espnId:4066259, espnRank:35, color:'#C4CED4',
    stats:{ pts:19.0, reb:3.7, ast:6.3, stl:1.2, blk:0.2, threePM:1.9, fgPct:49.1, ftPct:75.6, tov:2.3 },
    ranks:{ pts:35, reb:45, ast:14, stl:18, blk:45, threePM:21, fgPct:24, ftPct:40, tov:28 } },
  ...
  { id:'dbane',     name:'Desmond Bane',             teamName:'Orlando Magic',            espnId:4066320, espnRank:39, color:'#0077C0',
    ...
    ranks:{ pts:27, reb:41, ast:29, stl:33, blk:30, threePM:17, fgPct:26, ftPct:2, tov:36 } },
  { id:'agordon',   name:'Aaron Gordon',             teamName:'Denver Nuggets',           espnId:3064290, espnRank:40, color:'#0E2240',
    ...
    ranks:{ pts:43, reb:25, ast:43, stl:46, blk:46, threePM:25, fgPct:19, ftPct:32, tov:49 } },
  ...
  { id:'randle',    name:'Julius Randle',            teamName:'Minnesota Timberwolves',   espnId:3064514, espnRank:42, color:'#0C2340',
    stats:{ pts:21.2, reb:7.0, ast:5.2, stl:1.1, blk:0.2, threePM:1.4, fgPct:48.2, ftPct:81.8, tov:2.6 },
    ranks:{ pts:25, reb:21, ast:23, stl:27, blk:47, threePM:34, fgPct:29, ftPct:26, tov:23 } },
  ...
  { id:'jjohnson',  name:'Jalen Johnson',            teamName:'Atlanta Hawks',            espnId:4701230, espnRank:44, color:'#C8102E',
    stats:{ pts:23.0, reb:10.4, ast:7.9, stl:1.3, blk:0.5, threePM:1.6, fgPct:49.5, ftPct:78.2, tov:3.4 },
    ranks:{ pts:21, reb:8, ast:7, stl:16, blk:32, threePM:31, fgPct:20, ftPct:35, tov:8 } },
  { id:'jallen',    name:'Jarrett Allen',            teamName:'Cleveland Cavaliers',      espnId:4066328, espnRank:45, color:'#860038',
    ...
    ranks:{ pts:47, reb:15, ast:48, stl:35, blk:14, threePM:49, fgPct:2, ftPct:44, tov:46 } },
  { id:'jmurray',   name:'Jamal Murray',             teamName:'Denver Nuggets',           espnId:3936299, espnRank:46, color:'#0E2240',
    ...
    ranks:{ pts:15, reb:40, ast:8, stl:40, blk:37, threePM:6, fgPct:30, ftPct:11, tov:29 } },
  { id:'embiid',    name:'Joel Embiid',              teamName:'Philadelphia 76ers',       espnId:3059318, espnRank:47, color:'#006BB6',
    ...
    ranks:{ pts:12, reb:19, ast:33, stl:47, blk:10, threePM:36, fgPct:21, ftPct:14, tov:14 } },
  { id:'mbridges',  name:'Mikal Bridges',            teamName:'New York Knicks',          espnId:3147657, espnRank:48, color:'#006BB6',
    ...
    ranks:{ pts:48, reb:43, ast:31, stl:12, blk:20, threePM:18, fgPct:22, ftPct:24, tov:48 } },
  { id:'gobert',    name:'Rudy Gobert',              teamName:'Minnesota Timberwolves',   espnId:3032976, espnRank:49, color:'#0C2340',
    stats:{ pts:10.9, reb:11.5, ast:1.7, stl:0.8, blk:1.6, threePM:0.0, fgPct:70.6, ftPct:50.0, tov:1.3 },
    ranks:{ pts:50, reb:3, ast:50, stl:43, blk:5, threePM:50, fgPct:1, ftPct:50, tov:47 } },
  { id:'porzingis', name:'Kristaps Porzingis',       teamName:'Atlanta Hawks',            espnId:3102531, espnRank:50, color:'#C8102E',
    ...
    ranks:{ pts:45, reb:35, ast:42, stl:49, blk:9, threePM:26, fgPct:44, ftPct:25, tov:50 } },
];
