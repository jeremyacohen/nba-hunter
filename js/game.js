...
const PLAYERS = [
  { id:'jokic',     name:'Nikola Jokic',            teamName:'Denver Nuggets',          espnId:3112335, espnRank:1,  color:'#0E2240',
    stats:{ pts:27.7, reb:12.9, ast:10.7, stl:1.4, blk:0.8, threePM:1.7, fgPct:56.9, ftPct:83.1, tov:3.7 },
    ranks:{ pts:8, reb:1, ast:1, stl:7, blk:13, threePM:24, fgPct:5, ftPct:21, tov:2 } },
  { id:'sga',       name:'Shai Gilgeous-Alexander',  teamName:'Oklahoma City Thunder',    espnId:4278073, espnRank:2,  color:'#007AC1',
    ...
    ranks:{ pts:2, reb:40, ast:12, stl:8, blk:14, threePM:25, fgPct:7, ftPct:10, tov:30 } },
  ...
  { id:'edwards',   name:'Anthony Edwards',          teamName:'Minnesota Timberwolves',   espnId:4594268, espnRank:6,  color:'#0C2340',
    ...
    ranks:{ pts:3, reb:34, ast:33, stl:9, blk:15, threePM:3, fgPct:22, ftPct:31, tov:14 } },
  { id:'curry',     name:'Stephen Curry',            teamName:'Golden State Warriors',    espnId:3975,    espnRank:7,  color:'#1D428A',
    stats:{ pts:26.6, reb:3.6, ast:4.7, stl:1.1, blk:0.4, threePM:4.4, fgPct:46.8, ftPct:92.3, tov:2.8 },
    ranks:{ pts:12, reb:46, ast:28, stl:20, blk:31, threePM:1, fgPct:38, ftPct:1, tov:17 } },
  { id:'lebron',    name:'LeBron James',             teamName:'Los Angeles Lakers',       espnId:1966,    espnRank:8,  color:'#552583',
    stats:{ pts:20.9, reb:6.1, ast:7.2, stl:1.2, blk:0.6, threePM:1.3, fgPct:51.5, ftPct:73.7, tov:3.0 },
    ranks:{ pts:24, reb:25, ast:8, stl:14, blk:24, threePM:35, fgPct:14, ftPct:41, tov:13 } },
  { id:'durant',    name:'Kevin Durant',             teamName:'Houston Rockets',          espnId:3202,    espnRank:9,  color:'#CE1141',
    ...
    ranks:{ pts:14, reb:29, ast:27, stl:40, blk:12, threePM:13, fgPct:11, ftPct:11, tov:9 } },
  { id:'brunson',   name:'Jalen Brunson',            teamName:'New York Knicks',          espnId:3934672, espnRank:10, color:'#006BB6',
    ...
    ranks:{ pts:15, reb:47, ast:10, stl:41, blk:49, threePM:11, fgPct:39, ftPct:19, tov:25 } },
  { id:'jwilliams', name:'Jalen Williams',           teamName:'Oklahoma City Thunder',    espnId:4593803, espnRank:11, color:'#007AC1',
    ...
    ranks:{ pts:40, reb:36, ast:19, stl:15, blk:38, threePM:42, fgPct:26, ftPct:20, tov:36 } },
  { id:'cade',      name:'Cade Cunningham',          teamName:'Detroit Pistons',          espnId:4432166, espnRank:12, color:'#C8102E',
    stats:{ pts:23.9, reb:5.5, ast:9.9, stl:1.4, blk:0.8, threePM:2.0, fgPct:46.1, ftPct:81.2, tov:3.7 },
    ranks:{ pts:19, reb:30, ast:2, stl:10, blk:16, threePM:15, fgPct:41, ftPct:28, tov:3 } },
  ...
  { id:'adavis',    name:'Anthony Davis',            teamName:'Dallas Mavericks',         espnId:6583,    espnRank:14, color:'#003DA5',
    ...
    ranks:{ pts:26, reb:6, ast:41, stl:21, blk:4, threePM:44, fgPct:17, ftPct:42, tov:33 } },
  { id:'mitchell',  name:'Donovan Mitchell',         teamName:'Cleveland Cavaliers',      espnId:3908809, espnRank:15, color:'#860038',
    ...
    ranks:{ pts:6, reb:37, ast:18, stl:5, blk:39, threePM:5, fgPct:30, ftPct:13, tov:18 } },
  ...
  { id:'banchero',  name:'Paolo Banchero',           teamName:'Orlando Magic',            espnId:4432573, espnRank:17, color:'#0077C0',
    stats:{ pts:22.2, reb:8.4, ast:5.2, stl:0.7, blk:0.6, threePM:1.2, fgPct:45.9, ftPct:77.5, tov:3.1 },
    ranks:{ pts:22, reb:15, ast:23, stl:45, blk:25, threePM:37, fgPct:43, ftPct:38, tov:12 } },
  { id:'butler',    name:'Jimmy Butler',             teamName:'Golden State Warriors',    espnId:6430,    espnRank:18, color:'#1D428A',
    ...
    ranks:{ pts:31, reb:28, ast:26, stl:11, blk:45, threePM:40, fgPct:12, ftPct:14, tov:42 } },
  { id:'jbrown',    name:'Jaylen Brown',             teamName:'Boston Celtics',           espnId:3917376, espnRank:19, color:'#007A33',
    ...
    ranks:{ pts:4, reb:20, ast:24, stl:28, blk:32, threePM:16, fgPct:34, ftPct:32, tov:4 } },
  { id:'kawhi',     name:'Kawhi Leonard',            teamName:'LA Clippers',              espnId:6450,    espnRank:20, color:'#C8102E',
    ...
    ranks:{ pts:7, reb:24, ast:36, stl:1, blk:33, threePM:12, fgPct:18, ftPct:6, tov:34 } },
  { id:'adebayo',   name:'Bam Adebayo',              teamName:'Miami Heat',               espnId:4066261, espnRank:21, color:'#98002E',
    stats:{ pts:20.1, reb:10.0, ast:3.2, stl:1.2, blk:0.7, threePM:1.7, fgPct:44.2, ftPct:77.8, tov:1.6 },
    ranks:{ pts:28, reb:9, ast:38, stl:16, blk:22, threePM:26, fgPct:47, ftPct:37, tov:43 } },
  { id:'siakam',    name:'Pascal Siakam',            teamName:'Indiana Pacers',           espnId:3149673, espnRank:22, color:'#002D62',
    ...
    ranks:{ pts:18, reb:23, ast:32, stl:22, blk:34, threePM:27, fgPct:27, ftPct:46, tov:31 } },
  { id:'harden',    name:'James Harden',             teamName:'LA Clippers',              espnId:3992,    espnRank:23, color:'#C8102E',
    ...
    ranks:{ pts:20, reb:35, ast:5, stl:23, blk:35, threePM:6, fgPct:48, ftPct:9, tov:5 } },
  ...
  { id:'sengun',    name:'Alperen Sengun',           teamName:'Houston Rockets',          espnId:4871144, espnRank:25, color:'#CE1141',
    ...
    ranks:{ pts:27, reb:13, ast:14, stl:17, blk:11, threePM:43, fgPct:13, ftPct:47, tov:10 } },
  { id:'dwhite',    name:'Derrick White',            teamName:'Boston Celtics',           espnId:3078576, espnRank:26, color:'#007A33',
    ...
    ranks:{ pts:44, reb:38, ast:21, stl:24, blk:8, threePM:8, fgPct:50, ftPct:3, tov:40 } },
  { id:'kat',       name:'Karl-Anthony Towns',       teamName:'New York Knicks',          espnId:3136195, espnRank:27, color:'#006BB6',
    ...
    ranks:{ pts:29, reb:2, ast:40, stl:35, blk:28, threePM:31, fgPct:19, ftPct:16, tov:23 } },
  { id:'maxey',     name:'Tyrese Maxey',             teamName:'Philadelphia 76ers',       espnId:4431678, espnRank:28, color:'#006BB6',
    stats:{ pts:28.3, reb:4.1, ast:6.6, stl:1.9, blk:0.8, threePM:3.1, fgPct:46.2, ftPct:89.2, tov:2.4 },
    ranks:{ pts:5, reb:41, ast:13, stl:2, blk:17, threePM:7, fgPct:40, ftPct:7, tov:26 } },
  { id:'trae',      name:'Trae Young',               teamName:'Atlanta Hawks',            espnId:4277905, espnRank:29, color:'#C8102E',
    ...
    ranks:{ pts:39, reb:50, ast:6, stl:36, blk:50, threePM:21, fgPct:44, ftPct:25, tov:21 } },
  { id:'barnes',    name:'Scottie Barnes',           teamName:'Toronto Raptors',          espnId:4433134, espnRank:30, color:'#CE1141',
    stats:{ pts:18.1, reb:7.5, ast:5.9, stl:1.4, blk:1.4, threePM:0.8, fgPct:50.7, ftPct:81.5, tov:2.6 },
    ranks:{ pts:38, reb:19, ast:17, stl:12, blk:6, threePM:41, fgPct:16, ftPct:27, tov:22 } },
  ...
  { id:'fwagner',   name:'Franz Wagner',             teamName:'Orlando Magic',            espnId:4566434, espnRank:32, color:'#0077C0',
    stats:{ pts:20.6, reb:5.2, ast:3.3, stl:0.9, blk:0.3, threePM:1.4, fgPct:48.1, ftPct:82.3, tov:1.7 },
    ranks:{ pts:25, reb:31, ast:37, stl:37, blk:41, threePM:32, fgPct:32, ftPct:26, tov:41 } },
  ...
  { id:'sabonis',   name:'Domantas Sabonis',         teamName:'Sacramento Kings',         espnId:3155942, espnRank:34, color:'#5A2D81',
    ...
    ranks:{ pts:46, reb:5, ast:29, stl:38, blk:46, threePM:46, fgPct:9, ftPct:43, tov:19 } },
  { id:'fox',       name:"De'Aaron Fox",             teamName:'San Antonio Spurs',        espnId:4066259, espnRank:35, color:'#C4CED4',
    stats:{ pts:18.6, reb:3.8, ast:6.2, stl:1.2, blk:0.3, threePM:1.8, fgPct:48.6, ftPct:76.0, tov:2.3 },
    ranks:{ pts:35, reb:44, ast:15, stl:18, blk:43, threePM:23, fgPct:25, ftPct:40, tov:28 } },
  ...
  { id:'amen',      name:'Amen Thompson',            teamName:'Houston Rockets',          espnId:4684740, espnRank:37, color:'#CE1141',
    ...
    ranks:{ pts:36, reb:16, ast:22, stl:6, blk:26, threePM:47, fgPct:10, ftPct:36, tov:27 } },
  { id:'garland',   name:'Darius Garland',           teamName:'Cleveland Cavaliers',      espnId:4396907, espnRank:38, color:'#860038',
    stats:{ pts:18.8, reb:2.4, ast:6.7, stl:1.0, blk:0.2, threePM:2.7, fgPct:46.0, ftPct:86.1, tov:2.9 },
    ranks:{ pts:34, reb:49, ast:11, stl:30, blk:47, threePM:9, fgPct:42, ftPct:15, tov:15 } },
  { id:'dbane',     name:'Desmond Bane',             teamName:'Orlando Magic',            espnId:4066320, espnRank:39, color:'#0077C0',
    stats:{ pts:20.1, reb:4.1, ast:4.1, stl:1.0, blk:0.5, threePM:2.0, fgPct:48.4, ftPct:90.8, tov:2.0 },
    ranks:{ pts:30, reb:42, ast:30, stl:31, blk:29, threePM:17, fgPct:28, ftPct:2, tov:35 } },
  ...
  { id:'og',        name:'OG Anunoby',               teamName:'New York Knicks',          espnId:3934719, espnRank:41, color:'#006BB6',
    ...
    ranks:{ pts:42, reb:32, ast:45, stl:4, blk:23, threePM:14, fgPct:29, ftPct:22, tov:39 } },
  ...
  { id:'lauri',     name:'Lauri Markkanen',          teamName:'Utah Jazz',                espnId:4066336, espnRank:43, color:'#002B5C',
    ...
    ranks:{ pts:11, reb:21, ast:46, stl:32, blk:30, threePM:10, fgPct:35, ftPct:5, tov:45 } },
  ...
  { id:'mbridges',  name:'Mikal Bridges',            teamName:'New York Knicks',          espnId:3147657, espnRank:48, color:'#006BB6',
    stats:{ pts:14.4, reb:3.8, ast:3.7, stl:1.3, blk:0.8, threePM:1.9, fgPct:49.0, ftPct:82.7, tov:1.0 },
    ranks:{ pts:48, reb:45, ast:34, stl:13, blk:20, threePM:20, fgPct:21, ftPct:24, tov:50 } },
  ...
  { id:'porzingis', name:'Kristaps Porzingis',       teamName:'Atlanta Hawks',            espnId:3102531, espnRank:50, color:'#C8102E',
    stats:{ pts:16.7, reb:5.2, ast:2.5, stl:0.6, blk:1.2, threePM:1.7, fgPct:44.6, ftPct:84.2, tov:1.3 },
    ranks:{ pts:43, reb:33, ast:43, stl:49, blk:10, threePM:30, fgPct:46, ftPct:18, tov:48 } },
];
