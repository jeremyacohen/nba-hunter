...
const PLAYERS = [
  { id:'jokic',     name:'Nikola Jokic',            teamName:'Denver Nuggets',          espnId:3112335, espnRank:1,  color:'#0E2240',
    ...
    ranks:{ pts:7, reb:1, ast:1, stl:5, blk:15, threePM:21, fgPct:5, ftPct:21, tov:2 } },
  { id:'sga',       name:'Shai Gilgeous-Alexander',  teamName:'Oklahoma City Thunder',    espnId:4278073, espnRank:2,  color:'#007AC1',
    stats:{ pts:31.6, reb:4.4, ast:6.6, stl:1.4, blk:0.8, threePM:1.7, fgPct:55.3, ftPct:88.8, tov:2.1 },
    ranks:{ pts:2, reb:39, ast:12, stl:9, blk:16, threePM:26, fgPct:7, ftPct:8, tov:32 } },
  { id:'luka',      name:'Luka Doncic',              teamName:'Los Angeles Lakers',       espnId:3945274, espnRank:3,  color:'#552583',
    stats:{ pts:33.4, reb:7.9, ast:8.4, stl:1.6, blk:0.6, threePM:4.0, fgPct:47.6, ftPct:77.0, tov:4.0 },
    ranks:{ pts:1, reb:16, ast:3, stl:4, blk:24, threePM:2, fgPct:36, ftPct:39, tov:1 } },
  { id:'giannis',   name:'Giannis Antetokounmpo',    teamName:'Milwaukee Bucks',          espnId:3032977, espnRank:4,  color:'#00471B',
    ...
    ranks:{ pts:9, reb:10, ast:19, stl:34, blk:21, threePM:45, fgPct:3, ftPct:48, tov:10 } },
  { id:'wemby',     name:'Victor Wembanyama',        teamName:'San Antonio Spurs',        espnId:5104157, espnRank:5,  color:'#C4CED4',
    stats:{ pts:24.3, reb:11.1, ast:3.0, stl:1.0, blk:3.0, threePM:2.0, fgPct:50.4, ftPct:81.8, tov:2.5 },
    ranks:{ pts:18, reb:5, ast:38, stl:28, blk:1, threePM:16, fgPct:17, ftPct:26, tov:23 } },
  { id:'edwards',   name:'Anthony Edwards',          teamName:'Minnesota Timberwolves',   espnId:4594268, espnRank:6,  color:'#0C2340',
    ...
    ranks:{ pts:3, reb:33, ast:34, stl:10, blk:17, threePM:3, fgPct:22, ftPct:33, tov:17 } },
  { id:'curry',     name:'Stephen Curry',            teamName:'Golden State Warriors',    espnId:3975,    espnRank:7,  color:'#1D428A',
    ...
    ranks:{ pts:10, reb:46, ast:27, stl:21, blk:31, threePM:1, fgPct:38, ftPct:1, tov:18 } },
  { id:'lebron',    name:'LeBron James',             teamName:'Los Angeles Lakers',       espnId:1966,    espnRank:8,  color:'#552583',
    stats:{ pts:21.1, reb:5.8, ast:6.8, stl:1.2, blk:0.6, threePM:1.3, fgPct:51.4, ftPct:74.0, tov:3.0 },
    ranks:{ pts:25, reb:26, ast:10, stl:16, blk:25, threePM:34, fgPct:13, ftPct:41, tov:12 } },
  { id:'durant',    name:'Kevin Durant',             teamName:'Houston Rockets',          espnId:3202,    espnRank:9,  color:'#CE1141',
    stats:{ pts:25.7, reb:5.4, ast:4.4, stl:0.9, blk:0.9, threePM:2.3, fgPct:51.7, ftPct:88.5, tov:3.2 },
    ranks:{ pts:14, reb:31, ast:28, stl:35, blk:12, threePM:13, fgPct:12, ftPct:9, tov:11 } },
  { id:'brunson',   name:'Jalen Brunson',            teamName:'New York Knicks',          espnId:3934672, espnRank:10, color:'#006BB6',
    ...
    ranks:{ pts:13, reb:47, ast:13, stl:42, blk:48, threePM:9, fgPct:39, ftPct:18, tov:26 } },
  ...
  { id:'cade',      name:'Cade Cunningham',          teamName:'Detroit Pistons',          espnId:4432166, espnRank:12, color:'#C8102E',
    ...
    ranks:{ pts:17, reb:29, ast:2, stl:6, blk:13, threePM:17, fgPct:41, ftPct:28, tov:3 } },
  { id:'mobley',    name:'Evan Mobley',              teamName:'Cleveland Cavaliers',      espnId:4432158, espnRank:13, color:'#860038',
    ...
    ranks:{ pts:37, reb:12, ast:36, stl:43, blk:2, threePM:38, fgPct:9, ftPct:49, tov:37 } },
  { id:'adavis',    name:'Anthony Davis',            teamName:'Dallas Mavericks',         espnId:6583,    espnRank:14, color:'#003DA5',
    ...
    ranks:{ pts:26, reb:6, ast:41, stl:22, blk:4, threePM:43, fgPct:15, ftPct:42, tov:34 } },
  { id:'mitchell',  name:'Donovan Mitchell',         teamName:'Cleveland Cavaliers',      espnId:3908809, espnRank:15, color:'#860038',
    ...
    ranks:{ pts:8, reb:37, ast:17, stl:7, blk:38, threePM:4, fgPct:34, ftPct:16, tov:15 } },
  { id:'booker',    name:'Devin Booker',             teamName:'Phoenix Suns',             espnId:3136193, espnRank:16, color:'#1D1160',
    stats:{ pts:25.5, reb:3.9, ast:5.9, stl:0.9, blk:0.3, threePM:1.8, fgPct:44.9, ftPct:86.8, tov:3.3 },
    ranks:{ pts:15, reb:44, ast:16, stl:36, blk:39, threePM:22, fgPct:45, ftPct:12, tov:8 } },
  { id:'banchero',  name:'Paolo Banchero',           teamName:'Orlando Magic',            espnId:4432573, espnRank:17, color:'#0077C0',
    stats:{ pts:22.2, reb:8.5, ast:5.0, stl:0.7, blk:0.6, threePM:1.2, fgPct:46.0, ftPct:77.9, tov:3.0 },
    ranks:{ pts:22, reb:14, ast:25, stl:45, blk:26, threePM:36, fgPct:43, ftPct:35, tov:13 } },
  ...
  { id:'jbrown',    name:'Jaylen Brown',             teamName:'Boston Celtics',           espnId:3917376, espnRank:19, color:'#007A33',
    ...
    ranks:{ pts:5, reb:20, ast:22, stl:29, blk:32, threePM:18, fgPct:32, ftPct:31, tov:4 } },
  { id:'kawhi',     name:'Kawhi Leonard',            teamName:'LA Clippers',              espnId:6450,    espnRank:20, color:'#C8102E',
    stats:{ pts:28.3, reb:6.3, ast:3.7, stl:2.0, blk:0.4, threePM:2.7, fgPct:50.5, ftPct:89.9, tov:2.1 },
    ranks:{ pts:6, reb:24, ast:35, stl:1, blk:33, threePM:10, fgPct:16, ftPct:3, tov:33 } },
  { id:'adebayo',   name:'Bam Adebayo',              teamName:'Miami Heat',               espnId:4066261, espnRank:21, color:'#98002E',
    stats:{ pts:20.4, reb:9.9, ast:2.9, stl:1.2, blk:0.7, threePM:1.7, fgPct:44.7, ftPct:77.1, tov:1.7 },
    ranks:{ pts:27, reb:9, ast:39, stl:17, blk:22, threePM:27, fgPct:46, ftPct:38, tov:41 } },
  ...
  { id:'holmgren',  name:'Chet Holmgren',            teamName:'Oklahoma City Thunder',    espnId:4433255, espnRank:24, color:'#007AC1',
    stats:{ pts:17.2, reb:9.0, ast:1.7, stl:0.6, blk:1.9, threePM:1.2, fgPct:55.4, ftPct:79.7, tov:1.6 },
    ranks:{ pts:42, reb:11, ast:49, stl:46, blk:3, threePM:37, fgPct:6, ftPct:32, tov:44 } },
  { id:'sengun',    name:'Alperen Sengun',           teamName:'Houston Rockets',          espnId:4871144, espnRank:25, color:'#CE1141',
    stats:{ pts:20.2, reb:8.9, ast:6.1, stl:1.2, blk:1.0, threePM:0.5, fgPct:51.0, ftPct:68.5, tov:3.3 },
    ranks:{ pts:29, reb:13, ast:15, stl:18, blk:11, threePM:44, fgPct:14, ftPct:46, tov:9 } },
  { id:'dwhite',    name:'Derrick White',            teamName:'Boston Celtics',           espnId:3078576, espnRank:26, color:'#007A33',
    stats:{ pts:17.3, reb:4.5, ast:5.6, stl:1.2, blk:1.4, threePM:2.9, fgPct:39.6, ftPct:89.9, tov:1.8 },
    ranks:{ pts:41, reb:38, ast:18, stl:19, blk:8, threePM:8, fgPct:50, ftPct:4, tov:39 } },
  { id:'kat',       name:'Karl-Anthony Towns',       teamName:'New York Knicks',          espnId:3136195, espnRank:27, color:'#006BB6',
    ...
    ranks:{ pts:30, reb:2, ast:40, stl:37, blk:27, threePM:30, fgPct:23, ftPct:17, tov:24 } },
  ...
  { id:'trae',      name:'Trae Young',               teamName:'Atlanta Hawks',            espnId:4277905, espnRank:29, color:'#C8102E',
    ...
    ranks:{ pts:39, reb:50, ast:6, stl:38, blk:49, threePM:23, fgPct:44, ftPct:25, tov:21 } },
  { id:'barnes',    name:'Scottie Barnes',           teamName:'Toronto Raptors',          espnId:4433134, espnRank:30, color:'#CE1141',
    ...
    ranks:{ pts:36, reb:17, ast:21, stl:12, blk:5, threePM:40, fgPct:19, ftPct:19, tov:22 } },
  ...
  { id:'fwagner',   name:'Franz Wagner',             teamName:'Orlando Magic',            espnId:4566434, espnRank:32, color:'#0077C0',
    ...
    ranks:{ pts:23, reb:27, ast:37, stl:26, blk:40, threePM:32, fgPct:33, ftPct:22, tov:42 } },
  ...
  { id:'fox',       name:"De'Aaron Fox",             teamName:'San Antonio Spurs',        espnId:4066259, espnRank:35, color:'#C4CED4',
    stats:{ pts:19.0, reb:3.8, ast:6.3, stl:1.2, blk:0.3, threePM:1.9, fgPct:48.7, ftPct:76.2, tov:2.3 },
    ranks:{ pts:34, reb:45, ast:14, stl:20, blk:42, threePM:19, fgPct:25, ftPct:40, tov:28 } },
  ...
  { id:'amen',      name:'Amen Thompson',            teamName:'Houston Rockets',          espnId:4684740, espnRank:37, color:'#CE1141',
    stats:{ pts:18.0, reb:7.9, ast:5.2, stl:1.5, blk:0.6, threePM:0.4, fgPct:52.3, ftPct:77.5, tov:2.5 },
    ranks:{ pts:38, reb:18, ast:23, stl:8, blk:28, threePM:46, fgPct:10, ftPct:37, tov:25 } },
  { id:'garland',   name:'Darius Garland',           teamName:'Cleveland Cavaliers',      espnId:4396907, espnRank:38, color:'#860038',
    stats:{ pts:18.9, reb:2.4, ast:6.9, stl:0.9, blk:0.1, threePM:2.7, fgPct:46.2, ftPct:85.7, tov:2.9 },
    ranks:{ pts:35, reb:49, ast:9, stl:40, blk:50, threePM:11, fgPct:40, ftPct:15, tov:16 } },
  { id:'dbane',     name:'Desmond Bane',             teamName:'Orlando Magic',            espnId:4066320, espnRank:39, color:'#0077C0',
    stats:{ pts:20.4, reb:4.2, ast:4.2, stl:1.0, blk:0.4, threePM:2.1, fgPct:48.7, ftPct:92.6, tov:2.0 },
    ranks:{ pts:28, reb:41, ast:29, stl:31, blk:36, threePM:15, fgPct:26, ftPct:2, tov:35 } },
  { id:'agordon',   name:'Aaron Gordon',             teamName:'Denver Nuggets',           espnId:3064290, espnRank:40, color:'#0E2240',
    ...
    ranks:{ pts:43, reb:25, ast:43, stl:47, blk:43, threePM:25, fgPct:18, ftPct:36, tov:48 } },
  { id:'og',        name:'OG Anunoby',               teamName:'New York Knicks',          espnId:3934719, espnRank:41, color:'#006BB6',
    stats:{ pts:16.8, reb:5.3, ast:2.2, stl:1.7, blk:0.7, threePM:2.2, fgPct:48.9, ftPct:81.0, tov:1.9 },
    ranks:{ pts:44, reb:32, ast:45, stl:3, blk:23, threePM:14, fgPct:24, ftPct:29, tov:38 } },
  { id:'randle',    name:'Julius Randle',            teamName:'Minnesota Timberwolves',   espnId:3064514, espnRank:42, color:'#0C2340',
    ...
    ranks:{ pts:24, reb:22, ast:24, stl:27, blk:47, threePM:33, fgPct:29, ftPct:27, tov:20 } },
  ...
  { id:'jjohnson',  name:'Jalen Johnson',            teamName:'Atlanta Hawks',            espnId:4701230, espnRank:44, color:'#C8102E',
    ...
    ranks:{ pts:21, reb:8, ast:7, stl:15, blk:30, threePM:31, fgPct:21, ftPct:34, tov:7 } },
  ...
  { id:'jmurray',   name:'Jamal Murray',             teamName:'Denver Nuggets',           espnId:3936299, espnRank:46, color:'#0E2240',
    ...
    ranks:{ pts:16, reb:40, ast:8, stl:41, blk:44, threePM:7, fgPct:30, ftPct:11, tov:29 } },
  { id:'embiid',    name:'Joel Embiid',              teamName:'Philadelphia 76ers',       espnId:3059318, espnRank:47, color:'#006BB6',
    ...
    ranks:{ pts:12, reb:19, ast:32, stl:48, blk:10, threePM:35, fgPct:20, ftPct:14, tov:14 } },
  ...
  { id:'porzingis', name:'Kristaps Porzingis',       teamName:'Atlanta Hawks',            espnId:3102531, espnRank:50, color:'#C8102E',
    ...
    ranks:{ pts:45, reb:35, ast:42, stl:49, blk:7, threePM:29, fgPct:47, ftPct:23, tov:50 } },
];
