...
const PLAYERS = [
  { id:'jokic',     name:'Nikola Jokic',            teamName:'Denver Nuggets',          espnId:3112335, espnRank:1,  color:'#0E2240',
    ...
    ranks:{ pts:6, reb:1, ast:1, stl:13, blk:15, threePM:19, fgPct:5, ftPct:24, tov:3 } },
  ...
  { id:'luka',      name:'Luka Doncic',              teamName:'Los Angeles Lakers',       espnId:3945274, espnRank:3,  color:'#552583',
    stats:{ pts:32.5, reb:7.7, ast:8.6, stl:1.4, blk:0.5, threePM:3.7, fgPct:47.3, ftPct:77.2, tov:4.0 },
    ranks:{ pts:1, reb:17, ast:4, stl:9, blk:28, threePM:2, fgPct:36, ftPct:36, tov:1 } },
  { id:'giannis',   name:'Giannis Antetokounmpo',    teamName:'Milwaukee Bucks',          espnId:3032977, espnRank:4,  color:'#00471B',
    ...
    ranks:{ pts:9, reb:9, ast:19, stl:36, blk:21, threePM:43, fgPct:3, ftPct:48, tov:8 } },
  { id:'wemby',     name:'Victor Wembanyama',        teamName:'San Antonio Spurs',        espnId:5104157, espnRank:5,  color:'#C4CED4',
    stats:{ pts:23.7, reb:11.2, ast:2.9, stl:1.0, blk:2.9, threePM:1.7, fgPct:50.1, ftPct:81.7, tov:2.6 },
    ranks:{ pts:20, reb:5, ast:38, stl:27, blk:1, threePM:27, fgPct:15, ftPct:27, tov:21 } },
  { id:'edwards',   name:'Anthony Edwards',          teamName:'Minnesota Timberwolves',   espnId:4594268, espnRank:6,  color:'#0C2340',
    stats:{ pts:29.5, reb:5.2, ast:3.7, stl:1.4, blk:0.8, threePM:3.4, fgPct:49.3, ftPct:78.5, tov:2.8 },
    ranks:{ pts:3, reb:33, ast:35, stl:10, blk:17, threePM:4, fgPct:22, ftPct:33, tov:17 } },
  ...
  { id:'lebron',    name:'LeBron James',             teamName:'Los Angeles Lakers',       espnId:1966,    espnRank:8,  color:'#552583',
    stats:{ pts:21.6, reb:5.6, ast:7.0, stl:1.1, blk:0.6, threePM:1.5, fgPct:49.9, ftPct:75.1, tov:3.0 },
    ranks:{ pts:23, reb:29, ast:9, stl:21, blk:25, threePM:31, fgPct:19, ftPct:41, tov:13 } },
  ...
  { id:'brunson',   name:'Jalen Brunson',            teamName:'New York Knicks',          espnId:3934672, espnRank:10, color:'#006BB6',
    stats:{ pts:26.7, reb:3.4, ast:6.1, stl:0.7, blk:0.1, threePM:2.9, fgPct:47.0, ftPct:84.3, tov:2.3 },
    ranks:{ pts:11, reb:47, ast:15, stl:44, blk:48, threePM:8, fgPct:38, ftPct:19, tov:29 } },
  ...
  { id:'cade',      name:'Cade Cunningham',          teamName:'Detroit Pistons',          espnId:4432166, espnRank:12, color:'#C8102E',
    stats:{ pts:25.5, reb:5.8, ast:9.8, stl:1.5, blk:0.9, threePM:2.0, fgPct:46.0, ftPct:81.0, tov:3.8 },
    ranks:{ pts:16, reb:26, ast:2, stl:5, blk:13, threePM:17, fgPct:42, ftPct:28, tov:2 } },
  { id:'mobley',    name:'Evan Mobley',              teamName:'Cleveland Cavaliers',      espnId:4432158, espnRank:13, color:'#860038',
    stats:{ pts:17.6, reb:8.7, ast:3.8, stl:0.9, blk:1.9, threePM:1.1, fgPct:51.6, ftPct:62.7, tov:2.0 },
    ranks:{ pts:39, reb:13, ast:34, stl:37, blk:3, threePM:38, fgPct:10, ftPct:49, tov:35 } },
  { id:'adavis',    name:'Anthony Davis',            teamName:'Dallas Mavericks',         espnId:6583,    espnRank:14, color:'#003DA5',
    ...
    ranks:{ pts:27, reb:6, ast:39, stl:22, blk:5, threePM:44, fgPct:14, ftPct:43, tov:36 } },
  ...
  { id:'booker',    name:'Devin Booker',             teamName:'Phoenix Suns',             espnId:3136193, espnRank:16, color:'#1D1160',
    ...
    ranks:{ pts:17, reb:44, ast:16, stl:38, blk:40, threePM:28, fgPct:43, ftPct:15, tov:9 } },
  { id:'banchero',  name:'Paolo Banchero',           teamName:'Orlando Magic',            espnId:4432573, espnRank:17, color:'#0077C0',
    stats:{ pts:21.8, reb:8.5, ast:5.0, stl:0.7, blk:0.7, threePM:1.2, fgPct:45.2, ftPct:77.2, tov:2.9 },
    ranks:{ pts:22, reb:15, ast:24, stl:45, blk:22, threePM:36, fgPct:44, ftPct:37, tov:15 } },
  { id:'butler',    name:'Jimmy Butler',             teamName:'Golden State Warriors',    espnId:6430,    espnRank:18, color:'#1D428A',
    ...
    ranks:{ pts:29, reb:30, ast:26, stl:11, blk:45, threePM:42, fgPct:9, ftPct:12, tov:43 } },
  { id:'jbrown',    name:'Jaylen Brown',             teamName:'Boston Celtics',           espnId:3917376, espnRank:19, color:'#007A33',
    ...
    ranks:{ pts:5, reb:20, ast:25, stl:28, blk:34, threePM:14, fgPct:29, ftPct:35, tov:5 } },
  ...
  { id:'adebayo',   name:'Bam Adebayo',              teamName:'Miami Heat',               espnId:4066261, espnRank:21, color:'#98002E',
    stats:{ pts:18.6, reb:9.9, ast:2.8, stl:1.0, blk:0.7, threePM:1.7, fgPct:44.9, ftPct:76.5, tov:1.8 },
    ranks:{ pts:36, reb:10, ast:40, stl:29, blk:23, threePM:29, fgPct:46, ftPct:40, tov:40 } },
  { id:'siakam',    name:'Pascal Siakam',            teamName:'Indiana Pacers',           espnId:3149673, espnRank:22, color:'#002D62',
    ...
    ranks:{ pts:19, reb:23, ast:32, stl:23, blk:35, threePM:21, fgPct:28, ftPct:47, tov:31 } },
  ...
  { id:'holmgren',  name:'Chet Holmgren',            teamName:'Oklahoma City Thunder',    espnId:4433255, espnRank:24, color:'#007AC1',
    stats:{ pts:17.2, reb:9.0, ast:1.7, stl:0.6, blk:2.0, threePM:1.2, fgPct:55.3, ftPct:78.8, tov:1.6 },
    ranks:{ pts:42, reb:12, ast:49, stl:47, blk:2, threePM:37, fgPct:6, ftPct:32, tov:44 } },
  { id:'sengun',    name:'Alperen Sengun',           teamName:'Houston Rockets',          espnId:4871144, espnRank:25, color:'#CE1141',
    ...
    ranks:{ pts:26, reb:11, ast:13, stl:15, blk:10, threePM:45, fgPct:16, ftPct:46, tov:11 } },
  { id:'dwhite',    name:'Derrick White',            teamName:'Boston Celtics',           espnId:3078576, espnRank:26, color:'#007A33',
    ...
    ranks:{ pts:43, reb:39, ast:18, stl:18, blk:7, threePM:9, fgPct:50, ftPct:4, tov:41 } },
  { id:'kat',       name:'Karl-Anthony Towns',       teamName:'New York Knicks',          espnId:3136195, espnRank:27, color:'#006BB6',
    stats:{ pts:19.8, reb:11.8, ast:2.8, stl:0.9, blk:0.6, threePM:1.6, fgPct:47.8, ftPct:85.5, tov:2.6 },
    ranks:{ pts:30, reb:2, ast:41, stl:39, blk:26, threePM:30, fgPct:33, ftPct:17, tov:22 } },
  { id:'maxey',     name:'Tyrese Maxey',             teamName:'Philadelphia 76ers',       espnId:4431678, espnRank:28, color:'#006BB6',
    stats:{ pts:29.1, reb:4.1, ast:6.8, stl:2.0, blk:0.8, threePM:3.4, fgPct:46.2, ftPct:89.1, tov:2.4 },
    ranks:{ pts:4, reb:42, ast:10, stl:2, blk:18, threePM:5, fgPct:40, ftPct:10, tov:26 } },
  ...
  { id:'barnes',    name:'Scottie Barnes',           teamName:'Toronto Raptors',          espnId:4433134, espnRank:30, color:'#CE1141',
    stats:{ pts:19.1, reb:8.2, ast:5.5, stl:1.4, blk:1.6, threePM:0.9, fgPct:50.1, ftPct:82.7, tov:2.7 },
    ranks:{ pts:34, reb:16, ast:20, stl:12, blk:6, threePM:40, fgPct:17, ftPct:25, tov:19 } },
  { id:'jjj',       name:'Jaren Jackson Jr.',        teamName:'Memphis Grizzlies',        espnId:4277961, espnRank:31, color:'#5D76A9',
    ...
    ranks:{ pts:31, reb:28, ast:47, stl:24, blk:8, threePM:23, fgPct:35, ftPct:29, tov:32 } },
  ...
  { id:'sabonis',   name:'Domantas Sabonis',         teamName:'Sacramento Kings',         espnId:3155942, espnRank:34, color:'#5A2D81',
    ...
    ranks:{ pts:46, reb:4, ast:29, stl:40, blk:46, threePM:46, fgPct:8, ftPct:44, tov:20 } },
  { id:'fox',       name:"De'Aaron Fox",             teamName:'San Antonio Spurs',        espnId:4066259, espnRank:35, color:'#C4CED4',
    stats:{ pts:18.8, reb:3.7, ast:6.2, stl:1.2, blk:0.3, threePM:1.9, fgPct:48.1, ftPct:76.6, tov:2.4 },
    ranks:{ pts:35, reb:45, ast:14, stl:19, blk:43, threePM:20, fgPct:30, ftPct:39, tov:27 } },
  { id:'zubac',     name:'Ivica Zubac',              teamName:'LA Clippers',              espnId:4017837, espnRank:36, color:'#C8102E',
    ...
    ranks:{ pts:49, reb:7, ast:45, stl:50, blk:19, threePM:48, fgPct:4, ftPct:45, tov:38 } },
  ...
  { id:'dbane',     name:'Desmond Bane',             teamName:'Orlando Magic',            espnId:4066320, espnRank:39, color:'#0077C0',
    stats:{ pts:20.3, reb:4.2, ast:4.1, stl:1.0, blk:0.5, threePM:2.1, fgPct:48.4, ftPct:91.2, tov:2.1 },
    ranks:{ pts:28, reb:41, ast:30, stl:32, blk:30, threePM:15, fgPct:24, ftPct:2, tov:34 } },
  { id:'agordon',   name:'Aaron Gordon',             teamName:'Denver Nuggets',           espnId:3064290, espnRank:40, color:'#0E2240',
    ...
    ranks:{ pts:38, reb:25, ast:43, stl:46, blk:47, threePM:24, fgPct:13, ftPct:31, tov:48 } },
  { id:'og',        name:'OG Anunoby',               teamName:'New York Knicks',          espnId:3934719, espnRank:41, color:'#006BB6',
    stats:{ pts:16.1, reb:5.3, ast:2.3, stl:1.7, blk:0.7, threePM:2.0, fgPct:47.3, ftPct:79.4, tov:1.9 },
    ranks:{ pts:45, reb:32, ast:44, stl:3, blk:24, threePM:18, fgPct:37, ftPct:30, tov:39 } },
  { id:'randle',    name:'Julius Randle',            teamName:'Minnesota Timberwolves',   espnId:3064514, espnRank:42, color:'#0C2340',
    stats:{ pts:21.5, reb:6.9, ast:5.4, stl:1.1, blk:0.3, threePM:1.5, fgPct:48.4, ftPct:81.9, tov:2.6 },
    ranks:{ pts:24, reb:21, ast:22, stl:26, blk:44, threePM:33, fgPct:25, ftPct:26, tov:25 } },
  { id:'lauri',     name:'Lauri Markkanen',          teamName:'Utah Jazz',                espnId:4066336, espnRank:43, color:'#002B5C',
    ...
    ranks:{ pts:12, reb:22, ast:46, stl:33, blk:31, threePM:10, fgPct:34, ftPct:6, tov:45 } },
  ...
  { id:'jallen',    name:'Jarrett Allen',            teamName:'Cleveland Cavaliers',      espnId:4066328, espnRank:45, color:'#860038',
    stats:{ pts:15.4, reb:8.6, ast:1.9, stl:1.0, blk:0.9, threePM:0.0, fgPct:63.7, ftPct:73.1, tov:1.4 },
    ranks:{ pts:48, reb:14, ast:48, stl:34, blk:14, threePM:49, fgPct:2, ftPct:42, tov:46 } },
  { id:'jmurray',   name:'Jamal Murray',             teamName:'Denver Nuggets',           espnId:3936299, espnRank:46, color:'#0E2240',
    ...
    ranks:{ pts:15, reb:40, ast:8, stl:35, blk:37, threePM:6, fgPct:26, ftPct:11, tov:28 } },
  { id:'embiid',    name:'Joel Embiid',              teamName:'Philadelphia 76ers',       espnId:3059318, espnRank:47, color:'#006BB6',
    ...
    ranks:{ pts:13, reb:19, ast:33, stl:48, blk:11, threePM:35, fgPct:21, ftPct:16, tov:14 } },
  { id:'mbridges',  name:'Mikal Bridges',            teamName:'New York Knicks',          espnId:3147657, espnRank:48, color:'#006BB6',
    stats:{ pts:15.7, reb:4.1, ast:4.0, stl:1.5, blk:0.8, threePM:2.1, fgPct:50.1, ftPct:82.9, tov:1.0 },
    ranks:{ pts:47, reb:43, ast:31, stl:7, blk:20, threePM:16, fgPct:18, ftPct:22, tov:49 } },
  { id:'gobert',    name:'Rudy Gobert',              teamName:'Minnesota Timberwolves',   espnId:3032976, espnRank:49, color:'#0C2340',
    stats:{ pts:10.9, reb:11.5, ast:1.7, stl:0.8, blk:1.7, threePM:0.0, fgPct:70.1, ftPct:50.2, tov:1.4 },
    ranks:{ pts:50, reb:3, ast:50, stl:43, blk:4, threePM:50, fgPct:1, ftPct:50, tov:47 } },
