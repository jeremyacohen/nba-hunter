...
const PLAYERS = [
  { id:'jokic',     name:'Nikola Jokic',            teamName:'Denver Nuggets',          espnId:3112335, espnRank:1,  color:'#0E2240',
    ...
    ranks:{ pts:6, reb:1, ast:1, stl:8, blk:15, threePM:16, fgPct:5, ftPct:21, tov:2 } },
  { id:'sga',       name:'Shai Gilgeous-Alexander',  teamName:'Oklahoma City Thunder',    espnId:4278073, espnRank:2,  color:'#007AC1',
    ...
    ranks:{ pts:2, reb:38, ast:12, stl:12, blk:16, threePM:21, fgPct:6, ftPct:8, tov:33 } },
  ...
  { id:'wemby',     name:'Victor Wembanyama',        teamName:'San Antonio Spurs',        espnId:5104157, espnRank:5,  color:'#C4CED4',
    stats:{ pts:24.2, reb:11.3, ast:2.9, stl:1.0, blk:2.8, threePM:1.8, fgPct:50.8, ftPct:81.1, tov:2.6 },
    ranks:{ pts:19, reb:4, ast:38, stl:27, blk:1, threePM:22, fgPct:13, ftPct:27, tov:21 } },
  { id:'edwards',   name:'Anthony Edwards',          teamName:'Minnesota Timberwolves',   espnId:4594268, espnRank:6,  color:'#0C2340',
    ...
    ranks:{ pts:3, reb:33, ast:36, stl:9, blk:17, threePM:4, fgPct:20, ftPct:31, tov:15 } },
  ...
  { id:'durant',    name:'Kevin Durant',             teamName:'Houston Rockets',          espnId:3202,    espnRank:9,  color:'#CE1141',
    stats:{ pts:25.9, reb:5.4, ast:4.5, stl:0.8, blk:0.9, threePM:2.4, fgPct:50.7, ftPct:88.1, tov:3.2 },
    ranks:{ pts:14, reb:31, ast:28, stl:41, blk:12, threePM:12, fgPct:14, ftPct:11, tov:10 } },
  ...
  { id:'jwilliams', name:'Jalen Williams',           teamName:'Oklahoma City Thunder',    espnId:4593803, espnRank:11, color:'#007AC1',
    ...
    ranks:{ pts:40, reb:36, ast:21, stl:13, blk:38, threePM:41, fgPct:31, ftPct:22, tov:38 } },
  { id:'cade',      name:'Cade Cunningham',          teamName:'Detroit Pistons',          espnId:4432166, espnRank:12, color:'#C8102E',
    stats:{ pts:25.3, reb:5.8, ast:9.8, stl:1.5, blk:0.9, threePM:2.0, fgPct:45.5, ftPct:81.0, tov:3.6 },
    ranks:{ pts:16, reb:26, ast:2, stl:5, blk:13, threePM:17, fgPct:42, ftPct:28, tov:3 } },
  ...
  { id:'adavis',    name:'Anthony Davis',            teamName:'Dallas Mavericks',         espnId:6583,    espnRank:14, color:'#003DA5',
    ...
    ranks:{ pts:26, reb:6, ast:41, stl:22, blk:4, threePM:45, fgPct:15, ftPct:43, tov:36 } },
  { id:'mitchell',  name:'Donovan Mitchell',         teamName:'Cleveland Cavaliers',      espnId:3908809, espnRank:15, color:'#860038',
    ...
    ranks:{ pts:7, reb:37, ast:17, stl:6, blk:39, threePM:3, fgPct:25, ftPct:18, tov:12 } },
  ...
  { id:'jbrown',    name:'Jaylen Brown',             teamName:'Boston Celtics',           espnId:3917376, espnRank:19, color:'#007A33',
    ...
    ranks:{ pts:4, reb:20, ast:26, stl:28, blk:34, threePM:14, fgPct:29, ftPct:38, tov:4 } },
  { id:'kawhi',     name:'Kawhi Leonard',            teamName:'LA Clippers',              espnId:6450,    espnRank:20, color:'#C8102E',
    ...
    ranks:{ pts:9, reb:24, ast:35, stl:1, blk:29, threePM:10, fgPct:21, ftPct:3, tov:30 } },
  ...
  { id:'siakam',    name:'Pascal Siakam',            teamName:'Indiana Pacers',           espnId:3149673, espnRank:22, color:'#002D62',
    ...
    ranks:{ pts:20, reb:23, ast:33, stl:23, blk:35, threePM:23, fgPct:26, ftPct:47, tov:31 } },
  { id:'harden',    name:'James Harden',             teamName:'LA Clippers',              espnId:3992,    espnRank:23, color:'#C8102E',
    stats:{ pts:24.6, reb:4.8, ast:8.2, stl:1.3, blk:0.4, threePM:3.0, fgPct:42.6, ftPct:89.9, tov:3.6 },
    ranks:{ pts:18, reb:35, ast:5, stl:14, blk:36, threePM:7, fgPct:47, ftPct:4, tov:5 } },
  ...
  { id:'sengun',    name:'Alperen Sengun',           teamName:'Houston Rockets',          espnId:4871144, espnRank:25, color:'#CE1141',
    stats:{ pts:20.3, reb:9.1, ast:6.3, stl:1.3, blk:1.1, threePM:0.6, fgPct:49.6, ftPct:69.3, tov:3.2 },
    ranks:{ pts:27, reb:11, ast:13, stl:15, blk:10, threePM:43, fgPct:19, ftPct:46, tov:11 } },
  ...
  { id:'kat',       name:'Karl-Anthony Towns',       teamName:'New York Knicks',          espnId:3136195, espnRank:27, color:'#006BB6',
    ...
    ranks:{ pts:28, reb:2, ast:40, stl:39, blk:26, threePM:30, fgPct:35, ftPct:17, tov:25 } },
  { id:'maxey',     name:'Tyrese Maxey',             teamName:'Philadelphia 76ers',       espnId:4431678, espnRank:28, color:'#006BB6',
    ...
    ranks:{ pts:5, reb:43, ast:11, stl:2, blk:18, threePM:5, fgPct:40, ftPct:9, tov:26 } },
  ...
  { id:'barnes',    name:'Scottie Barnes',           teamName:'Toronto Raptors',          espnId:4433134, espnRank:30, color:'#CE1141',
    ...
    ranks:{ pts:34, reb:16, ast:20, stl:16, blk:5, threePM:40, fgPct:16, ftPct:25, tov:19 } },
  ...
  { id:'fox',       name:"De'Aaron Fox",             teamName:'San Antonio Spurs',        espnId:4066259, espnRank:35, color:'#C4CED4',
    stats:{ pts:19.1, reb:3.9, ast:6.3, stl:1.2, blk:0.3, threePM:1.9, fgPct:48.0, ftPct:78.9, tov:2.4 },
    ranks:{ pts:35, reb:45, ast:14, stl:19, blk:43, threePM:20, fgPct:30, ftPct:32, tov:27 } },
  ...
  { id:'amen',      name:'Amen Thompson',            teamName:'Houston Rockets',          espnId:4684740, espnRank:37, color:'#CE1141',
    stats:{ pts:17.4, reb:7.6, ast:5.3, stl:1.5, blk:0.6, threePM:0.3, fgPct:50.9, ftPct:78.3, tov:2.6 },
    ranks:{ pts:42, reb:18, ast:22, stl:7, blk:27, threePM:47, fgPct:11, ftPct:36, tov:23 } },
  ...
  { id:'dbane',     name:'Desmond Bane',             teamName:'Orlando Magic',            espnId:4066320, espnRank:39, color:'#0077C0',
    ...
    ranks:{ pts:29, reb:41, ast:30, stl:32, blk:30, threePM:18, fgPct:27, ftPct:2, tov:35 } },
  ...
  { id:'og',        name:'OG Anunoby',               teamName:'New York Knicks',          espnId:3934719, espnRank:41, color:'#006BB6',
    ...
    ranks:{ pts:45, reb:32, ast:44, stl:3, blk:20, threePM:19, fgPct:38, ftPct:30, tov:37 } },
  { id:'randle',    name:'Julius Randle',            teamName:'Minnesota Timberwolves',   espnId:3064514, espnRank:42, color:'#0C2340',
    ...
    ranks:{ pts:22, reb:21, ast:23, stl:26, blk:44, threePM:33, fgPct:24, ftPct:26, tov:24 } },
  { id:'lauri',     name:'Lauri Markkanen',          teamName:'Utah Jazz',                espnId:4066336, espnRank:43, color:'#002B5C',
    ...
    ranks:{ pts:12, reb:22, ast:46, stl:33, blk:31, threePM:11, fgPct:33, ftPct:7, tov:45 } },
  ...
  { id:'jmurray',   name:'Jamal Murray',             teamName:'Denver Nuggets',           espnId:3936299, espnRank:46, color:'#0E2240',
    ...
    ranks:{ pts:15, reb:40, ast:8, stl:35, blk:37, threePM:6, fgPct:28, ftPct:10, tov:28 } },
  ...
  { id:'mbridges',  name:'Mikal Bridges',            teamName:'New York Knicks',          espnId:3147657, espnRank:48, color:'#006BB6',
    ...
    ranks:{ pts:47, reb:42, ast:31, stl:11, blk:21, threePM:15, fgPct:17, ftPct:23, tov:48 } },
  { id:'gobert',    name:'Rudy Gobert',              teamName:'Minnesota Timberwolves',   espnId:3032976, espnRank:49, color:'#0C2340',
    ...
    ranks:{ pts:50, reb:5, ast:50, stl:46, blk:6, threePM:50, fgPct:1, ftPct:50, tov:47 } },
  { id:'porzingis', name:'Kristaps Porzingis',       teamName:'Atlanta Hawks',            espnId:3102531, espnRank:50, color:'#C8102E',
    ...
    ranks:{ pts:44, reb:34, ast:42, stl:49, blk:9, threePM:27, fgPct:41, ftPct:20, tov:50 } },
];
