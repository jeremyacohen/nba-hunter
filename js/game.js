...
const PLAYERS = [
  { id:'jokic',     name:'Nikola Jokic',            teamName:'Denver Nuggets',          espnId:3112335, espnRank:1,  color:'#0E2240',
    ...
    ranks:{ pts:7, reb:1, ast:1, stl:9, blk:14, threePM:21, fgPct:5, ftPct:22, tov:2 } },
  { id:'sga',       name:'Shai Gilgeous-Alexander',  teamName:'Oklahoma City Thunder',    espnId:4278073, espnRank:2,  color:'#007AC1',
    ...
    ranks:{ pts:2, reb:39, ast:13, stl:10, blk:15, threePM:26, fgPct:6, ftPct:9, tov:30 } },
  ...
  { id:'wemby',     name:'Victor Wembanyama',        teamName:'San Antonio Spurs',        espnId:5104157, espnRank:5,  color:'#C4CED4',
    ...
    ranks:{ pts:17, reb:3, ast:38, stl:27, blk:1, threePM:18, fgPct:15, ftPct:25, tov:23 } },
  { id:'edwards',   name:'Anthony Edwards',          teamName:'Minnesota Timberwolves',   espnId:4594268, espnRank:6,  color:'#0C2340',
    ...
    ranks:{ pts:3, reb:33, ast:34, stl:11, blk:16, threePM:3, fgPct:24, ftPct:33, tov:15 } },
  { id:'curry',     name:'Stephen Curry',            teamName:'Golden State Warriors',    espnId:3975,    espnRank:7,  color:'#1D428A',
    ...
    ranks:{ pts:10, reb:46, ast:27, stl:20, blk:30, threePM:1, fgPct:38, ftPct:1, tov:16 } },
  ...
  { id:'brunson',   name:'Jalen Brunson',            teamName:'New York Knicks',          espnId:3934672, espnRank:10, color:'#006BB6',
    ...
    ranks:{ pts:13, reb:47, ast:12, stl:44, blk:49, threePM:11, fgPct:39, ftPct:18, tov:25 } },
  { id:'jwilliams', name:'Jalen Williams',           teamName:'Oklahoma City Thunder',    espnId:4593803, espnRank:11, color:'#007AC1',
    ...
    ranks:{ pts:41, reb:36, ast:21, stl:15, blk:38, threePM:42, fgPct:31, ftPct:23, tov:36 } },
  ...
  { id:'mobley',    name:'Evan Mobley',              teamName:'Cleveland Cavaliers',      espnId:4432158, espnRank:13, color:'#860038',
    ...
    ranks:{ pts:37, reb:11, ast:35, stl:40, blk:2, threePM:38, fgPct:8, ftPct:49, tov:38 } },
  { id:'adavis',    name:'Anthony Davis',            teamName:'Dallas Mavericks',         espnId:6583,    espnRank:14, color:'#003DA5',
    ...
    ranks:{ pts:27, reb:6, ast:41, stl:22, blk:4, threePM:44, fgPct:16, ftPct:42, tov:33 } },
  { id:'mitchell',  name:'Donovan Mitchell',         teamName:'Cleveland Cavaliers',      espnId:3908809, espnRank:15, color:'#860038',
    ...
    ranks:{ pts:8, reb:37, ast:18, stl:6, blk:39, threePM:4, fgPct:33, ftPct:13, tov:17 } },
  ...
  { id:'banchero',  name:'Paolo Banchero',           teamName:'Orlando Magic',            espnId:4432573, espnRank:17, color:'#0077C0',
    stats:{ pts:22.2, reb:8.3, ast:5.1, stl:0.6, blk:0.6, threePM:1.2, fgPct:45.7, ftPct:77.5, tov:3.0 },
    ranks:{ pts:22, reb:15, ast:24, stl:45, blk:25, threePM:36, fgPct:44, ftPct:38, tov:12 } },
  { id:'butler',    name:'Jimmy Butler',             teamName:'Golden State Warriors',    espnId:6430,    espnRank:18, color:'#1D428A',
    ...
    ranks:{ pts:31, reb:29, ast:26, stl:12, blk:45, threePM:41, fgPct:12, ftPct:14, tov:43 } },
  { id:'jbrown',    name:'Jaylen Brown',             teamName:'Boston Celtics',           espnId:3917376, espnRank:19, color:'#007A33',
    stats:{ pts:28.7, reb:7.0, ast:5.2, stl:1.0, blk:0.4, threePM:2.0, fgPct:47.5, ftPct:79.7, tov:3.6 },
    ranks:{ pts:4, reb:20, ast:23, stl:28, blk:31, threePM:17, fgPct:37, ftPct:32, tov:4 } },
  { id:'kawhi',     name:'Kawhi Leonard',            teamName:'LA Clippers',              espnId:6450,    espnRank:20, color:'#C8102E',
    ...
    ranks:{ pts:6, reb:24, ast:36, stl:1, blk:32, threePM:12, fgPct:17, ftPct:4, tov:34 } },
  ...
  { id:'siakam',    name:'Pascal Siakam',            teamName:'Indiana Pacers',           espnId:3149673, espnRank:22, color:'#002D62',
    ...
    ranks:{ pts:19, reb:23, ast:32, stl:23, blk:33, threePM:28, fgPct:28, ftPct:46, tov:31 } },
  { id:'harden',    name:'James Harden',             teamName:'LA Clippers',              espnId:3992,    espnRank:23, color:'#C8102E',
    ...
    ranks:{ pts:20, reb:35, ast:4, stl:24, blk:34, threePM:7, fgPct:48, ftPct:10, tov:5 } },
  ...
  { id:'sengun',    name:'Alperen Sengun',           teamName:'Houston Rockets',          espnId:4871144, espnRank:25, color:'#CE1141',
    stats:{ pts:20.6, reb:8.9, ast:6.2, stl:1.2, blk:1.1, threePM:0.6, fgPct:52.2, ftPct:68.6, tov:3.1 },
    ranks:{ pts:26, reb:12, ast:14, stl:17, blk:10, threePM:43, fgPct:11, ftPct:47, tov:11 } },
  { id:'dwhite',    name:'Derrick White',            teamName:'Boston Celtics',           espnId:3078576, espnRank:26, color:'#007A33',
    stats:{ pts:16.8, reb:4.5, ast:5.5, stl:1.2, blk:1.3, threePM:2.7, fgPct:39.4, ftPct:90.0, tov:1.8 },
    ranks:{ pts:44, reb:38, ast:19, stl:18, blk:8, threePM:9, fgPct:50, ftPct:3, tov:39 } },
  { id:'kat',       name:'Karl-Anthony Towns',       teamName:'New York Knicks',          espnId:3136195, espnRank:27, color:'#006BB6',
    ...
    ranks:{ pts:30, reb:2, ast:40, stl:42, blk:28, threePM:31, fgPct:19, ftPct:15, tov:24 } },
  ...
  { id:'barnes',    name:'Scottie Barnes',           teamName:'Toronto Raptors',          espnId:4433134, espnRank:30, color:'#CE1141',
    stats:{ pts:18.2, reb:7.5, ast:5.9, stl:1.5, blk:1.5, threePM:0.9, fgPct:50.4, ftPct:81.3, tov:2.7 },
    ranks:{ pts:36, reb:19, ast:17, stl:7, blk:6, threePM:40, fgPct:18, ftPct:28, tov:19 } },
  { id:'jjj',       name:'Jaren Jackson Jr.',        teamName:'Memphis Grizzlies',        espnId:4277961, espnRank:31, color:'#5D76A9',
    ...
    ranks:{ pts:32, reb:27, ast:47, stl:25, blk:7, threePM:23, fgPct:36, ftPct:29, tov:32 } },
  { id:'fwagner',   name:'Franz Wagner',             teamName:'Orlando Magic',            espnId:4566434, espnRank:32, color:'#0077C0',
    stats:{ pts:20.9, reb:5.5, ast:3.5, stl:1.0, blk:0.3, threePM:1.4, fgPct:48.1, ftPct:82.7, tov:1.7 },
    ranks:{ pts:24, reb:30, ast:37, stl:29, blk:41, threePM:32, fgPct:30, ftPct:21, tov:42 } },
  ...
  { id:'fox',       name:"De'Aaron Fox",             teamName:'San Antonio Spurs',        espnId:4066259, espnRank:35, color:'#C4CED4',
    ...
    ranks:{ pts:35, reb:45, ast:15, stl:19, blk:43, threePM:24, fgPct:23, ftPct:40, tov:28 } },
  ...
  { id:'amen',      name:'Amen Thompson',            teamName:'Houston Rockets',          espnId:4684740, espnRank:37, color:'#CE1141',
    stats:{ pts:17.9, reb:7.8, ast:5.3, stl:1.5, blk:0.6, threePM:0.3, fgPct:52.5, ftPct:78.0, tov:2.4 },
    ranks:{ pts:39, reb:16, ast:22, stl:8, blk:26, threePM:47, fgPct:10, ftPct:36, tov:27 } },
  ...
  { id:'dbane',     name:'Desmond Bane',             teamName:'Orlando Magic',            espnId:4066320, espnRank:39, color:'#0077C0',
    stats:{ pts:20.4, reb:4.2, ast:4.2, stl:1.0, blk:0.4, threePM:2.1, fgPct:48.5, ftPct:92.0, tov:2.0 },
    ranks:{ pts:28, reb:42, ast:29, stl:31, blk:35, threePM:15, fgPct:27, ftPct:2, tov:35 } },
  ...
  { id:'randle',    name:'Julius Randle',            teamName:'Minnesota Timberwolves',   espnId:3064514, espnRank:42, color:'#0C2340',
    stats:{ pts:21.1, reb:6.8, ast:5.1, stl:1.1, blk:0.2, threePM:1.4, fgPct:48.0, ftPct:80.0, tov:2.7 },
  ...
  { id:'embiid',    name:'Joel Embiid',              teamName:'Philadelphia 76ers',       espnId:3059318, espnRank:47, color:'#006BB6',
    ...
    ranks:{ pts:12, reb:18, ast:31, stl:48, blk:11, threePM:34, fgPct:22, ftPct:16, tov:18 } },
  { id:'mbridges',  name:'Mikal Bridges',            teamName:'New York Knicks',          espnId:3147657, espnRank:48, color:'#006BB6',
    ...
    ranks:{ pts:48, reb:44, ast:33, stl:14, blk:20, threePM:20, fgPct:25, ftPct:20, tov:50 } },
  { id:'gobert',    name:'Rudy Gobert',              teamName:'Minnesota Timberwolves',   espnId:3032976, espnRank:49, color:'#0C2340',
    stats:{ pts:11.0, reb:11.5, ast:1.7, stl:0.8, blk:1.6, threePM:0.0, fgPct:68.6, ftPct:52.8, tov:1.4 },
