...
const PLAYERS = [
  { id:'jokic',     name:'Nikola Jokic',            teamName:'Denver Nuggets',          espnId:3112335, espnRank:1,  color:'#0E2240',
    stats:{ pts:27.9, reb:12.9, ast:10.9, stl:1.4, blk:0.8, threePM:1.8, fgPct:57.1, ftPct:82.7, tov:3.8 },
    ranks:{ pts:7, reb:1, ast:1, stl:9, blk:14, threePM:21, fgPct:5, ftPct:23, tov:2 } },
  { id:'sga',       name:'Shai Gilgeous-Alexander',  teamName:'Oklahoma City Thunder',    espnId:4278073, espnRank:2,  color:'#007AC1',
    stats:{ pts:31.4, reb:4.4, ast:6.5, stl:1.4, blk:0.8, threePM:1.7, fgPct:55.2, ftPct:88.0, tov:2.2 },
    ranks:{ pts:2, reb:39, ast:13, stl:10, blk:15, threePM:26, fgPct:7, ftPct:10, tov:30 } },
  ...
  { id:'giannis',   name:'Giannis Antetokounmpo',    teamName:'Milwaukee Bucks',          espnId:3032977, espnRank:4,  color:'#00471B',
    ...
    ranks:{ pts:9, reb:10, ast:21, stl:34, blk:21, threePM:45, fgPct:3, ftPct:48, tov:8 } },
  { id:'wemby',     name:'Victor Wembanyama',        teamName:'San Antonio Spurs',        espnId:5104157, espnRank:5,  color:'#C4CED4',
    stats:{ pts:24.9, reb:11.6, ast:3.1, stl:1.0, blk:3.1, threePM:1.9, fgPct:50.9, ftPct:82.8, tov:2.4 },
    ranks:{ pts:17, reb:3, ast:38, stl:27, blk:1, threePM:18, fgPct:15, ftPct:22, tov:24 } },
  { id:'edwards',   name:'Anthony Edwards',          teamName:'Minnesota Timberwolves',   espnId:4594268, espnRank:6,  color:'#0C2340',
    ...
    ranks:{ pts:3, reb:34, ast:34, stl:11, blk:16, threePM:3, fgPct:23, ftPct:32, tov:15 } },
  { id:'curry',     name:'Stephen Curry',            teamName:'Golden State Warriors',    espnId:3975,    espnRank:7,  color:'#1D428A',
    ...
    ranks:{ pts:10, reb:46, ast:27, stl:19, blk:30, threePM:1, fgPct:38, ftPct:1, tov:16 } },
  { id:'lebron',    name:'LeBron James',             teamName:'Los Angeles Lakers',       espnId:1966,    espnRank:8,  color:'#552583',
    stats:{ pts:20.6, reb:6.0, ast:6.9, stl:1.1, blk:0.6, threePM:1.3, fgPct:51.1, ftPct:74.4, tov:2.9 },
    ranks:{ pts:24, reb:25, ast:9, stl:20, blk:24, threePM:35, fgPct:14, ftPct:41, tov:14 } },
  { id:'durant',    name:'Kevin Durant',             teamName:'Houston Rockets',          espnId:3202,    espnRank:9,  color:'#CE1141',
    stats:{ pts:25.9, reb:5.4, ast:4.8, stl:0.8, blk:0.9, threePM:2.4, fgPct:51.9, ftPct:87.7, tov:3.2 },
    ranks:{ pts:14, reb:31, ast:28, stl:39, blk:12, threePM:13, fgPct:12, ftPct:11, tov:9 } },
  { id:'brunson',   name:'Jalen Brunson',            teamName:'New York Knicks',          espnId:3934672, espnRank:10, color:'#006BB6',
    stats:{ pts:26.0, reb:3.4, ast:6.7, stl:0.7, blk:0.1, threePM:2.6, fgPct:46.5, ftPct:84.3, tov:2.4 },
    ranks:{ pts:13, reb:47, ast:11, stl:44, blk:49, threePM:11, fgPct:39, ftPct:18, tov:25 } },
  ...
  { id:'mobley',    name:'Evan Mobley',              teamName:'Cleveland Cavaliers',      espnId:4432158, espnRank:13, color:'#860038',
    stats:{ pts:18.1, reb:9.0, ast:3.6, stl:0.8, blk:1.8, threePM:1.0, fgPct:54.4, ftPct:60.6, tov:1.8 },
    ranks:{ pts:36, reb:11, ast:35, stl:40, blk:3, threePM:38, fgPct:8, ftPct:49, tov:38 } },
  { id:'adavis',    name:'Anthony Davis',            teamName:'Dallas Mavericks',         espnId:6583,    espnRank:14, color:'#003DA5',
    ...
    ranks:{ pts:27, reb:6, ast:41, stl:21, blk:4, threePM:44, fgPct:16, ftPct:42, tov:33 } },
  { id:'mitchell',  name:'Donovan Mitchell',         teamName:'Cleveland Cavaliers',      espnId:3908809, espnRank:15, color:'#860038',
    ...
    ranks:{ pts:8, reb:37, ast:18, stl:6, blk:39, threePM:4, fgPct:32, ftPct:14, tov:17 } },
  { id:'booker',    name:'Devin Booker',             teamName:'Phoenix Suns',             espnId:3136193, espnRank:16, color:'#1D1160',
    stats:{ pts:25.7, reb:3.9, ast:6.0, stl:0.8, blk:0.3, threePM:1.9, fgPct:45.6, ftPct:86.8, tov:3.2 },
    ranks:{ pts:15, reb:43, ast:16, stl:41, blk:40, threePM:19, fgPct:45, ftPct:12, tov:10 } },
  { id:'banchero',  name:'Paolo Banchero',           teamName:'Orlando Magic',            espnId:4432573, espnRank:17, color:'#0077C0',
    stats:{ pts:22.2, reb:8.4, ast:5.1, stl:0.7, blk:0.6, threePM:1.2, fgPct:45.7, ftPct:77.4, tov:3.1 },
    ranks:{ pts:22, reb:15, ast:24, stl:45, blk:25, threePM:37, fgPct:44, ftPct:38, tov:11 } },
  { id:'butler',    name:'Jimmy Butler',             teamName:'Golden State Warriors',    espnId:6430,    espnRank:18, color:'#1D428A',
    ...
    ranks:{ pts:31, reb:29, ast:26, stl:12, blk:44, threePM:40, fgPct:13, ftPct:13, tov:43 } },
  { id:'jbrown',    name:'Jaylen Brown',             teamName:'Boston Celtics',           espnId:3917376, espnRank:19, color:'#007A33',
    stats:{ pts:28.7, reb:7.0, ast:5.2, stl:1.0, blk:0.4, threePM:2.0, fgPct:47.6, ftPct:79.5, tov:3.6 },
    ranks:{ pts:4, reb:20, ast:23, stl:28, blk:31, threePM:17, fgPct:36, ftPct:33, tov:4 } },
  { id:'kawhi',     name:'Kawhi Leonard',            teamName:'LA Clippers',              espnId:6450,    espnRank:20, color:'#C8102E',
    stats:{ pts:28.0, reb:6.3, ast:3.6, stl:1.9, blk:0.4, threePM:2.6, fgPct:50.5, ftPct:90.0, tov:2.0 },
    ranks:{ pts:6, reb:24, ast:36, stl:1, blk:32, threePM:12, fgPct:17, ftPct:3, tov:34 } },
  { id:'adebayo',   name:'Bam Adebayo',              teamName:'Miami Heat',               espnId:4066261, espnRank:21, color:'#98002E',
    stats:{ pts:20.2, reb:10.0, ast:3.0, stl:1.2, blk:0.7, threePM:1.7, fgPct:43.9, ftPct:77.8, tov:1.7 },
    ranks:{ pts:29, reb:9, ast:39, stl:16, blk:22, threePM:27, fgPct:47, ftPct:36, tov:41 } },
  { id:'siakam',    name:'Pascal Siakam',            teamName:'Indiana Pacers',           espnId:3149673, espnRank:22, color:'#002D62',
    ...
    ranks:{ pts:19, reb:23, ast:32, stl:22, blk:33, threePM:28, fgPct:27, ftPct:46, tov:31 } },
  { id:'harden',    name:'James Harden',             teamName:'LA Clippers',              espnId:3992,    espnRank:23, color:'#C8102E',
    ...
    ranks:{ pts:20, reb:35, ast:4, stl:23, blk:34, threePM:7, fgPct:48, ftPct:9, tov:5 } },
  { id:'holmgren',  name:'Chet Holmgren',            teamName:'Oklahoma City Thunder',    espnId:4433255, espnRank:24, color:'#007AC1',
    stats:{ pts:17.0, reb:8.8, ast:1.6, stl:0.6, blk:1.9, threePM:1.3, fgPct:55.3, ftPct:79.7, tov:1.5 },
    ranks:{ pts:41, reb:12, ast:50, stl:46, blk:2, threePM:36, fgPct:6, ftPct:31, tov:44 } },
  { id:'sengun',    name:'Alperen Sengun',           teamName:'Houston Rockets',          espnId:4871144, espnRank:25, color:'#CE1141',
    stats:{ pts:20.6, reb:8.8, ast:6.2, stl:1.2, blk:1.1, threePM:0.6, fgPct:52.2, ftPct:68.8, tov:3.1 },
    ranks:{ pts:25, reb:13, ast:14, stl:17, blk:10, threePM:43, fgPct:11, ftPct:47, tov:12 } },
  { id:'dwhite',    name:'Derrick White',            teamName:'Boston Celtics',           espnId:3078576, espnRank:26, color:'#007A33',
    stats:{ pts:16.7, reb:4.5, ast:5.5, stl:1.1, blk:1.3, threePM:2.7, fgPct:39.5, ftPct:90.0, tov:1.8 },
    ranks:{ pts:44, reb:38, ast:20, stl:24, blk:8, threePM:9, fgPct:50, ftPct:4, tov:39 } },
  { id:'kat',       name:'Karl-Anthony Towns',       teamName:'New York Knicks',          espnId:3136195, espnRank:27, color:'#006BB6',
    stats:{ pts:20.1, reb:11.9, ast:2.9, stl:0.8, blk:0.5, threePM:1.5, fgPct:49.6, ftPct:85.5, tov:2.5 },
    ranks:{ pts:30, reb:2, ast:40, stl:42, blk:28, threePM:31, fgPct:20, ftPct:15, tov:23 } },
  { id:'maxey',     name:'Tyrese Maxey',             teamName:'Philadelphia 76ers',       espnId:4431678, espnRank:28, color:'#006BB6',
    stats:{ pts:28.6, reb:4.2, ast:6.7, stl:1.9, blk:0.8, threePM:3.2, fgPct:46.3, ftPct:89.0, tov:2.4 },
    ranks:{ pts:5, reb:41, ast:12, stl:2, blk:17, threePM:5, fgPct:41, ftPct:7, tov:26 } },
  { id:'trae',      name:'Trae Young',               teamName:'Atlanta Hawks',            espnId:4277905, espnRank:29, color:'#C8102E',
    ...
    ranks:{ pts:38, reb:50, ast:6, stl:35, blk:50, threePM:22, fgPct:43, ftPct:24, tov:22 } },
  { id:'barnes',    name:'Scottie Barnes',           teamName:'Toronto Raptors',          espnId:4433134, espnRank:30, color:'#CE1141',
    stats:{ pts:18.1, reb:7.5, ast:5.9, stl:1.5, blk:1.5, threePM:0.8, fgPct:50.2, ftPct:81.3, tov:2.7 },
    ranks:{ pts:37, reb:19, ast:17, stl:7, blk:6, threePM:41, fgPct:18, ftPct:28, tov:20 } },
  ...
  { id:'morant',    name:'Ja Morant',                teamName:'Memphis Grizzlies',        espnId:4279888, espnRank:33, color:'#5D76A9',
    ...
    ranks:{ pts:33, reb:48, ast:5, stl:30, blk:42, threePM:39, fgPct:49, ftPct:5, tov:6 } },
  { id:'sabonis',   name:'Domantas Sabonis',         teamName:'Sacramento Kings',         espnId:3155942, espnRank:34, color:'#5A2D81',
    ...
    ranks:{ pts:46, reb:5, ast:30, stl:36, blk:45, threePM:46, fgPct:9, ftPct:43, tov:21 } },
  { id:'fox',       name:"De'Aaron Fox",             teamName:'San Antonio Spurs',        espnId:4066259, espnRank:35, color:'#C4CED4',
    stats:{ pts:18.5, reb:3.8, ast:6.2, stl:1.2, blk:0.2, threePM:1.8, fgPct:48.8, ftPct:76.2, tov:2.3 },
    ranks:{ pts:35, reb:45, ast:15, stl:18, blk:46, threePM:24, fgPct:24, ftPct:40, tov:28 } },
  { id:'zubac',     name:'Ivica Zubac',              teamName:'LA Clippers',              espnId:4017837, espnRank:36, color:'#C8102E',
    ...
    ranks:{ pts:49, reb:7, ast:44, stl:50, blk:18, threePM:48, fgPct:4, ftPct:44, tov:40 } },
  { id:'amen',      name:'Amen Thompson',            teamName:'Houston Rockets',          espnId:4684740, espnRank:37, color:'#CE1141',
    stats:{ pts:17.9, reb:7.8, ast:5.3, stl:1.5, blk:0.6, threePM:0.3, fgPct:52.7, ftPct:77.7, tov:2.4 },
    ranks:{ pts:39, reb:16, ast:22, stl:8, blk:26, threePM:47, fgPct:10, ftPct:37, tov:27 } },
  { id:'garland',   name:'Darius Garland',           teamName:'Cleveland Cavaliers',      espnId:4396907, espnRank:38, color:'#860038',
    stats:{ pts:18.9, reb:2.3, ast:6.8, stl:0.9, blk:0.2, threePM:2.8, fgPct:46.5, ftPct:85.0, tov:3.0 },
    ranks:{ pts:34, reb:49, ast:10, stl:37, blk:47, threePM:8, fgPct:40, ftPct:17, tov:13 } },
  { id:'dbane',     name:'Desmond Bane',             teamName:'Orlando Magic',            espnId:4066320, espnRank:39, color:'#0077C0',
    stats:{ pts:20.4, reb:4.2, ast:4.2, stl:1.0, blk:0.4, threePM:2.1, fgPct:48.4, ftPct:91.4, tov:2.0 },
    ranks:{ pts:28, reb:42, ast:29, stl:31, blk:35, threePM:15, fgPct:28, ftPct:2, tov:35 } },
  { id:'agordon',   name:'Aaron Gordon',             teamName:'Denver Nuggets',           espnId:3064290, espnRank:40, color:'#0E2240',
    stats:{ pts:16.3, reb:5.8, ast:2.5, stl:0.6, blk:0.3, threePM:1.7, fgPct:49.7, ftPct:76.4, tov:1.1 },
    ranks:{ pts:45, reb:26, ast:43, stl:47, blk:43, threePM:29, fgPct:19, ftPct:39, tov:49 } },
  { id:'og',        name:'OG Anunoby',               teamName:'New York Knicks',          espnId:3934719, espnRank:41, color:'#006BB6',
    stats:{ pts:16.9, reb:5.3, ast:2.2, stl:1.6, blk:0.7, threePM:2.3, fgPct:48.6, ftPct:82.3, tov:1.9 },
    ranks:{ pts:43, reb:32, ast:45, stl:4, blk:23, threePM:14, fgPct:26, ftPct:26, tov:37 } },
  { id:'randle',    name:'Julius Randle',            teamName:'Minnesota Timberwolves',   espnId:3064514, espnRank:42, color:'#0C2340',
    stats:{ pts:21.1, reb:6.8, ast:5.1, stl:1.1, blk:0.2, threePM:1.4, fgPct:48.2, ftPct:80.0, tov:2.8 },
    ranks:{ pts:23, reb:22, ast:25, stl:26, blk:48, threePM:33, fgPct:31, ftPct:30, tov:18 } },
  { id:'lauri',     name:'Lauri Markkanen',          teamName:'Utah Jazz',                espnId:4066336, espnRank:43, color:'#002B5C',
    ...
    ranks:{ pts:11, reb:21, ast:46, stl:32, blk:29, threePM:10, fgPct:34, ftPct:6, tov:45 } },
  ...
  { id:'jallen',    name:'Jarrett Allen',            teamName:'Cleveland Cavaliers',      espnId:4066328, espnRank:45, color:'#860038',
    stats:{ pts:15.4, reb:8.5, ast:1.8, stl:1.0, blk:0.8, threePM:0.0, fgPct:64.1, ftPct:71.0, tov:1.3 },
    ranks:{ pts:47, reb:14, ast:48, stl:33, blk:19, threePM:49, fgPct:2, ftPct:45, tov:47 } },
  { id:'jmurray',   name:'Jamal Murray',             teamName:'Denver Nuggets',           espnId:3936299, espnRank:46, color:'#0E2240',
    stats:{ pts:25.6, reb:4.4, ast:7.1, stl:0.9, blk:0.4, threePM:3.2, fgPct:48.4, ftPct:88.5, tov:2.3 },
    ranks:{ pts:16, reb:40, ast:8, stl:38, blk:37, threePM:6, fgPct:29, ftPct:8, tov:29 } },
  { id:'embiid',    name:'Joel Embiid',              teamName:'Philadelphia 76ers',       espnId:3059318, espnRank:47, color:'#006BB6',
    stats:{ pts:26.7, reb:7.6, ast:4.0, stl:0.6, blk:1.1, threePM:1.4, fgPct:49.1, ftPct:85.4, tov:2.8 },
    ranks:{ pts:12, reb:18, ast:31, stl:48, blk:11, threePM:34, fgPct:22, ftPct:16, tov:19 } },
  { id:'mbridges',  name:'Mikal Bridges',            teamName:'New York Knicks',          espnId:3147657, espnRank:48, color:'#006BB6',
    stats:{ pts:14.7, reb:3.9, ast:3.8, stl:1.3, blk:0.8, threePM:1.9, fgPct:48.7, ftPct:83.2, tov:1.1 },
    ranks:{ pts:48, reb:44, ast:33, stl:14, blk:20, threePM:20, fgPct:25, ftPct:21, tov:50 } },
  { id:'gobert',    name:'Rudy Gobert',              teamName:'Minnesota Timberwolves',   espnId:3032976, espnRank:49, color:'#0C2340',
    ...
    ranks:{ pts:50, reb:4, ast:49, stl:43, blk:5, threePM:50, fgPct:1, ftPct:50, tov:46 } },
  { id:'porzingis', name:'Kristaps Porzingis',       teamName:'Atlanta Hawks',            espnId:3102531, espnRank:50, color:'#C8102E',
    ...
    ranks:{ pts:42, reb:33, ast:42, stl:49, blk:9, threePM:25, fgPct:46, ftPct:19, tov:48 } },
];
