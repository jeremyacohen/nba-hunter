...
const PLAYERS = [
  { id:'jokic',     name:'Nikola Jokic',            teamName:'Denver Nuggets',          espnId:3112335, espnRank:1,  color:'#0E2240',
    ...
    ranks:{ pts:6, reb:1, ast:1, stl:13, blk:15, threePM:18, fgPct:5, ftPct:25, tov:3 } },
  { id:'sga',       name:'Shai Gilgeous-Alexander',  teamName:'Oklahoma City Thunder',    espnId:4278073, espnRank:2,  color:'#007AC1',
    stats:{ pts:31.8, reb:4.4, ast:6.4, stl:1.4, blk:0.8, threePM:1.7, fgPct:55.0, ftPct:89.3, tov:2.1 },
    ranks:{ pts:2, reb:38, ast:12, stl:8, blk:16, threePM:26, fgPct:7, ftPct:7, tov:33 } },
  { id:'luka',      name:'Luka Doncic',              teamName:'Los Angeles Lakers',       espnId:3945274, espnRank:3,  color:'#552583',
    ...
    ranks:{ pts:1, reb:17, ast:4, stl:9, blk:28, threePM:2, fgPct:37, ftPct:37, tov:1 } },
  { id:'giannis',   name:'Giannis Antetokounmpo',    teamName:'Milwaukee Bucks',          espnId:3032977, espnRank:4,  color:'#00471B',
    stats:{ pts:27.7, reb:10.1, ast:5.5, stl:0.9, blk:0.7, threePM:0.5, fgPct:63.6, ftPct:65.9, tov:3.3 },
    ranks:{ pts:9, reb:9, ast:19, stl:36, blk:21, threePM:43, fgPct:2, ftPct:48, tov:8 } },
  { id:'wemby',     name:'Victor Wembanyama',        teamName:'San Antonio Spurs',        espnId:5104157, espnRank:5,  color:'#C4CED4',
    ...
    ranks:{ pts:20, reb:5, ast:38, stl:27, blk:1, threePM:27, fgPct:17, ftPct:27, tov:21 } },
  ...
  { id:'curry',     name:'Stephen Curry',            teamName:'Golden State Warriors',    espnId:3975,    espnRank:7,  color:'#1D428A',
    ...
    ranks:{ pts:10, reb:46, ast:27, stl:20, blk:33, threePM:1, fgPct:39, ftPct:1, tov:18 } },
  ...
  { id:'durant',    name:'Kevin Durant',             teamName:'Houston Rockets',          espnId:3202,    espnRank:9,  color:'#CE1141',
    ...
    ranks:{ pts:14, reb:31, ast:28, stl:41, blk:12, threePM:12, fgPct:12, ftPct:9, tov:10 } },
  { id:'brunson',   name:'Jalen Brunson',            teamName:'New York Knicks',          espnId:3934672, espnRank:10, color:'#006BB6',
    stats:{ pts:26.7, reb:3.4, ast:6.2, stl:0.7, blk:0.1, threePM:2.9, fgPct:47.0, ftPct:84.5, tov:2.2 },
    ranks:{ pts:11, reb:47, ast:14, stl:44, blk:48, threePM:8, fgPct:38, ftPct:19, tov:29 } },
  { id:'jwilliams', name:'Jalen Williams',           teamName:'Oklahoma City Thunder',    espnId:4593803, espnRank:11, color:'#007AC1',
    ...
    ranks:{ pts:40, reb:36, ast:21, stl:14, blk:38, threePM:41, fgPct:32, ftPct:21, tov:37 } },
  ...
  { id:'mobley',    name:'Evan Mobley',              teamName:'Cleveland Cavaliers',      espnId:4432158, espnRank:13, color:'#860038',
    ...
    ranks:{ pts:39, reb:13, ast:34, stl:37, blk:3, threePM:36, fgPct:10, ftPct:49, tov:34 } },
  ...
  { id:'mitchell',  name:'Donovan Mitchell',         teamName:'Cleveland Cavaliers',      espnId:3908809, espnRank:15, color:'#860038',
    ...
    ranks:{ pts:7, reb:37, ast:17, stl:4, blk:39, threePM:4, fgPct:26, ftPct:18, tov:13 } },
  { id:'booker',    name:'Devin Booker',             teamName:'Phoenix Suns',             espnId:3136193, espnRank:16, color:'#1D1160',
    ...
    ranks:{ pts:17, reb:44, ast:16, stl:38, blk:40, threePM:28, fgPct:44, ftPct:15, tov:9 } },
  { id:'banchero',  name:'Paolo Banchero',           teamName:'Orlando Magic',            espnId:4432573, espnRank:17, color:'#0077C0',
    ...
    ranks:{ pts:22, reb:15, ast:24, stl:45, blk:22, threePM:37, fgPct:42, ftPct:36, tov:15 } },
  ...
  { id:'jbrown',    name:'Jaylen Brown',             teamName:'Boston Celtics',           espnId:3917376, espnRank:19, color:'#007A33',
    stats:{ pts:29.0, reb:7.1, ast:5.0, stl:1.0, blk:0.4, threePM:2.1, fgPct:48.2, ftPct:77.8, tov:3.6 },
    ranks:{ pts:4, reb:20, ast:25, stl:29, blk:34, threePM:14, fgPct:29, ftPct:35, tov:5 } },
  { id:'kawhi',     name:'Kawhi Leonard',            teamName:'LA Clippers',              espnId:6450,    espnRank:20, color:'#C8102E',
    stats:{ pts:27.8, reb:6.3, ast:3.7, stl:2.0, blk:0.5, threePM:2.6, fgPct:49.6, ftPct:90.4, tov:2.2 },
    ranks:{ pts:8, reb:24, ast:36, stl:1, blk:29, threePM:11, fgPct:20, ftPct:3, tov:30 } },
  { id:'adebayo',   name:'Bam Adebayo',              teamName:'Miami Heat',               espnId:4066261, espnRank:21, color:'#98002E',
    ...
    ranks:{ pts:35, reb:10, ast:39, stl:22, blk:23, threePM:29, fgPct:46, ftPct:40, tov:41 } },
  { id:'siakam',    name:'Pascal Siakam',            teamName:'Indiana Pacers',           espnId:3149673, espnRank:22, color:'#002D62',
    ...
    ranks:{ pts:19, reb:23, ast:32, stl:23, blk:35, threePM:21, fgPct:27, ftPct:47, tov:31 } },
  ...
  { id:'holmgren',  name:'Chet Holmgren',            teamName:'Oklahoma City Thunder',    espnId:4433255, espnRank:24, color:'#007AC1',
    stats:{ pts:17.1, reb:9.0, ast:1.7, stl:0.5, blk:2.0, threePM:1.2, fgPct:55.1, ftPct:78.4, tov:1.6 },
  ...
  { id:'sengun',    name:'Alperen Sengun',           teamName:'Houston Rockets',          espnId:4871144, espnRank:25, color:'#CE1141',
    ...
    ranks:{ pts:26, reb:11, ast:13, stl:15, blk:10, threePM:45, fgPct:18, ftPct:46, tov:11 } },
  { id:'dwhite',    name:'Derrick White',            teamName:'Boston Celtics',           espnId:3078576, espnRank:26, color:'#007A33',
    stats:{ pts:17.1, reb:4.4, ast:5.8, stl:1.2, blk:1.5, threePM:2.9, fgPct:38.9, ftPct:89.8, tov:1.8 },
    ranks:{ pts:43, reb:39, ast:18, stl:18, blk:7, threePM:9, fgPct:50, ftPct:4, tov:40 } },
  { id:'kat',       name:'Karl-Anthony Towns',       teamName:'New York Knicks',          espnId:3136195, espnRank:27, color:'#006BB6',
    stats:{ pts:19.8, reb:11.8, ast:2.8, stl:0.9, blk:0.6, threePM:1.6, fgPct:48.0, ftPct:85.5, tov:2.6 },
    ranks:{ pts:30, reb:2, ast:41, stl:39, blk:26, threePM:30, fgPct:31, ftPct:17, tov:22 } },
  { id:'maxey',     name:'Tyrese Maxey',             teamName:'Philadelphia 76ers',       espnId:4431678, espnRank:28, color:'#006BB6',
    stats:{ pts:29.0, reb:4.2, ast:6.7, stl:2.0, blk:0.8, threePM:3.3, fgPct:46.1, ftPct:88.9, tov:2.4 },
    ranks:{ pts:5, reb:41, ast:10, stl:2, blk:18, threePM:5, fgPct:40, ftPct:10, tov:26 } },
  { id:'trae',      name:'Trae Young',               teamName:'Atlanta Hawks',            espnId:4277905, espnRank:29, color:'#C8102E',
    ...
    ranks:{ pts:33, reb:50, ast:3, stl:30, blk:49, threePM:22, fgPct:48, ftPct:14, tov:23 } },
  { id:'barnes',    name:'Scottie Barnes',           teamName:'Toronto Raptors',          espnId:4433134, espnRank:30, color:'#CE1141',
    ...
    ranks:{ pts:34, reb:16, ast:20, stl:12, blk:5, threePM:40, fgPct:19, ftPct:23, tov:19 } },
  { id:'jjj',       name:'Jaren Jackson Jr.',        teamName:'Memphis Grizzlies',        espnId:4277961, espnRank:31, color:'#5D76A9',
    ...
    ranks:{ pts:31, reb:29, ast:47, stl:24, blk:8, threePM:23, fgPct:36, ftPct:29, tov:32 } },
  { id:'fwagner',   name:'Franz Wagner',             teamName:'Orlando Magic',            espnId:4566434, espnRank:32, color:'#0077C0',
    ...
    ranks:{ pts:25, reb:27, ast:37, stl:25, blk:41, threePM:32, fgPct:33, ftPct:24, tov:42 } },
  ...
  { id:'fox',       name:"De'Aaron Fox",             teamName:'San Antonio Spurs',        espnId:4066259, espnRank:35, color:'#C4CED4',
    ...
    ranks:{ pts:36, reb:45, ast:15, stl:19, blk:46, threePM:20, fgPct:30, ftPct:39, tov:28 } },
  ...
  { id:'amen',      name:'Amen Thompson',            teamName:'Houston Rockets',          espnId:4684740, espnRank:37, color:'#CE1141',
    ...
    ranks:{ pts:41, reb:18, ast:23, stl:6, blk:27, threePM:47, fgPct:11, ftPct:38, tov:24 } },
  { id:'garland',   name:'Darius Garland',           teamName:'Cleveland Cavaliers',      espnId:4396907, espnRank:38, color:'#860038',
    stats:{ pts:17.7, reb:2.4, ast:6.7, stl:0.8, blk:0.1, threePM:2.3, fgPct:45.1, ftPct:86.4, tov:2.9 },
    ranks:{ pts:37, reb:49, ast:11, stl:42, blk:50, threePM:13, fgPct:45, ftPct:13, tov:16 } },
  ...
  { id:'agordon',   name:'Aaron Gordon',             teamName:'Denver Nuggets',           espnId:3064290, espnRank:40, color:'#0E2240',
    ...
    ranks:{ pts:38, reb:25, ast:43, stl:46, blk:47, threePM:24, fgPct:13, ftPct:31, tov:49 } },
  { id:'og',        name:'OG Anunoby',               teamName:'New York Knicks',          espnId:3934719, espnRank:41, color:'#006BB6',
    stats:{ pts:16.1, reb:5.2, ast:2.2, stl:1.7, blk:0.7, threePM:2.0, fgPct:47.7, ftPct:79.2, tov:1.9 },
    ranks:{ pts:45, reb:33, ast:45, stl:3, blk:24, threePM:17, fgPct:34, ftPct:30, tov:39 } },
  { id:'randle',    name:'Julius Randle',            teamName:'Minnesota Timberwolves',   espnId:3064514, espnRank:42, color:'#0C2340',
    ...
    ranks:{ pts:24, reb:21, ast:22, stl:26, blk:43, threePM:33, fgPct:28, ftPct:26, tov:25 } },
  { id:'lauri',     name:'Lauri Markkanen',          teamName:'Utah Jazz',                espnId:4066336, espnRank:43, color:'#002B5C',
    ...
    ranks:{ pts:12, reb:22, ast:46, stl:33, blk:31, threePM:10, fgPct:35, ftPct:6, tov:45 } },
  { id:'jjohnson',  name:'Jalen Johnson',            teamName:'Atlanta Hawks',            espnId:4701230, espnRank:44, color:'#C8102E',
    stats:{ pts:22.7, reb:10.6, ast:7.9, stl:1.3, blk:0.5, threePM:1.5, fgPct:49.3, ftPct:77.9, tov:3.4 },
    ranks:{ pts:21, reb:8, ast:7, stl:16, blk:32, threePM:34, fgPct:23, ftPct:34, tov:7 } },
  ...
  { id:'jmurray',   name:'Jamal Murray',             teamName:'Denver Nuggets',           espnId:3936299, espnRank:46, color:'#0E2240',
    ...
    ranks:{ pts:15, reb:40, ast:8, stl:35, blk:37, threePM:6, fgPct:25, ftPct:11, tov:27 } },
  { id:'embiid',    name:'Joel Embiid',              teamName:'Philadelphia 76ers',       espnId:3059318, espnRank:47, color:'#006BB6',
    ...
    ranks:{ pts:13, reb:19, ast:33, stl:47, blk:11, threePM:35, fgPct:21, ftPct:16, tov:14 } },
  { id:'mbridges',  name:'Mikal Bridges',            teamName:'New York Knicks',          espnId:3147657, espnRank:48, color:'#006BB6',
    stats:{ pts:15.6, reb:4.1, ast:4.0, stl:1.5, blk:0.8, threePM:2.1, fgPct:50.2, ftPct:83.3, tov:1.1 },
    ranks:{ pts:47, reb:43, ast:31, stl:7, blk:20, threePM:16, fgPct:16, ftPct:22, tov:48 } },
  ...
  { id:'porzingis', name:'Kristaps Porzingis',       teamName:'Atlanta Hawks',            espnId:3102531, espnRank:50, color:'#C8102E',
    ...
    ranks:{ pts:44, reb:35, ast:42, stl:49, blk:9, threePM:25, fgPct:41, ftPct:20, tov:50 } },
];
