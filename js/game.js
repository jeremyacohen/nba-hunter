...
const PLAYERS = [
  { id:'jokic',     name:'Nikola Jokic',            teamName:'Denver Nuggets',          espnId:3112335, espnRank:1,  color:'#0E2240',
    stats:{ pts:28.0, reb:12.6, ast:10.6, stl:1.5, blk:0.8, threePM:1.8, fgPct:57.3, ftPct:83.1, tov:3.9 },
    ranks:{ pts:7, reb:1, ast:1, stl:5, blk:15, threePM:22, fgPct:5, ftPct:20, tov:2 } },
  ...
  { id:'luka',      name:'Luka Doncic',              teamName:'Los Angeles Lakers',       espnId:3945274, espnRank:3,  color:'#552583',
    ...
    ranks:{ pts:1, reb:16, ast:3, stl:3, blk:24, threePM:2, fgPct:37, ftPct:39, tov:1 } },
  { id:'giannis',   name:'Giannis Antetokounmpo',    teamName:'Milwaukee Bucks',          espnId:3032977, espnRank:4,  color:'#00471B',
    ...
    ranks:{ pts:9, reb:9, ast:19, stl:34, blk:21, threePM:45, fgPct:3, ftPct:48, tov:10 } },
  { id:'wemby',     name:'Victor Wembanyama',        teamName:'San Antonio Spurs',        espnId:5104157, espnRank:5,  color:'#C4CED4',
    ...
    ranks:{ pts:18, reb:5, ast:38, stl:28, blk:1, threePM:17, fgPct:16, ftPct:26, tov:23 } },
  { id:'edwards',   name:'Anthony Edwards',          teamName:'Minnesota Timberwolves',   espnId:4594268, espnRank:6,  color:'#0C2340',
    ...
    ranks:{ pts:3, reb:33, ast:34, stl:10, blk:17, threePM:3, fgPct:23, ftPct:33, tov:17 } },
  { id:'curry',     name:'Stephen Curry',            teamName:'Golden State Warriors',    espnId:3975,    espnRank:7,  color:'#1D428A',
    ...
    ranks:{ pts:10, reb:46, ast:27, stl:20, blk:31, threePM:1, fgPct:38, ftPct:1, tov:18 } },
  ...
  { id:'durant',    name:'Kevin Durant',             teamName:'Houston Rockets',          espnId:3202,    espnRank:9,  color:'#CE1141',
    ...
    ranks:{ pts:14, reb:31, ast:28, stl:40, blk:12, threePM:13, fgPct:11, ftPct:10, tov:11 } },
  ...
  { id:'jwilliams', name:'Jalen Williams',           teamName:'Oklahoma City Thunder',    espnId:4593803, espnRank:11, color:'#007AC1',
    ...
    ranks:{ pts:40, reb:36, ast:20, stl:15, blk:37, threePM:41, fgPct:29, ftPct:23, tov:34 } },
  { id:'cade',      name:'Cade Cunningham',          teamName:'Detroit Pistons',          espnId:4432166, espnRank:12, color:'#C8102E',
    ...
    ranks:{ pts:17, reb:29, ast:2, stl:6, blk:13, threePM:15, fgPct:41, ftPct:27, tov:3 } },
  { id:'mobley',    name:'Evan Mobley',              teamName:'Cleveland Cavaliers',      espnId:4432158, espnRank:13, color:'#860038',
    stats:{ pts:18.2, reb:8.9, ast:3.6, stl:0.8, blk:1.9, threePM:1.1, fgPct:53.4, ftPct:60.2, tov:1.9 },
    ranks:{ pts:37, reb:13, ast:35, stl:42, blk:2, threePM:38, fgPct:9, ftPct:49, tov:38 } },
  { id:'adavis',    name:'Anthony Davis',            teamName:'Dallas Mavericks',         espnId:6583,    espnRank:14, color:'#003DA5',
    ...
    ranks:{ pts:26, reb:6, ast:41, stl:22, blk:4, threePM:43, fgPct:15, ftPct:42, tov:35 } },
  { id:'mitchell',  name:'Donovan Mitchell',         teamName:'Cleveland Cavaliers',      espnId:3908809, espnRank:15, color:'#860038',
    stats:{ pts:28.0, reb:4.5, ast:5.8, stl:1.5, blk:0.3, threePM:3.3, fgPct:47.7, ftPct:85.4, tov:2.9 },
    ranks:{ pts:8, reb:38, ast:17, stl:7, blk:38, threePM:4, fgPct:33, ftPct:16, tov:15 } },
  { id:'booker',    name:'Devin Booker',             teamName:'Phoenix Suns',             espnId:3136193, espnRank:16, color:'#1D1160',
    stats:{ pts:25.5, reb:3.9, ast:5.9, stl:0.8, blk:0.3, threePM:1.9, fgPct:45.2, ftPct:86.9, tov:3.3 },
    ranks:{ pts:15, reb:44, ast:16, stl:43, blk:39, threePM:18, fgPct:45, ftPct:12, tov:8 } },
  { id:'banchero',  name:'Paolo Banchero',           teamName:'Orlando Magic',            espnId:4432573, espnRank:17, color:'#0077C0',
    stats:{ pts:22.5, reb:8.4, ast:5.1, stl:0.7, blk:0.6, threePM:1.2, fgPct:46.0, ftPct:77.8, tov:3.0 },
    ranks:{ pts:22, reb:15, ast:23, stl:45, blk:26, threePM:36, fgPct:43, ftPct:36, tov:13 } },
  ...
  { id:'kawhi',     name:'Kawhi Leonard',            teamName:'LA Clippers',              espnId:6450,    espnRank:20, color:'#C8102E',
    ...
    ranks:{ pts:6, reb:24, ast:36, stl:1, blk:33, threePM:10, fgPct:17, ftPct:3, tov:33 } },
  { id:'adebayo',   name:'Bam Adebayo',              teamName:'Miami Heat',               espnId:4066261, espnRank:21, color:'#98002E',
    ...
    ranks:{ pts:29, reb:10, ast:39, stl:16, blk:22, threePM:27, fgPct:46, ftPct:37, tov:41 } },
  ...
  { id:'sengun',    name:'Alperen Sengun',           teamName:'Houston Rockets',          espnId:4871144, espnRank:25, color:'#CE1141',
    ...
    ranks:{ pts:27, reb:12, ast:15, stl:17, blk:11, threePM:44, fgPct:13, ftPct:47, tov:9 } },
  ...
  { id:'kat',       name:'Karl-Anthony Towns',       teamName:'New York Knicks',          espnId:3136195, espnRank:27, color:'#006BB6',
    stats:{ pts:20.2, reb:12.0, ast:2.9, stl:0.9, blk:0.6, threePM:1.6, fgPct:49.4, ftPct:85.4, tov:2.5 },
    ranks:{ pts:30, reb:2, ast:40, stl:35, blk:27, threePM:30, fgPct:21, ftPct:17, tov:24 } },
  { id:'maxey',     name:'Tyrese Maxey',             teamName:'Philadelphia 76ers',       espnId:4431678, espnRank:28, color:'#006BB6',
    ...
    ranks:{ pts:4, reb:42, ast:11, stl:2, blk:18, threePM:5, fgPct:42, ftPct:7, tov:26 } },
  ...
  { id:'fwagner',   name:'Franz Wagner',             teamName:'Orlando Magic',            espnId:4566434, espnRank:32, color:'#0077C0',
    ...
    ranks:{ pts:23, reb:27, ast:37, stl:26, blk:40, threePM:32, fgPct:32, ftPct:22, tov:42 } },
  ...
  { id:'fox',       name:"De'Aaron Fox",             teamName:'San Antonio Spurs',        espnId:4066259, espnRank:35, color:'#C4CED4',
    ...
    ranks:{ pts:34, reb:45, ast:14, stl:19, blk:42, threePM:20, fgPct:26, ftPct:40, tov:28 } },
  ...
  { id:'amen',      name:'Amen Thompson',            teamName:'Houston Rockets',          espnId:4684740, espnRank:37, color:'#CE1141',
    ...
    ranks:{ pts:38, reb:18, ast:22, stl:8, blk:28, threePM:47, fgPct:10, ftPct:38, tov:25 } },
  { id:'garland',   name:'Darius Garland',           teamName:'Cleveland Cavaliers',      espnId:4396907, espnRank:38, color:'#860038',
    ...
    ranks:{ pts:35, reb:49, ast:10, stl:38, blk:50, threePM:11, fgPct:39, ftPct:14, tov:16 } },
  { id:'dbane',     name:'Desmond Bane',             teamName:'Orlando Magic',            espnId:4066320, espnRank:39, color:'#0077C0',
    stats:{ pts:20.4, reb:4.2, ast:4.2, stl:1.0, blk:0.4, threePM:2.0, fgPct:48.7, ftPct:92.3, tov:2.0 },
    ranks:{ pts:28, reb:41, ast:29, stl:31, blk:36, threePM:16, fgPct:25, ftPct:2, tov:36 } },
  { id:'agordon',   name:'Aaron Gordon',             teamName:'Denver Nuggets',           espnId:3064290, espnRank:40, color:'#0E2240',
    stats:{ pts:16.6, reb:5.9, ast:2.5, stl:0.6, blk:0.3, threePM:1.8, fgPct:50.0, ftPct:78.1, tov:1.0 },
    ranks:{ pts:45, reb:26, ast:43, stl:46, blk:43, threePM:25, fgPct:19, ftPct:34, tov:49 } },
  { id:'og',        name:'OG Anunoby',               teamName:'New York Knicks',          espnId:3934719, espnRank:41, color:'#006BB6',
    stats:{ pts:16.7, reb:5.2, ast:2.2, stl:1.6, blk:0.7, threePM:2.2, fgPct:48.9, ftPct:81.2, tov:2.0 },
    ranks:{ pts:43, reb:32, ast:45, stl:4, blk:23, threePM:14, fgPct:24, ftPct:29, tov:37 } },
  { id:'randle',    name:'Julius Randle',            teamName:'Minnesota Timberwolves',   espnId:3064514, espnRank:42, color:'#0C2340',
    ...
    ranks:{ pts:25, reb:22, ast:25, stl:27, blk:47, threePM:33, fgPct:30, ftPct:28, tov:21 } },
  ...
  { id:'jjohnson',  name:'Jalen Johnson',            teamName:'Atlanta Hawks',            espnId:4701230, espnRank:44, color:'#C8102E',
    ...
    ranks:{ pts:21, reb:8, ast:7, stl:13, blk:30, threePM:31, fgPct:22, ftPct:35, tov:7 } },
  ...
  { id:'jmurray',   name:'Jamal Murray',             teamName:'Denver Nuggets',           espnId:3936299, espnRank:46, color:'#0E2240',
    stats:{ pts:25.1, reb:4.4, ast:7.1, stl:0.9, blk:0.3, threePM:3.1, fgPct:48.0, ftPct:87.9, tov:2.3 },
    ranks:{ pts:16, reb:40, ast:8, stl:39, blk:44, threePM:7, fgPct:31, ftPct:11, tov:29 } },
  { id:'embiid',    name:'Joel Embiid',              teamName:'Philadelphia 76ers',       espnId:3059318, espnRank:47, color:'#006BB6',
    ...
    ranks:{ pts:12, reb:19, ast:31, stl:47, blk:10, threePM:35, fgPct:20, ftPct:15, tov:14 } },
  { id:'mbridges',  name:'Mikal Bridges',            teamName:'New York Knicks',          espnId:3147657, espnRank:48, color:'#006BB6',
    stats:{ pts:14.7, reb:4.1, ast:3.9, stl:1.3, blk:0.8, threePM:1.9, fgPct:48.6, ftPct:82.6, tov:1.0 },
    ranks:{ pts:48, reb:43, ast:32, stl:14, blk:20, threePM:21, fgPct:27, ftPct:24, tov:50 } },
  ...
  { id:'porzingis', name:'Kristaps Porzingis',       teamName:'Atlanta Hawks',            espnId:3102531, espnRank:50, color:'#C8102E',
    ...
    ranks:{ pts:44, reb:35, ast:42, stl:48, blk:9, threePM:29, fgPct:47, ftPct:21, tov:48 } },
];
