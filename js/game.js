...
const PLAYERS = [
  ...
  { id:'sga',       name:'Shai Gilgeous-Alexander',  teamName:'Oklahoma City Thunder',    espnId:4278073, espnRank:2,  color:'#007AC1',
    ...
    ranks:{ pts:2, reb:37, ast:12, stl:9, blk:16, threePM:26, fgPct:6, ftPct:7, tov:32 } },
  ...
  { id:'giannis',   name:'Giannis Antetokounmpo',    teamName:'Milwaukee Bucks',          espnId:3032977, espnRank:4,  color:'#00471B',
    ...
    ranks:{ pts:9, reb:9, ast:19, stl:28, blk:21, threePM:45, fgPct:3, ftPct:48, tov:7 } },
  { id:'wemby',     name:'Victor Wembanyama',        teamName:'San Antonio Spurs',        espnId:5104157, espnRank:5,  color:'#C4CED4',
    ...
    ranks:{ pts:18, reb:5, ast:38, stl:29, blk:1, threePM:16, fgPct:13, ftPct:27, tov:22 } },
  { id:'edwards',   name:'Anthony Edwards',          teamName:'Minnesota Timberwolves',   espnId:4594268, espnRank:6,  color:'#0C2340',
    stats:{ pts:29.7, reb:5.1, ast:3.7, stl:1.4, blk:0.8, threePM:3.5, fgPct:49.4, ftPct:80.3, tov:2.8 },
    ranks:{ pts:3, reb:33, ast:34, stl:10, blk:17, threePM:3, fgPct:22, ftPct:30, tov:16 } },
  ...
  { id:'durant',    name:'Kevin Durant',             teamName:'Houston Rockets',          espnId:3202,    espnRank:9,  color:'#CE1141',
    ...
    ranks:{ pts:14, reb:31, ast:28, stl:40, blk:12, threePM:13, fgPct:12, ftPct:10, tov:10 } },
  ...
  { id:'cade',      name:'Cade Cunningham',          teamName:'Detroit Pistons',          espnId:4432166, espnRank:12, color:'#C8102E',
    stats:{ pts:24.7, reb:5.7, ast:10.1, stl:1.5, blk:0.9, threePM:2.1, fgPct:46.0, ftPct:81.1, tov:3.7 },
    ranks:{ pts:17, reb:28, ast:2, stl:7, blk:13, threePM:15, fgPct:42, ftPct:28, tov:3 } },
  { id:'mobley',    name:'Evan Mobley',              teamName:'Cleveland Cavaliers',      espnId:4432158, espnRank:13, color:'#860038',
    stats:{ pts:17.9, reb:8.7, ast:3.6, stl:0.8, blk:1.8, threePM:1.2, fgPct:52.6, ftPct:61.8, tov:1.9 },
    ranks:{ pts:37, reb:13, ast:36, stl:41, blk:3, threePM:37, fgPct:9, ftPct:49, tov:37 } },
  ...
  { id:'mitchell',  name:'Donovan Mitchell',         teamName:'Cleveland Cavaliers',      espnId:3908809, espnRank:15, color:'#860038',
    stats:{ pts:28.2, reb:4.5, ast:5.8, stl:1.6, blk:0.3, threePM:3.4, fgPct:48.2, ftPct:85.6, tov:3.0 },
    ranks:{ pts:7, reb:38, ast:17, stl:4, blk:39, threePM:4, fgPct:29, ftPct:15, tov:13 } },
  ...
  { id:'banchero',  name:'Paolo Banchero',           teamName:'Orlando Magic',            espnId:4432573, espnRank:17, color:'#0077C0',
    ...
    ranks:{ pts:22, reb:14, ast:25, stl:45, blk:26, threePM:38, fgPct:40, ftPct:36, tov:15 } },
  ...
  { id:'jbrown',    name:'Jaylen Brown',             teamName:'Boston Celtics',           espnId:3917376, espnRank:19, color:'#007A33',
    ...
    ranks:{ pts:8, reb:20, ast:23, stl:30, blk:33, threePM:21, fgPct:34, ftPct:32, tov:4 } },
  ...
  { id:'adebayo',   name:'Bam Adebayo',              teamName:'Miami Heat',               espnId:4066261, espnRank:21, color:'#98002E',
    ...
    ranks:{ pts:30, reb:10, ast:39, stl:22, blk:22, threePM:27, fgPct:46, ftPct:38, tov:40 } },
  { id:'siakam',    name:'Pascal Siakam',            teamName:'Indiana Pacers',           espnId:3149673, espnRank:22, color:'#002D62',
    ...
    ranks:{ pts:20, reb:23, ast:31, stl:23, blk:35, threePM:28, fgPct:27, ftPct:47, tov:30 } },
  { id:'harden',    name:'James Harden',             teamName:'LA Clippers',              espnId:3992,    espnRank:23, color:'#C8102E',
    stats:{ pts:24.2, reb:4.9, ast:8.1, stl:1.1, blk:0.4, threePM:3.1, fgPct:43.2, ftPct:88.7, tov:3.6 },
    ranks:{ pts:19, reb:34, ast:5, stl:24, blk:36, threePM:6, fgPct:48, ftPct:9, tov:5 } },
  { id:'holmgren',  name:'Chet Holmgren',            teamName:'Oklahoma City Thunder',    espnId:4433255, espnRank:24, color:'#007AC1',
    ...
    ranks:{ pts:42, reb:11, ast:50, stl:48, blk:2, threePM:35, fgPct:7, ftPct:33, tov:44 } },
  ...
  { id:'dwhite',    name:'Derrick White',            teamName:'Boston Celtics',           espnId:3078576, espnRank:26, color:'#007A33',
    ...
    ranks:{ pts:41, reb:39, ast:18, stl:17, blk:7, threePM:8, fgPct:50, ftPct:3, tov:41 } },
  { id:'kat',       name:'Karl-Anthony Towns',       teamName:'New York Knicks',          espnId:3136195, espnRank:27, color:'#006BB6',
    ...
    ranks:{ pts:31, reb:2, ast:40, stl:37, blk:27, threePM:30, fgPct:23, ftPct:16, tov:24 } },
  { id:'maxey',     name:'Tyrese Maxey',             teamName:'Philadelphia 76ers',       espnId:4431678, espnRank:28, color:'#006BB6',
    ...
    ranks:{ pts:4, reb:42, ast:11, stl:2, blk:18, threePM:5, fgPct:41, ftPct:8, tov:26 } },
  { id:'trae',      name:'Trae Young',               teamName:'Atlanta Hawks',            espnId:4277905, espnRank:29, color:'#C8102E',
    ...
    ranks:{ pts:39, reb:50, ast:4, stl:38, blk:49, threePM:29, fgPct:47, ftPct:24, tov:23 } },
  { id:'barnes',    name:'Scottie Barnes',           teamName:'Toronto Raptors',          espnId:4433134, espnRank:30, color:'#CE1141',
    stats:{ pts:18.7, reb:7.8, ast:5.3, stl:1.4, blk:1.5, threePM:0.9, fgPct:49.9, ftPct:83.7, tov:2.7 },
    ranks:{ pts:35, reb:17, ast:21, stl:12, blk:6, threePM:40, fgPct:18, ftPct:20, tov:19 } },
  { id:'jjj',       name:'Jaren Jackson Jr.',        teamName:'Memphis Grizzlies',        espnId:4277961, espnRank:31, color:'#5D76A9',
    ...
    ranks:{ pts:32, reb:29, ast:47, stl:25, blk:8, threePM:23, fgPct:36, ftPct:31, tov:31 } },
  ...
  { id:'sabonis',   name:'Domantas Sabonis',         teamName:'Sacramento Kings',         espnId:3155942, espnRank:34, color:'#5A2D81',
    ...
    ranks:{ pts:46, reb:3, ast:30, stl:39, blk:46, threePM:47, fgPct:8, ftPct:43, tov:20 } },
  { id:'fox',       name:"De'Aaron Fox",             teamName:'San Antonio Spurs',        espnId:4066259, espnRank:35, color:'#C4CED4',
    ...
    ranks:{ pts:34, reb:45, ast:14, stl:18, blk:43, threePM:22, fgPct:25, ftPct:40, tov:28 } },
  ...
  { id:'garland',   name:'Darius Garland',           teamName:'Cleveland Cavaliers',      espnId:4396907, espnRank:38, color:'#860038',
    ...
    ranks:{ pts:36, reb:49, ast:10, stl:42, blk:50, threePM:12, fgPct:43, ftPct:17, tov:18 } },
  { id:'dbane',     name:'Desmond Bane',             teamName:'Orlando Magic',            espnId:4066320, espnRank:39, color:'#0077C0',
    ...
    ranks:{ pts:26, reb:41, ast:29, stl:32, blk:29, threePM:17, fgPct:26, ftPct:2, tov:35 } },
  { id:'agordon',   name:'Aaron Gordon',             teamName:'Denver Nuggets',           espnId:3064290, espnRank:40, color:'#0E2240',
    ...
    ranks:{ pts:43, reb:25, ast:43, stl:46, blk:44, threePM:24, fgPct:19, ftPct:34, tov:48 } },
  { id:'og',        name:'OG Anunoby',               teamName:'New York Knicks',          espnId:3934719, espnRank:41, color:'#006BB6',
    stats:{ pts:16.7, reb:5.3, ast:2.2, stl:1.7, blk:0.7, threePM:2.2, fgPct:48.3, ftPct:80.5, tov:1.9 },
    ranks:{ pts:44, reb:32, ast:45, stl:3, blk:23, threePM:14, fgPct:28, ftPct:29, tov:39 } },
  { id:'randle',    name:'Julius Randle',            teamName:'Minnesota Timberwolves',   espnId:3064514, espnRank:42, color:'#0C2340',
    stats:{ pts:20.9, reb:6.9, ast:5.1, stl:1.1, blk:0.2, threePM:1.4, fgPct:48.0, ftPct:81.8, tov:2.7 },
    ranks:{ pts:25, reb:21, ast:24, stl:27, blk:47, threePM:34, fgPct:30, ftPct:26, tov:21 } },
  ...
  { id:'jjohnson',  name:'Jalen Johnson',            teamName:'Atlanta Hawks',            espnId:4701230, espnRank:44, color:'#C8102E',
    ...
    ranks:{ pts:21, reb:8, ast:7, stl:15, blk:31, threePM:31, fgPct:20, ftPct:35, tov:9 } },
  ...
  { id:'jmurray',   name:'Jamal Murray',             teamName:'Denver Nuggets',           espnId:3936299, espnRank:46, color:'#0E2240',
    ...
    ranks:{ pts:16, reb:40, ast:8, stl:35, blk:37, threePM:7, fgPct:33, ftPct:11, tov:29 } },
  { id:'embiid',    name:'Joel Embiid',              teamName:'Philadelphia 76ers',       espnId:3059318, espnRank:47, color:'#006BB6',
    ...
    ranks:{ pts:12, reb:19, ast:32, stl:47, blk:11, threePM:36, fgPct:21, ftPct:14, tov:14 } },
  { id:'mbridges',  name:'Mikal Bridges',            teamName:'New York Knicks',          espnId:3147657, espnRank:48, color:'#006BB6',
    stats:{ pts:15.0, reb:4.1, ast:3.9, stl:1.4, blk:0.8, threePM:2.0, fgPct:49.0, ftPct:82.1, tov:1.0 },
    ranks:{ pts:48, reb:43, ast:33, stl:13, blk:20, threePM:18, fgPct:24, ftPct:25, tov:49 } },
