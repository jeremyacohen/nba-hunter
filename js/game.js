...
const PLAYERS = [
  { id:'jokic',     name:'Nikola Jokic',            teamName:'Denver Nuggets',          espnId:3112335, espnRank:1,  color:'#0E2240',
    stats:{ pts:27.8, reb:12.8, ast:10.8, stl:1.4, blk:0.8, threePM:1.8, fgPct:57.0, ftPct:83.1, tov:3.8 },
    ranks:{ pts:8, reb:1, ast:1, stl:7, blk:15, threePM:21, fgPct:5, ftPct:21, tov:2 } },
  { id:'sga',       name:'Shai Gilgeous-Alexander',  teamName:'Oklahoma City Thunder',    espnId:4278073, espnRank:2,  color:'#007AC1',
    stats:{ pts:31.5, reb:4.4, ast:6.6, stl:1.4, blk:0.8, threePM:1.7, fgPct:55.7, ftPct:88.7, tov:2.2 },
    ranks:{ pts:2, reb:39, ast:12, stl:8, blk:16, threePM:26, fgPct:6, ftPct:8, tov:30 } },
  { id:'luka',      name:'Luka Doncic',              teamName:'Los Angeles Lakers',       espnId:3945274, espnRank:3,  color:'#552583',
    stats:{ pts:33.6, reb:7.8, ast:8.3, stl:1.6, blk:0.5, threePM:4.0, fgPct:47.4, ftPct:77.4, tov:4.0 },
    ranks:{ pts:1, reb:17, ast:3, stl:4, blk:28, threePM:2, fgPct:37, ftPct:38, tov:1 } },
  { id:'giannis',   name:'Giannis Antetokounmpo',    teamName:'Milwaukee Bucks',          espnId:3032977, espnRank:4,  color:'#00471B',
    ...
    ranks:{ pts:9, reb:9, ast:20, stl:34, blk:21, threePM:45, fgPct:3, ftPct:48, tov:9 } },
  { id:'wemby',     name:'Victor Wembanyama',        teamName:'San Antonio Spurs',        espnId:5104157, espnRank:5,  color:'#C4CED4',
    stats:{ pts:24.2, reb:11.2, ast:3.0, stl:1.1, blk:3.1, threePM:1.9, fgPct:50.5, ftPct:81.8, tov:2.5 },
    ranks:{ pts:18, reb:5, ast:38, stl:20, blk:1, threePM:18, fgPct:16, ftPct:26, tov:23 } },
  { id:'edwards',   name:'Anthony Edwards',          teamName:'Minnesota Timberwolves',   espnId:4594268, espnRank:6,  color:'#0C2340',
    stats:{ pts:29.5, reb:5.1, ast:3.7, stl:1.4, blk:0.8, threePM:3.4, fgPct:49.2, ftPct:79.6, tov:2.8 },
    ranks:{ pts:3, reb:33, ast:34, stl:9, blk:17, threePM:3, fgPct:23, ftPct:33, tov:16 } },
  { id:'curry',     name:'Stephen Curry',            teamName:'Golden State Warriors',    espnId:3975,    espnRank:7,  color:'#1D428A',
    ...
    ranks:{ pts:10, reb:46, ast:27, stl:21, blk:32, threePM:1, fgPct:38, ftPct:1, tov:17 } },
  { id:'lebron',    name:'LeBron James',             teamName:'Los Angeles Lakers',       espnId:1966,    espnRank:8,  color:'#552583',
    stats:{ pts:21.0, reb:6.0, ast:6.9, stl:1.1, blk:0.6, threePM:1.3, fgPct:51.3, ftPct:74.8, tov:3.0 },
    ranks:{ pts:25, reb:25, ast:9, stl:22, blk:24, threePM:34, fgPct:14, ftPct:41, tov:12 } },
  { id:'durant',    name:'Kevin Durant',             teamName:'Houston Rockets',          espnId:3202,    espnRank:9,  color:'#CE1141',
    stats:{ pts:26.0, reb:5.4, ast:4.5, stl:0.9, blk:0.9, threePM:2.4, fgPct:51.8, ftPct:87.8, tov:3.2 },
    ranks:{ pts:14, reb:31, ast:28, stl:35, blk:12, threePM:13, fgPct:12, ftPct:11, tov:10 } },
  { id:'brunson',   name:'Jalen Brunson',            teamName:'New York Knicks',          espnId:3934672, espnRank:10, color:'#006BB6',
    stats:{ pts:26.2, reb:3.4, ast:6.6, stl:0.8, blk:0.1, threePM:2.7, fgPct:46.4, ftPct:84.4, tov:2.3 },
    ranks:{ pts:13, reb:47, ast:13, stl:41, blk:48, threePM:10, fgPct:40, ftPct:18, tov:27 } },
  { id:'jwilliams', name:'Jalen Williams',           teamName:'Oklahoma City Thunder',    espnId:4593803, espnRank:11, color:'#007AC1',
    stats:{ pts:17.1, reb:4.6, ast:5.4, stl:1.2, blk:0.3, threePM:0.8, fgPct:47.7, ftPct:82.4, tov:1.9 },
    ranks:{ pts:41, reb:36, ast:21, stl:15, blk:37, threePM:41, fgPct:33, ftPct:25, tov:36 } },
  { id:'cade',      name:'Cade Cunningham',          teamName:'Detroit Pistons',          espnId:4432166, espnRank:12, color:'#C8102E',
    ...
    ranks:{ pts:17, reb:29, ast:2, stl:5, blk:13, threePM:15, fgPct:41, ftPct:27, tov:3 } },
  { id:'mobley',    name:'Evan Mobley',              teamName:'Cleveland Cavaliers',      espnId:4432158, espnRank:13, color:'#860038',
    stats:{ pts:18.1, reb:8.9, ast:3.6, stl:0.8, blk:1.8, threePM:1.0, fgPct:53.8, ftPct:60.1, tov:1.9 },
    ranks:{ pts:37, reb:11, ast:35, stl:42, blk:3, threePM:38, fgPct:9, ftPct:49, tov:37 } },
  { id:'adavis',    name:'Anthony Davis',            teamName:'Dallas Mavericks',         espnId:6583,    espnRank:14, color:'#003DA5',
    ...
    ranks:{ pts:27, reb:6, ast:40, stl:23, blk:5, threePM:43, fgPct:15, ftPct:42, tov:34 } },
  { id:'mitchell',  name:'Donovan Mitchell',         teamName:'Cleveland Cavaliers',      espnId:3908809, espnRank:15, color:'#860038',
    stats:{ pts:28.2, reb:4.5, ast:5.8, stl:1.5, blk:0.3, threePM:3.3, fgPct:48.1, ftPct:85.8, tov:2.8 },
    ranks:{ pts:7, reb:37, ast:17, stl:6, blk:38, threePM:4, fgPct:30, ftPct:15, tov:18 } },
  { id:'booker',    name:'Devin Booker',             teamName:'Phoenix Suns',             espnId:3136193, espnRank:16, color:'#1D1160',
    stats:{ pts:25.5, reb:3.9, ast:5.9, stl:0.8, blk:0.3, threePM:1.8, fgPct:45.0, ftPct:86.8, tov:3.2 },
    ranks:{ pts:15, reb:44, ast:16, stl:43, blk:39, threePM:22, fgPct:45, ftPct:12, tov:11 } },
  { id:'banchero',  name:'Paolo Banchero',           teamName:'Orlando Magic',            espnId:4432573, espnRank:17, color:'#0077C0',
    stats:{ pts:22.7, reb:8.4, ast:5.1, stl:0.7, blk:0.6, threePM:1.3, fgPct:46.1, ftPct:78.1, tov:3.0 },
    ranks:{ pts:22, reb:15, ast:24, stl:45, blk:25, threePM:35, fgPct:42, ftPct:35, tov:13 } },
  { id:'butler',    name:'Jimmy Butler',             teamName:'Golden State Warriors',    espnId:6430,    espnRank:18, color:'#1D428A',
    ...
    ranks:{ pts:31, reb:30, ast:26, stl:10, blk:45, threePM:42, fgPct:11, ftPct:13, tov:43 } },
  { id:'jbrown',    name:'Jaylen Brown',             teamName:'Boston Celtics',           espnId:3917376, espnRank:19, color:'#007A33',
    stats:{ pts:28.6, reb:7.0, ast:5.2, stl:1.0, blk:0.4, threePM:1.9, fgPct:47.7, ftPct:80.2, tov:3.6 },
    ranks:{ pts:5, reb:20, ast:23, stl:29, blk:33, threePM:19, fgPct:34, ftPct:31, tov:4 } },
  { id:'kawhi',     name:'Kawhi Leonard',            teamName:'LA Clippers',              espnId:6450,    espnRank:20, color:'#C8102E',
    stats:{ pts:28.3, reb:6.3, ast:3.6, stl:2.0, blk:0.5, threePM:2.6, fgPct:50.4, ftPct:90.1, tov:2.1 },
    ranks:{ pts:6, reb:24, ast:36, stl:1, blk:29, threePM:12, fgPct:17, ftPct:4, tov:33 } },
  { id:'adebayo',   name:'Bam Adebayo',              teamName:'Miami Heat',               espnId:4066261, espnRank:21, color:'#98002E',
    stats:{ pts:20.3, reb:9.8, ast:3.0, stl:1.2, blk:0.7, threePM:1.7, fgPct:44.2, ftPct:77.5, tov:1.7 },
    ranks:{ pts:28, reb:10, ast:39, stl:16, blk:22, threePM:27, fgPct:47, ftPct:37, tov:41 } },
  { id:'siakam',    name:'Pascal Siakam',            teamName:'Indiana Pacers',           espnId:3149673, espnRank:22, color:'#002D62',
    stats:{ pts:23.9, reb:6.6, ast:3.8, stl:1.1, blk:0.4, threePM:1.7, fgPct:48.4, ftPct:69.1, tov:2.2 },
    ranks:{ pts:20, reb:23, ast:33, stl:24, blk:34, threePM:28, fgPct:28, ftPct:46, tov:31 } },
  { id:'harden',    name:'James Harden',             teamName:'LA Clippers',              espnId:3992,    espnRank:23, color:'#C8102E',
    stats:{ pts:24.1, reb:5.0, ast:8.0, stl:1.1, blk:0.4, threePM:3.1, fgPct:43.5, ftPct:88.5, tov:3.6 },
    ranks:{ pts:19, reb:34, ast:6, stl:25, blk:35, threePM:6, fgPct:48, ftPct:9, tov:5 } },
  { id:'holmgren',  name:'Chet Holmgren',            teamName:'Oklahoma City Thunder',    espnId:4433255, espnRank:24, color:'#007AC1',
    stats:{ pts:17.1, reb:8.9, ast:1.7, stl:0.5, blk:1.9, threePM:1.2, fgPct:55.2, ftPct:79.8, tov:1.5 },
    ranks:{ pts:42, reb:12, ast:49, stl:49, blk:2, threePM:37, fgPct:7, ftPct:32, tov:44 } },
  { id:'sengun',    name:'Alperen Sengun',           teamName:'Houston Rockets',          espnId:4871144, espnRank:25, color:'#CE1141',
    stats:{ pts:20.5, reb:8.9, ast:6.1, stl:1.2, blk:1.1, threePM:0.5, fgPct:51.7, ftPct:68.4, tov:3.3 },
    ranks:{ pts:26, reb:13, ast:15, stl:17, blk:10, threePM:44, fgPct:13, ftPct:47, tov:8 } },
  { id:'dwhite',    name:'Derrick White',            teamName:'Boston Celtics',           espnId:3078576, espnRank:26, color:'#007A33',
    stats:{ pts:17.2, reb:4.5, ast:5.5, stl:1.2, blk:1.4, threePM:2.8, fgPct:39.4, ftPct:90.3, tov:1.8 },
    ranks:{ pts:40, reb:38, ast:18, stl:18, blk:7, threePM:8, fgPct:50, ftPct:3, tov:39 } },
  { id:'kat',       name:'Karl-Anthony Towns',       teamName:'New York Knicks',          espnId:3136195, espnRank:27, color:'#006BB6',
    stats:{ pts:20.2, reb:12.0, ast:2.8, stl:0.9, blk:0.6, threePM:1.6, fgPct:49.4, ftPct:85.5, tov:2.5 },
    ranks:{ pts:30, reb:2, ast:41, stl:36, blk:26, threePM:30, fgPct:21, ftPct:16, tov:24 } },
  { id:'maxey',     name:'Tyrese Maxey',             teamName:'Philadelphia 76ers',       espnId:4431678, espnRank:28, color:'#006BB6',
    stats:{ pts:29.0, reb:4.1, ast:6.7, stl:2.0, blk:0.8, threePM:3.3, fgPct:46.1, ftPct:89.3, tov:2.4 },
    ranks:{ pts:4, reb:42, ast:11, stl:2, blk:18, threePM:5, fgPct:43, ftPct:7, tov:26 } },
  { id:'trae',      name:'Trae Young',               teamName:'Atlanta Hawks',            espnId:4277905, espnRank:29, color:'#C8102E',
    ...
    ranks:{ pts:38, reb:50, ast:7, stl:37, blk:49, threePM:23, fgPct:44, ftPct:24, tov:21 } },
  { id:'barnes',    name:'Scottie Barnes',           teamName:'Toronto Raptors',          espnId:4433134, espnRank:30, color:'#CE1141',
    stats:{ pts:18.5, reb:7.8, ast:5.5, stl:1.4, blk:1.5, threePM:0.9, fgPct:50.2, ftPct:83.2, tov:2.6 },
    ranks:{ pts:36, reb:18, ast:19, stl:11, blk:6, threePM:40, fgPct:18, ftPct:20, tov:22 } },
  ...
  { id:'fwagner',   name:'Franz Wagner',             teamName:'Orlando Magic',            espnId:4566434, espnRank:32, color:'#0077C0',
    ...
    ranks:{ pts:23, reb:27, ast:37, stl:27, blk:40, threePM:32, fgPct:31, ftPct:22, tov:42 } },
  { id:'morant',    name:'Ja Morant',                teamName:'Memphis Grizzlies',        espnId:4279888, espnRank:33, color:'#5D76A9',
    ...
    ranks:{ pts:33, reb:48, ast:4, stl:30, blk:41, threePM:39, fgPct:49, ftPct:5, tov:6 } },
  { id:'sabonis',   name:'Domantas Sabonis',         teamName:'Sacramento Kings',         espnId:3155942, espnRank:34, color:'#5A2D81',
    ...
    ranks:{ pts:46, reb:4, ast:30, stl:38, blk:46, threePM:46, fgPct:8, ftPct:43, tov:19 } },
  { id:'fox',       name:"De'Aaron Fox",             teamName:'San Antonio Spurs',        espnId:4066259, espnRank:35, color:'#C4CED4',
    stats:{ pts:18.9, reb:3.8, ast:6.3, stl:1.2, blk:0.3, threePM:1.9, fgPct:48.6, ftPct:76.5, tov:2.3 },
    ranks:{ pts:34, reb:45, ast:14, stl:19, blk:42, threePM:20, fgPct:25, ftPct:39, tov:28 } },
  ...
  { id:'amen',      name:'Amen Thompson',            teamName:'Houston Rockets',          espnId:4684740, espnRank:37, color:'#CE1141',
    stats:{ pts:17.9, reb:7.9, ast:5.3, stl:1.4, blk:0.6, threePM:0.3, fgPct:52.4, ftPct:77.7, tov:2.5 },
    ranks:{ pts:39, reb:16, ast:22, stl:12, blk:27, threePM:47, fgPct:10, ftPct:36, tov:25 } },
  { id:'garland',   name:'Darius Garland',           teamName:'Cleveland Cavaliers',      espnId:4396907, espnRank:38, color:'#860038',
    stats:{ pts:18.9, reb:2.4, ast:6.9, stl:0.9, blk:0.1, threePM:2.8, fgPct:46.8, ftPct:85.3, tov:2.9 },
    ranks:{ pts:35, reb:49, ast:10, stl:39, blk:50, threePM:9, fgPct:39, ftPct:17, tov:15 } },
  { id:'dbane',     name:'Desmond Bane',             teamName:'Orlando Magic',            espnId:4066320, espnRank:39, color:'#0077C0',
    stats:{ pts:20.3, reb:4.2, ast:4.2, stl:1.0, blk:0.4, threePM:2.0, fgPct:48.6, ftPct:92.4, tov:2.0 },
    ranks:{ pts:29, reb:41, ast:29, stl:31, blk:36, threePM:16, fgPct:26, ftPct:2, tov:35 } },
  { id:'agordon',   name:'Aaron Gordon',             teamName:'Denver Nuggets',           espnId:3064290, espnRank:40, color:'#0E2240',
    stats:{ pts:16.6, reb:5.9, ast:2.5, stl:0.6, blk:0.3, threePM:1.8, fgPct:50.1, ftPct:76.2, tov:1.1 },
    ranks:{ pts:45, reb:26, ast:43, stl:46, blk:43, threePM:25, fgPct:19, ftPct:40, tov:49 } },
  { id:'og',        name:'OG Anunoby',               teamName:'New York Knicks',          espnId:3934719, espnRank:41, color:'#006BB6',
    stats:{ pts:16.8, reb:5.2, ast:2.2, stl:1.7, blk:0.7, threePM:2.2, fgPct:48.7, ftPct:81.4, tov:1.9 },
    ranks:{ pts:43, reb:32, ast:45, stl:3, blk:23, threePM:14, fgPct:24, ftPct:28, tov:38 } },
  { id:'randle',    name:'Julius Randle',            teamName:'Minnesota Timberwolves',   espnId:3064514, espnRank:42, color:'#0C2340',
    stats:{ pts:21.1, reb:6.8, ast:5.1, stl:1.1, blk:0.2, threePM:1.4, fgPct:47.9, ftPct:81.2, tov:2.7 },
    ranks:{ pts:24, reb:22, ast:25, stl:28, blk:47, threePM:33, fgPct:32, ftPct:29, tov:20 } },
  ...
  { id:'jjohnson',  name:'Jalen Johnson',            teamName:'Atlanta Hawks',            espnId:4701230, espnRank:44, color:'#C8102E',
    stats:{ pts:22.8, reb:10.3, ast:8.1, stl:1.3, blk:0.5, threePM:1.6, fgPct:49.3, ftPct:78.2, tov:3.4 },
    ranks:{ pts:21, reb:8, ast:5, stl:13, blk:31, threePM:31, fgPct:22, ftPct:34, tov:7 } },
  { id:'jallen',    name:'Jarrett Allen',            teamName:'Cleveland Cavaliers',      espnId:4066328, espnRank:45, color:'#860038',
    stats:{ pts:15.3, reb:8.5, ast:1.9, stl:1.0, blk:0.9, threePM:0.0, fgPct:63.6, ftPct:72.5, tov:1.4 },
    ranks:{ pts:47, reb:14, ast:48, stl:33, blk:14, threePM:49, fgPct:2, ftPct:44, tov:46 } },
  { id:'jmurray',   name:'Jamal Murray',             teamName:'Denver Nuggets',           espnId:3936299, espnRank:46, color:'#0E2240',
    stats:{ pts:25.4, reb:4.4, ast:7.1, stl:0.9, blk:0.3, threePM:3.1, fgPct:48.3, ftPct:88.3, tov:2.3 },
    ranks:{ pts:16, reb:40, ast:8, stl:40, blk:44, threePM:7, fgPct:29, ftPct:10, tov:29 } },
  { id:'embiid',    name:'Joel Embiid',              teamName:'Philadelphia 76ers',       espnId:3059318, espnRank:47, color:'#006BB6',
    stats:{ pts:26.9, reb:7.5, ast:4.0, stl:0.6, blk:1.1, threePM:1.3, fgPct:50.1, ftPct:85.9, tov:3.0 },
    ranks:{ pts:11, reb:19, ast:31, stl:47, blk:11, threePM:36, fgPct:20, ftPct:14, tov:14 } },
  { id:'mbridges',  name:'Mikal Bridges',            teamName:'New York Knicks',          espnId:3147657, espnRank:48, color:'#006BB6',
    stats:{ pts:14.7, reb:4.1, ast:3.9, stl:1.3, blk:0.8, threePM:2.0, fgPct:48.5, ftPct:82.6, tov:1.0 },
    ranks:{ pts:48, reb:43, ast:32, stl:14, blk:20, threePM:17, fgPct:27, ftPct:23, tov:50 } },
  { id:'gobert',    name:'Rudy Gobert',              teamName:'Minnesota Timberwolves',   espnId:3032976, espnRank:49, color:'#0C2340',
    ...
    ranks:{ pts:50, reb:3, ast:50, stl:44, blk:4, threePM:50, fgPct:1, ftPct:50, tov:47 } },
  { id:'porzingis', name:'Kristaps Porzingis',       teamName:'Atlanta Hawks',            espnId:3102531, espnRank:50, color:'#C8102E',
    stats:{ pts:16.7, reb:4.8, ast:2.7, stl:0.6, blk:1.4, threePM:1.7, fgPct:44.4, ftPct:83.5, tov:1.3 },
    ranks:{ pts:44, reb:35, ast:42, stl:48, blk:9, threePM:29, fgPct:46, ftPct:19, tov:48 } },
];
