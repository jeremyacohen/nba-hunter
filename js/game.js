...
const PLAYERS = [
  { id:'jokic',     name:'Nikola Jokic',            teamName:'Denver Nuggets',          espnId:3112335, espnRank:1,  color:'#0E2240',
    stats:{ pts:28.2, reb:12.6, ast:10.5, stl:1.5, blk:0.8, threePM:1.8, fgPct:57.3, ftPct:83.3, tov:3.9 },
    ranks:{ pts:6, reb:1, ast:1, stl:5, blk:15, threePM:22, fgPct:5, ftPct:20, tov:2 } },
  { id:'sga',       name:'Shai Gilgeous-Alexander',  teamName:'Oklahoma City Thunder',    espnId:4278073, espnRank:2,  color:'#007AC1',
    stats:{ pts:31.5, reb:4.5, ast:6.6, stl:1.4, blk:0.8, threePM:1.7, fgPct:55.1, ftPct:89.2, tov:2.1 },
    ranks:{ pts:2, reb:37, ast:12, stl:9, blk:16, threePM:26, fgPct:7, ftPct:8, tov:32 } },
  { id:'luka',      name:'Luka Doncic',              teamName:'Los Angeles Lakers',       espnId:3945274, espnRank:3,  color:'#552583',
    stats:{ pts:33.0, reb:7.9, ast:8.5, stl:1.5, blk:0.6, threePM:3.9, fgPct:47.5, ftPct:77.1, tov:4.0 },
    ranks:{ pts:1, reb:16, ast:3, stl:6, blk:24, threePM:2, fgPct:37, ftPct:38, tov:1 } },
  ...
  { id:'wemby',     name:'Victor Wembanyama',        teamName:'San Antonio Spurs',        espnId:5104157, espnRank:5,  color:'#C4CED4',
    ...
    ranks:{ pts:18, reb:5, ast:38, stl:28, blk:1, threePM:16, fgPct:14, ftPct:29, tov:23 } },
  ...
  { id:'lebron',    name:'LeBron James',             teamName:'Los Angeles Lakers',       espnId:1966,    espnRank:8,  color:'#552583',
    stats:{ pts:21.4, reb:5.6, ast:6.8, stl:1.1, blk:0.6, threePM:1.4, fgPct:51.4, ftPct:74.1, tov:3.0 },
    ranks:{ pts:23, reb:28, ast:9, stl:20, blk:25, threePM:33, fgPct:13, ftPct:41, tov:12 } },
  { id:'durant',    name:'Kevin Durant',             teamName:'Houston Rockets',          espnId:3202,    espnRank:9,  color:'#CE1141',
    stats:{ pts:25.7, reb:5.5, ast:4.4, stl:0.8, blk:0.9, threePM:2.3, fgPct:51.6, ftPct:88.5, tov:3.2 },
    ranks:{ pts:15, reb:31, ast:28, stl:40, blk:12, threePM:13, fgPct:12, ftPct:9, tov:11 } },
  ...
  { id:'jwilliams', name:'Jalen Williams',           teamName:'Oklahoma City Thunder',    espnId:4593803, espnRank:11, color:'#007AC1',
    ...
    ranks:{ pts:40, reb:36, ast:20, stl:14, blk:38, threePM:41, fgPct:31, ftPct:21, tov:36 } },
  ...
  { id:'mobley',    name:'Evan Mobley',              teamName:'Cleveland Cavaliers',      espnId:4432158, espnRank:13, color:'#860038',
    ...
    ranks:{ pts:37, reb:11, ast:35, stl:42, blk:2, threePM:38, fgPct:9, ftPct:49, tov:37 } },
  ...
  { id:'mitchell',  name:'Donovan Mitchell',         teamName:'Cleveland Cavaliers',      espnId:3908809, espnRank:15, color:'#860038',
    ...
    ranks:{ pts:8, reb:38, ast:16, stl:4, blk:39, threePM:4, fgPct:32, ftPct:15, tov:14 } },
  { id:'booker',    name:'Devin Booker',             teamName:'Phoenix Suns',             espnId:3136193, espnRank:16, color:'#1D1160',
    ...
    ranks:{ pts:14, reb:44, ast:17, stl:43, blk:40, threePM:19, fgPct:44, ftPct:12, tov:8 } },
  { id:'banchero',  name:'Paolo Banchero',           teamName:'Orlando Magic',            espnId:4432573, espnRank:17, color:'#0077C0',
    ...
    ranks:{ pts:22, reb:14, ast:25, stl:46, blk:26, threePM:36, fgPct:40, ftPct:37, tov:15 } },
  ...
  { id:'jbrown',    name:'Jaylen Brown',             teamName:'Boston Celtics',           espnId:3917376, espnRank:19, color:'#007A33',
    stats:{ pts:28.5, reb:7.0, ast:5.1, stl:1.0, blk:0.4, threePM:1.9, fgPct:48.0, ftPct:79.6, tov:3.6 },
    ranks:{ pts:5, reb:20, ast:23, stl:29, blk:32, threePM:20, fgPct:30, ftPct:32, tov:4 } },
  { id:'kawhi',     name:'Kawhi Leonard',            teamName:'LA Clippers',              espnId:6450,    espnRank:20, color:'#C8102E',
    stats:{ pts:28.2, reb:6.4, ast:3.6, stl:2.0, blk:0.4, threePM:2.6, fgPct:50.4, ftPct:89.8, tov:2.1 },
    ranks:{ pts:7, reb:24, ast:36, stl:1, blk:33, threePM:11, fgPct:17, ftPct:4, tov:33 } },
  { id:'adebayo',   name:'Bam Adebayo',              teamName:'Miami Heat',               espnId:4066261, espnRank:21, color:'#98002E',
    ...
    ranks:{ pts:30, reb:10, ast:39, stl:22, blk:22, threePM:27, fgPct:47, ftPct:36, tov:39 } },
  { id:'siakam',    name:'Pascal Siakam',            teamName:'Indiana Pacers',           espnId:3149673, espnRank:22, color:'#002D62',
    ...
    ranks:{ pts:19, reb:23, ast:31, stl:23, blk:34, threePM:28, fgPct:29, ftPct:47, tov:29 } },
  ...
  { id:'holmgren',  name:'Chet Holmgren',            teamName:'Oklahoma City Thunder',    espnId:4433255, espnRank:24, color:'#007AC1',
    stats:{ pts:17.2, reb:8.9, ast:1.7, stl:0.6, blk:1.9, threePM:1.2, fgPct:55.2, ftPct:79.2, tov:1.6 },
    ranks:{ pts:42, reb:12, ast:49, stl:47, blk:3, threePM:37, fgPct:6, ftPct:33, tov:44 } },
  { id:'sengun',    name:'Alperen Sengun',           teamName:'Houston Rockets',          espnId:4871144, espnRank:25, color:'#CE1141',
    stats:{ pts:20.3, reb:8.9, ast:6.1, stl:1.2, blk:1.1, threePM:0.5, fgPct:50.6, ftPct:69.1, tov:3.3 },
    ranks:{ pts:28, reb:13, ast:15, stl:16, blk:10, threePM:44, fgPct:16, ftPct:46, tov:9 } },
  ...
  { id:'maxey',     name:'Tyrese Maxey',             teamName:'Philadelphia 76ers',       espnId:4431678, espnRank:28, color:'#006BB6',
    ...
    ranks:{ pts:4, reb:41, ast:11, stl:2, blk:18, threePM:5, fgPct:42, ftPct:7, tov:26 } },
  { id:'trae',      name:'Trae Young',               teamName:'Atlanta Hawks',            espnId:4277905, espnRank:29, color:'#C8102E',
    ...
    ranks:{ pts:38, reb:50, ast:7, stl:36, blk:49, threePM:23, fgPct:43, ftPct:23, tov:21 } },
  { id:'barnes',    name:'Scottie Barnes',           teamName:'Toronto Raptors',          espnId:4433134, espnRank:30, color:'#CE1141',
    stats:{ pts:18.7, reb:7.8, ast:5.3, stl:1.4, blk:1.5, threePM:0.9, fgPct:49.9, ftPct:83.6, tov:2.6 },
    ranks:{ pts:35, reb:17, ast:21, stl:12, blk:6, threePM:40, fgPct:18, ftPct:19, tov:22 } },
  { id:'jjj',       name:'Jaren Jackson Jr.',        teamName:'Memphis Grizzlies',        espnId:4277961, espnRank:31, color:'#5D76A9',
    ...
    ranks:{ pts:32, reb:27, ast:47, stl:25, blk:9, threePM:24, fgPct:36, ftPct:30, tov:30 } },
  { id:'fwagner',   name:'Franz Wagner',             teamName:'Orlando Magic',            espnId:4566434, espnRank:32, color:'#0077C0',
    ...
    ranks:{ pts:24, reb:26, ast:37, stl:26, blk:41, threePM:32, fgPct:33, ftPct:22, tov:42 } },
  ...
  { id:'sabonis',   name:'Domantas Sabonis',         teamName:'Sacramento Kings',         espnId:3155942, espnRank:34, color:'#5A2D81',
    ...
    ranks:{ pts:46, reb:3, ast:30, stl:37, blk:45, threePM:46, fgPct:8, ftPct:43, tov:19 } },
  ...
  { id:'amen',      name:'Amen Thompson',            teamName:'Houston Rockets',          espnId:4684740, espnRank:37, color:'#CE1141',
    stats:{ pts:17.9, reb:7.8, ast:5.3, stl:1.5, blk:0.6, threePM:0.3, fgPct:52.2, ftPct:77.0, tov:2.5 },
    ranks:{ pts:39, reb:18, ast:22, stl:8, blk:28, threePM:47, fgPct:10, ftPct:39, tov:25 } },
  { id:'garland',   name:'Darius Garland',           teamName:'Cleveland Cavaliers',      espnId:4396907, espnRank:38, color:'#860038',
    stats:{ pts:18.2, reb:2.4, ast:6.8, stl:0.9, blk:0.1, threePM:2.5, fgPct:45.4, ftPct:85.3, tov:2.9 },
    ranks:{ pts:36, reb:49, ast:10, stl:38, blk:50, threePM:12, fgPct:45, ftPct:16, tov:16 } },
  ...
  { id:'agordon',   name:'Aaron Gordon',             teamName:'Denver Nuggets',           espnId:3064290, espnRank:40, color:'#0E2240',
    ...
    ranks:{ pts:45, reb:25, ast:43, stl:48, blk:46, threePM:25, fgPct:19, ftPct:34, tov:48 } },
  ...
  { id:'randle',    name:'Julius Randle',            teamName:'Minnesota Timberwolves',   espnId:3064514, espnRank:42, color:'#0C2340',
    stats:{ pts:21.2, reb:6.8, ast:5.1, stl:1.1, blk:0.2, threePM:1.4, fgPct:48.6, ftPct:81.8, tov:2.7 },
    ranks:{ pts:25, reb:22, ast:24, stl:27, blk:47, threePM:34, fgPct:27, ftPct:26, tov:20 } },
  { id:'lauri',     name:'Lauri Markkanen',          teamName:'Utah Jazz',                espnId:4066336, espnRank:43, color:'#002B5C',
    ...
    ranks:{ pts:11, reb:21, ast:46, stl:32, blk:29, threePM:10, fgPct:35, ftPct:6, tov:45 } },
  { id:'jjohnson',  name:'Jalen Johnson',            teamName:'Atlanta Hawks',            espnId:4701230, espnRank:44, color:'#C8102E',
    stats:{ pts:22.9, reb:10.5, ast:8.1, stl:1.3, blk:0.5, threePM:1.6, fgPct:49.3, ftPct:78.0, tov:3.4 },
    ranks:{ pts:21, reb:8, ast:5, stl:15, blk:30, threePM:31, fgPct:21, ftPct:35, tov:7 } },
  ...
  { id:'embiid',    name:'Joel Embiid',              teamName:'Philadelphia 76ers',       espnId:3059318, espnRank:47, color:'#006BB6',
    ...
    ranks:{ pts:12, reb:19, ast:32, stl:49, blk:11, threePM:35, fgPct:20, ftPct:14, tov:13 } },
  { id:'mbridges',  name:'Mikal Bridges',            teamName:'New York Knicks',          espnId:3147657, espnRank:48, color:'#006BB6',
    ...
    ranks:{ pts:48, reb:43, ast:33, stl:13, blk:20, threePM:18, fgPct:28, ftPct:25, tov:49 } },
  { id:'gobert',    name:'Rudy Gobert',              teamName:'Minnesota Timberwolves',   espnId:3032976, espnRank:49, color:'#0C2340',
    stats:{ pts:10.9, reb:11.4, ast:1.7, stl:0.8, blk:1.6, threePM:0.0, fgPct:70.5, ftPct:51.8, tov:1.4 },
    ranks:{ pts:50, reb:4, ast:50, stl:44, blk:5, threePM:50, fgPct:1, ftPct:50, tov:47 } },
  { id:'porzingis', name:'Kristaps Porzingis',       teamName:'Atlanta Hawks',            espnId:3102531, espnRank:50, color:'#C8102E',
    stats:{ pts:17.0, reb:4.8, ast:2.7, stl:0.7, blk:1.5, threePM:1.7, fgPct:45.1, ftPct:82.5, tov:1.0 },
    ranks:{ pts:43, reb:35, ast:42, stl:45, blk:7, threePM:29, fgPct:46, ftPct:24, tov:50 } },
];
