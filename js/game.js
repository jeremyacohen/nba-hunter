...
const PLAYERS = [
  { id:'jokic',     name:'Nikola Jokic',            teamName:'Denver Nuggets',          espnId:3112335, espnRank:1,  color:'#0E2240',
    ...
    ranks:{ pts:7, reb:1, ast:1, stl:8, blk:15, threePM:22, fgPct:5, ftPct:21, tov:2 } },
  { id:'sga',       name:'Shai Gilgeous-Alexander',  teamName:'Oklahoma City Thunder',    espnId:4278073, espnRank:2,  color:'#007AC1',
    stats:{ pts:31.4, reb:4.3, ast:6.5, stl:1.4, blk:0.8, threePM:1.7, fgPct:55.1, ftPct:88.2, tov:2.2 },
    ranks:{ pts:2, reb:40, ast:13, stl:9, blk:16, threePM:26, fgPct:7, ftPct:10, tov:31 } },
  ...
  { id:'wemby',     name:'Victor Wembanyama',        teamName:'San Antonio Spurs',        espnId:5104157, espnRank:5,  color:'#C4CED4',
    stats:{ pts:24.2, reb:11.3, ast:3.0, stl:1.1, blk:3.1, threePM:1.9, fgPct:50.1, ftPct:82.0, tov:2.5 },
    ranks:{ pts:18, reb:5, ast:38, stl:20, blk:1, threePM:18, fgPct:18, ftPct:25, tov:23 } },
  { id:'edwards',   name:'Anthony Edwards',          teamName:'Minnesota Timberwolves',   espnId:4594268, espnRank:6,  color:'#0C2340',
    ...
    ranks:{ pts:3, reb:32, ast:34, stl:10, blk:17, threePM:3, fgPct:23, ftPct:33, tov:16 } },
  ...
  { id:'lebron',    name:'LeBron James',             teamName:'Los Angeles Lakers',       espnId:1966,    espnRank:8,  color:'#552583',
    ...
    ranks:{ pts:24, reb:25, ast:9, stl:22, blk:24, threePM:34, fgPct:14, ftPct:41, tov:14 } },
  ...
  { id:'brunson',   name:'Jalen Brunson',            teamName:'New York Knicks',          espnId:3934672, espnRank:10, color:'#006BB6',
    ...
    ranks:{ pts:13, reb:47, ast:11, stl:41, blk:48, threePM:10, fgPct:40, ftPct:18, tov:26 } },
  ...
  { id:'cade',      name:'Cade Cunningham',          teamName:'Detroit Pistons',          espnId:4432166, espnRank:12, color:'#C8102E',
    ...
    ranks:{ pts:17, reb:29, ast:2, stl:5, blk:13, threePM:15, fgPct:42, ftPct:28, tov:3 } },
  { id:'mobley',    name:'Evan Mobley',              teamName:'Cleveland Cavaliers',      espnId:4432158, espnRank:13, color:'#860038',
    stats:{ pts:18.2, reb:8.9, ast:3.6, stl:0.8, blk:1.8, threePM:1.0, fgPct:54.0, ftPct:60.4, tov:1.9 },
    ranks:{ pts:37, reb:12, ast:35, stl:42, blk:2, threePM:38, fgPct:9, ftPct:49, tov:37 } },
  { id:'adavis',    name:'Anthony Davis',            teamName:'Dallas Mavericks',         espnId:6583,    espnRank:14, color:'#003DA5',
    ...
    ranks:{ pts:27, reb:6, ast:40, stl:23, blk:5, threePM:44, fgPct:16, ftPct:42, tov:34 } },
  { id:'mitchell',  name:'Donovan Mitchell',         teamName:'Cleveland Cavaliers',      espnId:3908809, espnRank:15, color:'#860038',
    ...
    ranks:{ pts:8, reb:37, ast:17, stl:6, blk:39, threePM:4, fgPct:32, ftPct:15, tov:18 } },
  { id:'booker',    name:'Devin Booker',             teamName:'Phoenix Suns',             espnId:3136193, espnRank:16, color:'#1D1160',
    stats:{ pts:25.5, reb:3.9, ast:6.0, stl:0.8, blk:0.3, threePM:1.8, fgPct:45.2, ftPct:86.9, tov:3.2 },
    ranks:{ pts:15, reb:44, ast:16, stl:43, blk:40, threePM:23, fgPct:46, ftPct:12, tov:10 } },
  { id:'banchero',  name:'Paolo Banchero',           teamName:'Orlando Magic',            espnId:4432573, espnRank:17, color:'#0077C0',
    ...
    ranks:{ pts:22, reb:15, ast:24, stl:45, blk:25, threePM:36, fgPct:43, ftPct:35, tov:12 } },
  ...
  { id:'jbrown',    name:'Jaylen Brown',             teamName:'Boston Celtics',           espnId:3917376, espnRank:19, color:'#007A33',
    ...
    ranks:{ pts:5, reb:20, ast:22, stl:29, blk:32, threePM:19, fgPct:33, ftPct:31, tov:4 } },
  { id:'kawhi',     name:'Kawhi Leonard',            teamName:'LA Clippers',              espnId:6450,    espnRank:20, color:'#C8102E',
    ...
    ranks:{ pts:6, reb:24, ast:36, stl:2, blk:33, threePM:12, fgPct:17, ftPct:4, tov:33 } },
  { id:'adebayo',   name:'Bam Adebayo',              teamName:'Miami Heat',               espnId:4066261, espnRank:21, color:'#98002E',
    stats:{ pts:20.1, reb:9.9, ast:3.0, stl:1.2, blk:0.7, threePM:1.7, fgPct:43.8, ftPct:77.7, tov:1.7 },
  ...
  { id:'siakam',    name:'Pascal Siakam',            teamName:'Indiana Pacers',           espnId:3149673, espnRank:22, color:'#002D62',
    ...
    ranks:{ pts:20, reb:23, ast:32, stl:24, blk:34, threePM:28, fgPct:30, ftPct:46, tov:28 } },
  ...
  { id:'holmgren',  name:'Chet Holmgren',            teamName:'Oklahoma City Thunder',    espnId:4433255, espnRank:24, color:'#007AC1',
    stats:{ pts:17.1, reb:8.9, ast:1.7, stl:0.5, blk:1.8, threePM:1.2, fgPct:55.2, ftPct:79.9, tov:1.5 },
    ranks:{ pts:42, reb:13, ast:49, stl:49, blk:3, threePM:37, fgPct:6, ftPct:32, tov:44 } },
  { id:'sengun',    name:'Alperen Sengun',           teamName:'Houston Rockets',          espnId:4871144, espnRank:25, color:'#CE1141',
    ...
    ranks:{ pts:26, reb:11, ast:14, stl:17, blk:10, threePM:43, fgPct:13, ftPct:47, tov:11 } },
  { id:'dwhite',    name:'Derrick White',            teamName:'Boston Celtics',           espnId:3078576, espnRank:26, color:'#007A33',
    ...
    ranks:{ pts:43, reb:38, ast:19, stl:18, blk:7, threePM:8, fgPct:50, ftPct:3, tov:39 } },
  { id:'kat',       name:'Karl-Anthony Towns',       teamName:'New York Knicks',          espnId:3136195, espnRank:27, color:'#006BB6',
    ...
    ranks:{ pts:31, reb:2, ast:41, stl:36, blk:28, threePM:31, fgPct:21, ftPct:16, tov:24 } },
  { id:'maxey',     name:'Tyrese Maxey',             teamName:'Philadelphia 76ers',       espnId:4431678, espnRank:28, color:'#006BB6',
    stats:{ pts:28.9, reb:4.2, ast:6.7, stl:2.0, blk:0.8, threePM:3.3, fgPct:46.2, ftPct:89.1, tov:2.5 },
    ranks:{ pts:4, reb:41, ast:12, stl:1, blk:18, threePM:5, fgPct:41, ftPct:7, tov:25 } },
  { id:'trae',      name:'Trae Young',               teamName:'Atlanta Hawks',            espnId:4277905, espnRank:29, color:'#C8102E',
    ...
    ranks:{ pts:38, reb:50, ast:7, stl:37, blk:49, threePM:24, fgPct:44, ftPct:23, tov:21 } },
  { id:'barnes',    name:'Scottie Barnes',           teamName:'Toronto Raptors',          espnId:4433134, espnRank:30, color:'#CE1141',
    ...
    ranks:{ pts:36, reb:18, ast:18, stl:12, blk:6, threePM:40, fgPct:15, ftPct:20, tov:22 } },
  { id:'jjj',       name:'Jaren Jackson Jr.',        teamName:'Memphis Grizzlies',        espnId:4277961, espnRank:31, color:'#5D76A9',
    ...
    ranks:{ pts:32, reb:28, ast:47, stl:26, blk:8, threePM:25, fgPct:36, ftPct:30, tov:32 } },
  { id:'fwagner',   name:'Franz Wagner',             teamName:'Orlando Magic',            espnId:4566434, espnRank:32, color:'#0077C0',
    ...
    ranks:{ pts:23, reb:27, ast:37, stl:27, blk:41, threePM:32, fgPct:31, ftPct:22, tov:42 } },
  ...
  { id:'sabonis',   name:'Domantas Sabonis',         teamName:'Sacramento Kings',         espnId:3155942, espnRank:34, color:'#5A2D81',
    ...
    ranks:{ pts:46, reb:4, ast:30, stl:38, blk:46, threePM:46, fgPct:8, ftPct:43, tov:20 } },
  { id:'fox',       name:"De'Aaron Fox",             teamName:'San Antonio Spurs',        espnId:4066259, espnRank:35, color:'#C4CED4',
    stats:{ pts:18.8, reb:3.8, ast:6.2, stl:1.2, blk:0.3, threePM:1.9, fgPct:48.8, ftPct:76.2, tov:2.3 },
    ranks:{ pts:35, reb:45, ast:15, stl:19, blk:43, threePM:20, fgPct:24, ftPct:40, tov:29 } },
  ...
  { id:'garland',   name:'Darius Garland',           teamName:'Cleveland Cavaliers',      espnId:4396907, espnRank:38, color:'#860038',
    ...
    ranks:{ pts:34, reb:49, ast:10, stl:39, blk:50, threePM:9, fgPct:38, ftPct:14, tov:13 } },
  { id:'dbane',     name:'Desmond Bane',             teamName:'Orlando Magic',            espnId:4066320, espnRank:39, color:'#0077C0',
    ...
    ranks:{ pts:28, reb:42, ast:29, stl:31, blk:36, threePM:16, fgPct:25, ftPct:2, tov:35 } },
  { id:'agordon',   name:'Aaron Gordon',             teamName:'Denver Nuggets',           espnId:3064290, espnRank:40, color:'#0E2240',
    ...
    ranks:{ pts:45, reb:26, ast:43, stl:46, blk:44, threePM:29, fgPct:19, ftPct:39, tov:49 } },
  ...
  { id:'randle',    name:'Julius Randle',            teamName:'Minnesota Timberwolves',   espnId:3064514, espnRank:42, color:'#0C2340',
    stats:{ pts:20.9, reb:6.8, ast:5.1, stl:1.1, blk:0.2, threePM:1.3, fgPct:47.5, ftPct:81.4, tov:2.8 },
    ranks:{ pts:25, reb:22, ast:25, stl:28, blk:47, threePM:35, fgPct:37, ftPct:29, tov:19 } },
  ...
  { id:'jjohnson',  name:'Jalen Johnson',            teamName:'Atlanta Hawks',            espnId:4701230, espnRank:44, color:'#C8102E',
    stats:{ pts:22.9, reb:10.2, ast:8.1, stl:1.3, blk:0.5, threePM:1.7, fgPct:49.3, ftPct:78.6, tov:3.4 },
    ranks:{ pts:21, reb:8, ast:6, stl:13, blk:30, threePM:30, fgPct:22, ftPct:34, tov:7 } },
  ...
  { id:'jmurray',   name:'Jamal Murray',             teamName:'Denver Nuggets',           espnId:3936299, espnRank:46, color:'#0E2240',
    ...
    ranks:{ pts:16, reb:39, ast:8, stl:40, blk:37, threePM:6, fgPct:28, ftPct:9, tov:30 } },
  { id:'embiid',    name:'Joel Embiid',              teamName:'Philadelphia 76ers',       espnId:3059318, espnRank:47, color:'#006BB6',
    stats:{ pts:26.9, reb:7.5, ast:4.0, stl:0.6, blk:1.1, threePM:1.4, fgPct:49.8, ftPct:85.5, tov:2.9 },
    ranks:{ pts:11, reb:19, ast:31, stl:47, blk:11, threePM:33, fgPct:20, ftPct:17, tov:15 } },
  ...
  { id:'porzingis', name:'Kristaps Porzingis',       teamName:'Atlanta Hawks',            espnId:3102531, espnRank:50, color:'#C8102E',
    ...
    ranks:{ pts:41, reb:35, ast:42, stl:48, blk:9, threePM:21, fgPct:45, ftPct:19, tov:48 } },
];
