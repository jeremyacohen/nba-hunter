...
const PLAYERS = [
  { id:'jokic',     name:'Nikola Jokic',            teamName:'Denver Nuggets',          espnId:3112335, espnRank:1,  color:'#0E2240',
    stats:{ pts:28.8, reb:12.5, ast:10.4, stl:1.4, blk:0.7, threePM:2.0, fgPct:57.7, ftPct:83.0, tov:3.7 },
    ranks:{ pts:6, reb:1, ast:1, stl:7, blk:21, threePM:15, fgPct:5, ftPct:22, tov:2 } },
  { id:'sga',       name:'Shai Gilgeous-Alexander',  teamName:'Oklahoma City Thunder',    espnId:4278073, espnRank:2,  color:'#007AC1',
    ...
    ranks:{ pts:2, reb:39, ast:12, stl:14, blk:15, threePM:21, fgPct:6, ftPct:8, tov:33 } },
  { id:'luka',      name:'Luka Doncic',              teamName:'Los Angeles Lakers',       espnId:3945274, espnRank:3,  color:'#552583',
    ...
    ranks:{ pts:1, reb:17, ast:4, stl:8, blk:28, threePM:2, fgPct:36, ftPct:39, tov:1 } },
  ...
  { id:'wemby',     name:'Victor Wembanyama',        teamName:'San Antonio Spurs',        espnId:5104157, espnRank:5,  color:'#C4CED4',
    stats:{ pts:24.0, reb:11.2, ast:2.9, stl:1.0, blk:2.9, threePM:1.8, fgPct:50.3, ftPct:81.2, tov:2.6 },
    ranks:{ pts:19, reb:5, ast:38, stl:27, blk:1, threePM:22, fgPct:15, ftPct:27, tov:21 } },
  { id:'edwards',   name:'Anthony Edwards',          teamName:'Minnesota Timberwolves',   espnId:4594268, espnRank:6,  color:'#0C2340',
    ...
    ranks:{ pts:3, reb:32, ast:35, stl:9, blk:16, threePM:4, fgPct:23, ftPct:31, tov:15 } },
  { id:'curry',     name:'Stephen Curry',            teamName:'Golden State Warriors',    espnId:3975,    espnRank:7,  color:'#1D428A',
    ...
    ranks:{ pts:10, reb:46, ast:26, stl:20, blk:33, threePM:1, fgPct:37, ftPct:1, tov:16 } },
  { id:'lebron',    name:'LeBron James',             teamName:'Los Angeles Lakers',       espnId:1966,    espnRank:8,  color:'#552583',
    ...
    ranks:{ pts:24, reb:27, ast:9, stl:21, blk:25, threePM:34, fgPct:17, ftPct:41, tov:12 } },
  { id:'durant',    name:'Kevin Durant',             teamName:'Houston Rockets',          espnId:3202,    espnRank:9,  color:'#CE1141',
    stats:{ pts:25.8, reb:5.4, ast:4.6, stl:0.8, blk:0.9, threePM:2.4, fgPct:50.8, ftPct:88.2, tov:3.2 },
    ranks:{ pts:14, reb:31, ast:28, stl:41, blk:13, threePM:12, fgPct:13, ftPct:11, tov:10 } },
  ...
  { id:'jwilliams', name:'Jalen Williams',           teamName:'Oklahoma City Thunder',    espnId:4593803, espnRank:11, color:'#007AC1',
    ...
    ranks:{ pts:39, reb:36, ast:21, stl:15, blk:38, threePM:41, fgPct:30, ftPct:21, tov:38 } },
  { id:'cade',      name:'Cade Cunningham',          teamName:'Detroit Pistons',          espnId:4432166, espnRank:12, color:'#C8102E',
    stats:{ pts:25.4, reb:5.7, ast:9.8, stl:1.5, blk:1.0, threePM:2.0, fgPct:45.9, ftPct:81.2, tov:3.7 },
    ranks:{ pts:15, reb:28, ast:2, stl:5, blk:12, threePM:16, fgPct:42, ftPct:28, tov:3 } },
  ...
  { id:'adavis',    name:'Anthony Davis',            teamName:'Dallas Mavericks',         espnId:6583,    espnRank:14, color:'#003DA5',
    ...
    ranks:{ pts:27, reb:6, ast:41, stl:22, blk:4, threePM:45, fgPct:14, ftPct:43, tov:36 } },
  ...
  { id:'banchero',  name:'Paolo Banchero',           teamName:'Orlando Magic',            espnId:4432573, espnRank:17, color:'#0077C0',
    ...
    ranks:{ pts:23, reb:15, ast:24, stl:45, blk:23, threePM:35, fgPct:44, ftPct:38, tov:17 } },
  ...
  { id:'jbrown',    name:'Jaylen Brown',             teamName:'Boston Celtics',           espnId:3917376, espnRank:19, color:'#007A33',
    stats:{ pts:29.1, reb:7.1, ast:4.8, stl:1.0, blk:0.4, threePM:2.0, fgPct:47.9, ftPct:77.9, tov:3.6 },
    ranks:{ pts:4, reb:20, ast:27, stl:28, blk:34, threePM:17, fgPct:31, ftPct:36, tov:4 } },
  ...
  { id:'adebayo',   name:'Bam Adebayo',              teamName:'Miami Heat',               espnId:4066261, espnRank:21, color:'#98002E',
    ...
    ranks:{ pts:36, reb:10, ast:39, stl:29, blk:24, threePM:29, fgPct:46, ftPct:37, tov:40 } },
  ...
  { id:'sengun',    name:'Alperen Sengun',           teamName:'Houston Rockets',          espnId:4871144, espnRank:25, color:'#CE1141',
    stats:{ pts:20.5, reb:9.2, ast:6.4, stl:1.4, blk:1.1, threePM:0.6, fgPct:49.9, ftPct:69.8, tov:3.2 },
    ranks:{ pts:26, reb:11, ast:13, stl:11, blk:10, threePM:43, fgPct:18, ftPct:46, tov:11 } },
  { id:'dwhite',    name:'Derrick White',            teamName:'Boston Celtics',           espnId:3078576, espnRank:26, color:'#007A33',
    ...
    ranks:{ pts:43, reb:38, ast:18, stl:18, blk:7, threePM:9, fgPct:50, ftPct:7, tov:41 } },
  ...
  { id:'maxey',     name:'Tyrese Maxey',             teamName:'Philadelphia 76ers',       espnId:4431678, espnRank:28, color:'#006BB6',
    ...
    ranks:{ pts:5, reb:42, ast:11, stl:2, blk:17, threePM:5, fgPct:39, ftPct:9, tov:26 } },
  ...
  { id:'barnes',    name:'Scottie Barnes',           teamName:'Toronto Raptors',          espnId:4433134, espnRank:30, color:'#CE1141',
    ...
    ranks:{ pts:34, reb:16, ast:20, stl:12, blk:5, threePM:40, fgPct:16, ftPct:25, tov:18 } },
  ...
  { id:'fwagner',   name:'Franz Wagner',             teamName:'Orlando Magic',            espnId:4566434, espnRank:32, color:'#0077C0',
    ...
    ranks:{ pts:25, reb:26, ast:37, stl:25, blk:41, threePM:32, fgPct:32, ftPct:24, tov:42 } },
  ...
  { id:'fox',       name:"De'Aaron Fox",             teamName:'San Antonio Spurs',        espnId:4066259, espnRank:35, color:'#C4CED4',
    stats:{ pts:19.1, reb:3.8, ast:6.2, stl:1.2, blk:0.3, threePM:1.9, fgPct:48.1, ftPct:76.6, tov:2.4 },
    ranks:{ pts:35, reb:45, ast:14, stl:19, blk:43, threePM:20, fgPct:29, ftPct:40, tov:27 } },
  ...
  { id:'amen',      name:'Amen Thompson',            teamName:'Houston Rockets',          espnId:4684740, espnRank:37, color:'#CE1141',
    ...
    ranks:{ pts:41, reb:18, ast:22, stl:6, blk:27, threePM:47, fgPct:11, ftPct:34, tov:24 } },
  ...
  { id:'agordon',   name:'Aaron Gordon',             teamName:'Denver Nuggets',           espnId:3064290, espnRank:40, color:'#0E2240',
    ...
    ranks:{ pts:38, reb:25, ast:43, stl:46, blk:47, threePM:26, fgPct:12, ftPct:33, tov:49 } },
  { id:'og',        name:'OG Anunoby',               teamName:'New York Knicks',          espnId:3934719, espnRank:41, color:'#006BB6',
    ...
    ranks:{ pts:45, reb:33, ast:44, stl:3, blk:19, threePM:19, fgPct:40, ftPct:30, tov:37 } },
  ...
  { id:'jjohnson',  name:'Jalen Johnson',            teamName:'Atlanta Hawks',            espnId:4701230, espnRank:44, color:'#C8102E',
    ...
    ranks:{ pts:21, reb:8, ast:7, stl:16, blk:32, threePM:31, fgPct:22, ftPct:35, tov:7 } },
  ...
  { id:'jmurray',   name:'Jamal Murray',             teamName:'Denver Nuggets',           espnId:3936299, espnRank:46, color:'#0E2240',
    ...
    ranks:{ pts:16, reb:40, ast:8, stl:35, blk:37, threePM:6, fgPct:28, ftPct:10, tov:29 } },
  { id:'embiid',    name:'Joel Embiid',              teamName:'Philadelphia 76ers',       espnId:3059318, espnRank:47, color:'#006BB6',
    ...
    ranks:{ pts:13, reb:19, ast:34, stl:47, blk:11, threePM:37, fgPct:19, ftPct:16, tov:14 } },
  { id:'mbridges',  name:'Mikal Bridges',            teamName:'New York Knicks',          espnId:3147657, espnRank:48, color:'#006BB6',
    ...
    ranks:{ pts:47, reb:41, ast:31, stl:13, blk:20, threePM:14, fgPct:20, ftPct:23, tov:48 } },
