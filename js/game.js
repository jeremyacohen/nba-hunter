...
const PLAYERS = [
  { id:'jokic',     name:'Nikola Jokic',            teamName:'Denver Nuggets',          espnId:3112335, espnRank:1,  color:'#0E2240',
    stats:{ pts:28.8, reb:12.6, ast:10.5, stl:1.4, blk:0.8, threePM:2.0, fgPct:57.0, ftPct:82.4, tov:3.7 },
    ranks:{ pts:6, reb:1, ast:1, stl:8, blk:15, threePM:17, fgPct:5, ftPct:25, tov:3 } },
  { id:'sga',       name:'Shai Gilgeous-Alexander',  teamName:'Oklahoma City Thunder',    espnId:4278073, espnRank:2,  color:'#007AC1',
    ...
    ranks:{ pts:2, reb:39, ast:12, stl:9, blk:16, threePM:26, fgPct:7, ftPct:7, tov:33 } },
  { id:'luka',      name:'Luka Doncic',              teamName:'Los Angeles Lakers',       espnId:3945274, espnRank:3,  color:'#552583',
    ...
    ranks:{ pts:1, reb:17, ast:4, stl:10, blk:28, threePM:2, fgPct:36, ftPct:36, tov:1 } },
  ...
  { id:'edwards',   name:'Anthony Edwards',          teamName:'Minnesota Timberwolves',   espnId:4594268, espnRank:6,  color:'#0C2340',
    ...
    ranks:{ pts:3, reb:33, ast:35, stl:11, blk:17, threePM:4, fgPct:21, ftPct:33, tov:16 } },
  { id:'curry',     name:'Stephen Curry',            teamName:'Golden State Warriors',    espnId:3975,    espnRank:7,  color:'#1D428A',
    ...
    ranks:{ pts:10, reb:46, ast:27, stl:20, blk:33, threePM:1, fgPct:39, ftPct:1, tov:17 } },
  { id:'lebron',    name:'LeBron James',             teamName:'Los Angeles Lakers',       espnId:1966,    espnRank:8,  color:'#552583',
    ...
    ranks:{ pts:23, reb:29, ast:9, stl:21, blk:25, threePM:31, fgPct:18, ftPct:41, tov:13 } },
  { id:'durant',    name:'Kevin Durant',             teamName:'Houston Rockets',          espnId:3202,    espnRank:9,  color:'#CE1141',
    stats:{ pts:26.2, reb:5.4, ast:4.6, stl:0.8, blk:0.9, threePM:2.4, fgPct:51.0, ftPct:88.8, tov:3.1 },
    ranks:{ pts:14, reb:31, ast:28, stl:41, blk:12, threePM:12, fgPct:11, ftPct:10, tov:11 } },
  { id:'brunson',   name:'Jalen Brunson',            teamName:'New York Knicks',          espnId:3934672, espnRank:10, color:'#006BB6',
    ...
    ranks:{ pts:11, reb:47, ast:15, stl:44, blk:48, threePM:8, fgPct:38, ftPct:19, tov:28 } },
  ...
  { id:'cade',      name:'Cade Cunningham',          teamName:'Detroit Pistons',          espnId:4432166, espnRank:12, color:'#C8102E',
    ...
    ranks:{ pts:15, reb:26, ast:2, stl:5, blk:13, threePM:18, fgPct:42, ftPct:28, tov:2 } },
  ...
  { id:'adavis',    name:'Anthony Davis',            teamName:'Dallas Mavericks',         espnId:6583,    espnRank:14, color:'#003DA5',
    ...
    ranks:{ pts:26, reb:6, ast:39, stl:22, blk:5, threePM:44, fgPct:14, ftPct:43, tov:36 } },
  { id:'mitchell',  name:'Donovan Mitchell',         teamName:'Cleveland Cavaliers',      espnId:3908809, espnRank:15, color:'#860038',
    ...
    ranks:{ pts:7, reb:37, ast:17, stl:4, blk:39, threePM:3, fgPct:26, ftPct:18, tov:12 } },
  ...
  { id:'butler',    name:'Jimmy Butler',             teamName:'Golden State Warriors',    espnId:6430,    espnRank:18, color:'#1D428A',
    ...
    ranks:{ pts:29, reb:30, ast:26, stl:12, blk:45, threePM:42, fgPct:9, ftPct:12, tov:43 } },
  { id:'jbrown',    name:'Jaylen Brown',             teamName:'Boston Celtics',           espnId:3917376, espnRank:19, color:'#007A33',
    ...
    ranks:{ pts:5, reb:20, ast:25, stl:28, blk:34, threePM:14, fgPct:28, ftPct:35, tov:5 } },
  { id:'kawhi',     name:'Kawhi Leonard',            teamName:'LA Clippers',              espnId:6450,    espnRank:20, color:'#C8102E',
    stats:{ pts:27.9, reb:6.3, ast:3.7, stl:2.0, blk:0.5, threePM:2.6, fgPct:49.3, ftPct:90.4, tov:2.2 },
    ranks:{ pts:9, reb:24, ast:36, stl:1, blk:29, threePM:11, fgPct:22, ftPct:3, tov:30 } },
  ...
  { id:'harden',    name:'James Harden',             teamName:'LA Clippers',              espnId:3992,    espnRank:23, color:'#C8102E',
    ...
    ranks:{ pts:18, reb:34, ast:5, stl:17, blk:36, threePM:6, fgPct:47, ftPct:8, tov:4 } },
  ...
  { id:'sengun',    name:'Alperen Sengun',           teamName:'Houston Rockets',          espnId:4871144, espnRank:25, color:'#CE1141',
    stats:{ pts:20.2, reb:9.1, ast:6.3, stl:1.3, blk:1.1, threePM:0.5, fgPct:49.9, ftPct:69.2, tov:3.2 },
    ranks:{ pts:28, reb:11, ast:13, stl:15, blk:10, threePM:45, fgPct:19, ftPct:46, tov:10 } },
  { id:'dwhite',    name:'Derrick White',            teamName:'Boston Celtics',           espnId:3078576, espnRank:26, color:'#007A33',
    stats:{ pts:17.1, reb:4.5, ast:5.7, stl:1.2, blk:1.5, threePM:2.9, fgPct:39.1, ftPct:89.5, tov:1.8 },
    ranks:{ pts:43, reb:38, ast:18, stl:18, blk:7, threePM:9, fgPct:50, ftPct:6, tov:41 } },
  ...
  { id:'trae',      name:'Trae Young',               teamName:'Atlanta Hawks',            espnId:4277905, espnRank:29, color:'#C8102E',
    ...
    ranks:{ pts:33, reb:50, ast:3, stl:30, blk:49, threePM:22, fgPct:48, ftPct:13, tov:23 } },
  { id:'barnes',    name:'Scottie Barnes',           teamName:'Toronto Raptors',          espnId:4433134, espnRank:30, color:'#CE1141',
    ...
    ranks:{ pts:34, reb:16, ast:20, stl:13, blk:6, threePM:40, fgPct:16, ftPct:24, tov:19 } },
  ...
  { id:'morant',    name:'Ja Morant',                teamName:'Memphis Grizzlies',        espnId:4279888, espnRank:33, color:'#5D76A9',
    ...
    ranks:{ pts:32, reb:48, ast:6, stl:31, blk:42, threePM:39, fgPct:49, ftPct:4, tov:6 } },
  ...
  { id:'fox',       name:"De'Aaron Fox",             teamName:'San Antonio Spurs',        espnId:4066259, espnRank:35, color:'#C4CED4',
    ...
    ranks:{ pts:35, reb:45, ast:14, stl:19, blk:43, threePM:20, fgPct:29, ftPct:39, tov:27 } },
  ...
  { id:'amen',      name:'Amen Thompson',            teamName:'Houston Rockets',          espnId:4684740, espnRank:37, color:'#CE1141',
    stats:{ pts:17.3, reb:7.6, ast:5.3, stl:1.5, blk:0.6, threePM:0.3, fgPct:50.8, ftPct:77.0, tov:2.6 },
    ranks:{ pts:41, reb:18, ast:23, stl:6, blk:27, threePM:47, fgPct:13, ftPct:38, tov:24 } },
  { id:'garland',   name:'Darius Garland',           teamName:'Cleveland Cavaliers',      espnId:4396907, espnRank:38, color:'#860038',
    ...
    ranks:{ pts:37, reb:49, ast:10, stl:42, blk:50, threePM:13, fgPct:45, ftPct:15, tov:18 } },
  { id:'dbane',     name:'Desmond Bane',             teamName:'Orlando Magic',            espnId:4066320, espnRank:39, color:'#0077C0',
    ...
    ranks:{ pts:27, reb:41, ast:30, stl:32, blk:30, threePM:15, fgPct:24, ftPct:2, tov:34 } },
  { id:'agordon',   name:'Aaron Gordon',             teamName:'Denver Nuggets',           espnId:3064290, espnRank:40, color:'#0E2240',
    ...
    ranks:{ pts:38, reb:25, ast:43, stl:46, blk:47, threePM:24, fgPct:12, ftPct:31, tov:48 } },
  { id:'og',        name:'OG Anunoby',               teamName:'New York Knicks',          espnId:3934719, espnRank:41, color:'#006BB6',
    ...
    ranks:{ pts:45, reb:32, ast:44, stl:3, blk:24, threePM:19, fgPct:37, ftPct:30, tov:39 } },
  ...
  { id:'lauri',     name:'Lauri Markkanen',          teamName:'Utah Jazz',                espnId:4066336, espnRank:43, color:'#002B5C',
    ...
    ranks:{ pts:12, reb:22, ast:46, stl:33, blk:31, threePM:10, fgPct:34, ftPct:5, tov:45 } },
  ...
  { id:'jmurray',   name:'Jamal Murray',             teamName:'Denver Nuggets',           espnId:3936299, espnRank:46, color:'#0E2240',
    stats:{ pts:25.3, reb:4.4, ast:7.3, stl:1.0, blk:0.4, threePM:3.1, fgPct:48.1, ftPct:87.7, tov:2.3 },
    ranks:{ pts:16, reb:40, ast:8, stl:35, blk:37, threePM:7, fgPct:30, ftPct:11, tov:29 } },
  { id:'embiid',    name:'Joel Embiid',              teamName:'Philadelphia 76ers',       espnId:3059318, espnRank:47, color:'#006BB6',
    ...
    ranks:{ pts:13, reb:19, ast:33, stl:48, blk:11, threePM:35, fgPct:20, ftPct:16, tov:14 } },
  { id:'mbridges',  name:'Mikal Bridges',            teamName:'New York Knicks',          espnId:3147657, espnRank:48, color:'#006BB6',
    ...
    ranks:{ pts:47, reb:43, ast:31, stl:7, blk:20, threePM:16, fgPct:17, ftPct:22, tov:49 } },
